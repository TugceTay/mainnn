...
{$IFDEF DCC}
  unit GisLayerSqlOgisSqlite ;
  {$HPPEMIT '#pragma link "GisLayerSqlOgisSqlite"'}
{$ENDIF}
{$IFDEF CLR}
...
type
  ...
  Unit_GisLayerSqlOgisSqlite = class
    public
...
//=============================================================================
  ...
  class procedure Unit_GisLayerSqlOgisSqlite.SelfRegisterLayer() ;
  begin
...
{$IFNDEF OXYGENE}
  initialization
    Unit_GisLayerSqlOgisSqlite.SelfRegisterLayer() ;
{$ENDIF}
