...
const
  ...
  {$ENDIF}
  {#gendoc:hide}
  GIS_RT_COPYRIGHT      = 'TatukGIS DK RTree' ;
  {#gendoc:hide}
  GIS_RT_VERSION        = 6 ;
  {#gendoc:hide}
  GIS_RT_SUBVERSION     = 2 ;
...
type
  ...
  TGIS_RTree = {$IFDEF OXYGENE} public {$ENDIF} class( TGIS_ObjectDisposable )
    ...
    public // public routines
      ...
      ///   If True, open index in readonly mode
      /// </param>
      constructor  Create    ( const _path     : String ;
                               const _readonly : Boolean
                             ) ; overload ;
