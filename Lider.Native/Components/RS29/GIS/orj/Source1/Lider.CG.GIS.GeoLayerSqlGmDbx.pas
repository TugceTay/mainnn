...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoLayerSqlGmDbx;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoLayerSqlGmDbx"'}
{$ENDIF}
{$IFDEF CLR}
...
{$IFDEF GIS_NODB}
  {$Message Warn 'Unit Lider.CG.GIS.GeoLayerSqlGmDbx not supported - no DB support' }
  interface
  implementation
{$ELSE}
