...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoRendererAbstract ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoRendererAbstract"'}
{$ENDIF}
{$IFDEF CLR}
...
type
  ...
  TGIS_RendererAbstract = {$IFDEF OXYGENE} public abstract {$ENDIF} class ( TGIS_BaseObjectDisposable )
    ...
    public
      ...
      /// <summary>
      ///   Preparation of the renderer context.
      /// </summary>
    ...
    public
      ...
      ///   background color
      /// </param>
      procedure OnPaintDrawBackground
                                  ( const _canvas    : TObject ;
      ...
      /// </param>
      /// <returns>
      ///   width of the given bitmap
      /// </returns>
      function  OnPaintGetBitmapWidth
      ...
      /// </param>
      /// <returns>
      ///   height of the given bitmap
      /// </returns>
      function  OnPaintGetBitmapHeight
                                  ( const _bitmap    : TObject
                                  ) : Integer ; virtual ;
      ...
      ///   created canvas
      /// </returns>
      function  OnPaintCreateCanvasForBitmap
                                  ( const _bitmap    : TObject ;
                                    const _color     : TGIS_Color
                                  ) : TObject ; virtual ; 
      ...
      ///   framework bitmap
      /// </returns>
      function  OnPaintBitmapToFrameworkBitmap
                                  ( const _bitmap    : TObject
                                  ) : TObject ; virtual ;
      ...
      ///   bitmap
      /// </returns>
      function  OnPaintFrameworkBitmapToBitmap
                                  ( const _bitmap    : TObject
      ...
      ///   Internal use only.
      /// </summary>
      /// <param name="_srcBitmap">
      ///   framework bitmap
      /// </param>
      /// <param name="_dstBitmap">
      ///   bitmap
      /// </param>
      procedure OnPaintFrameworkBitmapToBitmap
                                  ( const _srcBitmap : TObject ;
                                    const _dstBitmap : TObject
                                  ) ; overload ; virtual ;
      ...
      /// </param>
      procedure OnPaintDrawBitmap ( const _canvas    : TObject ;
                                    const _bitmap    : TObject ;
                                    const _rect      : TRectF
                                  ) ; overload ; virtual ;
      ...
      /// </param>
      /// <returns>
      ///   true if the context has been cleared
      /// </returns>
      function  OnPaintClearTopContextBaseMap
                                  ( const _context   : TGIS_RendererContext ;
                                    const _width     : Integer ;
                                    const _height    : Integer
                                  ) : Boolean ; virtual ;
      ...
      /// </param>
      /// <returns>
      ///   true if the bitmap has been cleared
      /// </returns>
      function  OnPaintClearBitmap( const _bitmap    : TObject
                                  ) : Boolean ; virtual ;
      ...
      ///   font scaling factor in percents
      /// </param>
      procedure OnPaintCreateContextEx
      ...
      ///   copy of the bitmap
      /// </returns>
      function  OnPaintCopyBitmap ( const _bitmap    : TObject
                                  ) : TObject ; virtual ;
      ...
      /// </summary>
      /// <returns>
      ///   True if the renderer is active
      /// </returns>
      function  OnPaintIsActive   : Boolean ; virtual ;
      ...
      /// </returns>
      function  OnPaintValidBitmap( const _bitmap    : TObject
                                  ) : Boolean ; virtual ;
      ...
      ///   y coordinate
      /// </param>
      procedure OnPaintDrawTransparentControl
                                  ( const _context   : TObject ;
                                    const _bitmap    : TObject ;
                                    const _x         : Integer ;
                                    const _y         : Integer
...
//=============================================================================
  ...
  begin
    ...
    if not assigned( oMeasureBmp ) then begin
      ...
      oMeasureCtx.AssignBaseMap( oMeasureBmp.NativeBitmap, False ) ;
  ...
  {$IFDEF CLR}
  procedure TGIS_RendererAbstract.OnPaintDrawBackground(
    const _canvas : TObject ;
    const _color  : TGIS_Color
  ) ;
  begin
  ...
  function TGIS_RendererAbstract.OnPaintGetBitmapWidth(
    const _bitmap : TObject
  ) : Integer ;
  begin
    Result := 0 ;
  ...
  function TGIS_RendererAbstract.OnPaintGetBitmapHeight(
    const _bitmap : TObject
  ) : Integer ;
  begin
    Result := 0 ;
  ...
  procedure TGIS_RendererAbstract.OnPaintPaintExtraEx(
    const _sender  : TObject ;
    const _context : TObject ;
    const _event   : TGIS_PaintEvent
  ) ;
  ...
  function TGIS_RendererAbstract.OnPaintCreateBitmap(
    const _width  : Integer ;
    const _height : Integer
  ) : TObject ;
  begin
  ...
  function TGIS_RendererAbstract.OnPaintCreateCanvasForBitmap(
    const _bitmap : TObject ;
    const _color  : TGIS_Color
  ) : TObject ;
  begin
  ...
  function TGIS_RendererAbstract.OnPaintBitmapToFrameworkBitmap(
    const _bitmap : TObject
  ) : TObject ;
  begin
    result := nil ;
  ...
  function TGIS_RendererAbstract.OnPaintFrameworkBitmapToBitmap(
    const _bitmap : TObject
  ) : TObject ;
  begin
    result := nil ;
  ...
  procedure TGIS_RendererAbstract.OnPaintFrameworkBitmapToBitmap(
    const _srcBitmap : TObject ;
    const _dstBitmap : TObject
  ) ; 
  begin
  ...
  procedure TGIS_RendererAbstract.OnPaintDrawBitmap(
    const _canvas : TObject ;
    const _bitmap : TObject ;
    const _rect   : TRectF
  ) ;
  ...
  function TGIS_RendererAbstract.OnPaintClearTopContextBaseMap(
    const _context : TGIS_RendererContext ;
    const _width   : Integer ;
    const _height  : Integer
  ) : Boolean ;
  ...
  function TGIS_RendererAbstract.OnPaintClearBitmap(
    const _bitmap : TObject
  ) : Boolean ;
  begin
    result := False ;
  ...
  procedure TGIS_RendererAbstract.OnPaintCreateContextEx(
    const _parent    : IGIS_ViewerParent ;
    const _viewer    : IGIS_Viewer ;
    const _context   : TGIS_RendererContext ;
    const _shift     : TPoint  ;
  ...
  function TGIS_RendererAbstract.OnPaintCopyBitmap(
    const _bitmap : TObject
  ) : TObject ;
  begin
    Result := nil ;
  ...
  function TGIS_RendererAbstract.OnPaintIsActive
    : Boolean ;
  begin
    Result := false ;
  end ;

  function TGIS_RendererAbstract.OnPaintValidBitmap(
    const _bitmap : TObject
  ) : Boolean ;
  begin
    Result := false ;
  ...
  procedure TGIS_RendererAbstract.OnPaintDrawTransparentControl(
    const _context : TObject ;
    const _bitmap  : TObject ;
    const _x       : Integer ;
    const _y       : Integer
