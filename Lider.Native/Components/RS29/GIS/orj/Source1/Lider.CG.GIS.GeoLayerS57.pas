...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoLayerS57 ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoLayerS57"'}
{$ENDIF}
{$IFDEF CLR}
...
//==============================================================================  
  ...
  class procedure GisLayerS57.SelfRegisterLayer() ;
  begin
