...
//=============================================================================
{
  ADO 1.5 TLB stub. Use in a case if AdoInt was not provided (Delphi/BCB 5)
}
{$IFNDEF GENDOC}
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoAdoInt ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoAdoInt"'}
{$ENDIF}
{$IFDEF CLR}
...
{$IFDEF ADOINTUNIT}
  {$Message Error 'Do not use unit "Lider.CG.GIS.GeoAdoInt" - use "AdoInt"'}
{$ENDIF}
