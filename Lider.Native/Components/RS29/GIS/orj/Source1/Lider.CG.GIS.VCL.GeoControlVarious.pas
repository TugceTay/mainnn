...
unit Lider.CG.GIS.VCL.GeoControlVarious ;
{$HPPEMIT '#pragma link "Lider.CG.GIS.VCL.GeoControlVarious"'}
...
uses
  ...
  Lider.CG.GIS.VCL.GeoControlFieldFactor,
...
//==============================================================================
  ...
  begin
    ...
    try
      ...
      frm.cmbFields.ItemIndex :=
        frm.cmbFields.Items.IndexOf( FField ) ;
      frm.FillUnits( TGIS_FieldFactorUnitsType.NoScale ) ;

      if frm.Execute( FOnHelp ) = mrOk
      then begin
        FField := frm.cmbFields.Text ;
