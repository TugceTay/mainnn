...
//=============================================================================
{
  VCL implementation of TGIS_PvlControlNorthArrow
}

unit VCL.GisPvlControlNorthArrow ;
{$HPPEMIT '#pragma link "VCL.GisPvlControlNorthArrow"'}
...
type
  ...
  T_PvlControlNorthArrow = class( TGIS_PvlControlVcl, IGIS_PvlControlNorthArrow, IGIS_PrintableControl )
    private
...
begin
  TGIS_ControlNorthArrow( oControl ).Color1 := VCLColor( _value ) ;
end ;
...
begin
  TGIS_ControlNorthArrow( oControl ).Color2 := VCLColor( _value ) ;
end ;
...
begin
  oControl := TGIS_ControlNorthArrow.Create( TWinControl( _context.NativeParent ) );
