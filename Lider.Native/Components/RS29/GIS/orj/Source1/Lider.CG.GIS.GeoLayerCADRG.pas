...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoLayerCADRG ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoLayerCADRG"'}
{$ENDIF}
{$IFDEF CLR}
...
//      internalTransparentColor.rgbReserved := $FF ;
  ...
  class procedure GisLayerCADRG.SelfRegisterLayer() ;
  begin
...
{$IFNDEF OXYGENE}
  initialization
    GisLayerCADRG.SelfRegisterLayer() ;
{$ENDIF}
