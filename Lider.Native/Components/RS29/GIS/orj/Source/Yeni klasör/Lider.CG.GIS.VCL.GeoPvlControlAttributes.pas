...
//=============================================================================
{
  VCL implementation of TGIS_PvlControlAttributes
}

unit VCL.GisPvlControlAttributes ;
{$HPPEMIT '#pragma link "VCL.GisPvlControlAttributes"'}
...
type
  ...
  T_PvlControlAttributes = class ( TGIS_PvlControlVcl, IGIS_PvlControlAttributes )
    protected
      /// <inheritdoc"/>
...
begin
  TGIS_ControlAttributes( oControl ).FieldNameColumnWidth := RoundS( _value ) ;
end;
...
begin
  TGIS_ControlAttributes( oControl ).Font := VCLFont( _value ) ;
end;
...
begin
  oControl := TGIS_ControlAttributes.Create( TWinControl( _context.NativeParent ) );
