...
{$IFDEF DCC}
  unit GisLayerPixelStoreAdoNet ;
  {$HPPEMIT '#pragma link "GisLayerPixelStoreAdoNet"'}
{$ENDIF}
{$IFDEF CLR}
...
type
  ...
  Unit_GisLayerPixelStoreAdoNet = class
    public
...
//==============================================================================
  ...
  class procedure Unit_GisLayerPixelStoreAdoNet.SelfRegisterLayer ;
  begin
...
{$IFNDEF OXYGENE}
  initialization
    Unit_GisLayerPixelStoreAdoNet.SelfRegisterLayer() ;
{$ENDIF}
