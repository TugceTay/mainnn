...
unit Lider.CG.GIS.FMX.GeoControlLegend ;
{$HPPEMIT '#pragma link "Lider.CG.GIS.FMX.GeoControlLegend"'}
...
uses
  ...
  Lider.CG.GIS.FMX.GeoLegendUtilsFactory,
...
type
  ...
  TGIS_ControlLegend = class( TStyledControl,
    ...
    private
      oLegend              : TGIS_Legend ;
      oRenderer            : TGIS_LegendRendererFMX ;
...
uses
  ...
  Lider.CG.GIS.FMX.GeoControlLegendForm,
  Lider.CG.GIS.FMX.GeoPrintLegend;
...
//==============================================================================
  ...
  begin
    ...
    try
      ...
      oLegend.MouseDown( x, y, ssTouch in _shift, handled ) ;
    finally
      if not handled then
  ...
  begin
    ...
    if drawDragging then begin
      ...
      updatePPI ;
      bScrollBarsUpdated := False ;
      draw := draw_on_bitmap ;
      if bScrollBarsUpdated then
        // once again
        draw := draw_on_bitmap ;
    end ;
...
//==============================================================================
  ...
  begin
    ...
    oRenderer := TGIS_LegendRendererFMX.Create( Self ) ;
