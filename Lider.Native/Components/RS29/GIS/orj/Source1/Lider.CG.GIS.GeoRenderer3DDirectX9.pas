...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoRenderer3DDirectX9 ;
{$ENDIF}
{$IFDEF CLR}
...
{$IFDEF DCC}
  uses
    ...
    Lider.CG.GIS.GeoRenderer3DDirectXAbstract,
    Lider.CG.GIS.GeoDirectXLite ;
{$ENDIF}
{$IFDEF JAVA}
  uses
...
//    var mem := pD3DDevice.stubGetAvailableTextureMem ;
  ...
  begin
    ambColorDX := D3DCOLOR_ARGB( 255, _val, _val, _val ) ;
  end;
...
//      raise EGIS_Exception.Create( _rsrc( GIS_RS_ERR_3D_FAIL ),'InitD3D', 3 ) ;
  ...
  begin
    ...
    {$IFDEF CLR}
      ...
      oLight.SetDiffuse(  GetDirectXColor( 1.0, 1.0, 1.0, 1.0 ) ) ;
      oLight.SetAmbient(  GetDirectXColor( 0.1, 0.1, 0.1, 1.0 ) ) ;
      oLight.SetSpecular( GetDirectXColor( 0.1, 0.1, 0.1, 1.0 ) ) ;
    ...
    {$ELSE}
      ...
      oLight.Ambient.r := 0.1 ;
      oLight.Ambient.g := 0.1 ;
      oLight.Ambient.b := 0.1 ;
      oLight.Ambient.a := 1 ;

      oLight.Specular.r := 0.1 ;
      oLight.Specular.g := 0.1 ;
      oLight.Specular.b := 0.1 ;
      oLight.Specular.a := 1 ;
...
//    Result := TMesh(meshWallTiles[msc]).DrawSubset(0) ;
  ...
  begin
    ...
    pD3DDevice.SetRenderState(D3DRS_AMBIENT,ambColorDX) ;
  end;
