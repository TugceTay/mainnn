...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoLayerFGDB ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoLayerFGDB"'}
{$ENDIF}
{$IFDEF CLR}
...
//=============================================================================
  ...
  class procedure GisLayerFGDB.SelfRegisterLayer() ;
  begin
...
{$IFNDEF OXYGENE}
  initialization
    GisLayerFGDB.SelfRegisterLayer() ;
{$ENDIF}
