...
type
  ...
  TGIS_DataSet = class (TDataSet, IGIS_Subscribe)
    ...
    public
      ...
      ///    </note>
      /// </remarks>
      property ShowInternalFields : Boolean read  FShowViertualFields
                                            write FShowViertualFields ;

      /// <summary>
      ///   Show or hide virtual layer fields.
      /// </summary>
      property ShowViertualFields : Boolean read  FShowViertualFields
                                            write FShowViertualFields ;
...
{$R Lider.CG.GIS.GeoDataSet_16x16.RES}
...
//==============================================================================
  ...
  var
    ...
    function isPredefined( const _fldName : String ) : Boolean ;
    begin
      Result := Pos( _fldName, GIS_FIELDS_PREDEFINED ) >= StringFirst ;
    end ;
  ...
  begin
    ...
    try
      ...
      for i := 0 to Fields.Count-1 do begin
        fld := Fields[i] ;
        if isPredefined(fld.FieldName) or bReadOnly then
          fld.ReadOnly := True
        else if Assigned( dsLayer ) then begin
  ...
  begin
    ...
    if ShowViertualFields then begin
