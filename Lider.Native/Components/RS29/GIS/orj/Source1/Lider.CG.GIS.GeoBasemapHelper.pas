...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoBasemapHelper;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoBasemapHelper"'}
{$ENDIF}
{$IFDEF CLR}
  ...
  try
    ...
    try
      ...
      if bsuccess then begin
        ...
        then
          oParent.FBitmap.LoadFromBitmap( (oParent.oBmp as IGIS_ViewerBmp).Bitmap, '' )
        else
