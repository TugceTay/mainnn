...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoLayerGSHHS ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoLayerGSHHS"'}
{$ENDIF}
{$IFDEF CLR}
...
//=============================================================================
  ...
  class procedure GisLayerGSHHS.SelfRegisterLayer() ;
  begin
...
{$IFNDEF OXYGENE}
  initialization
    GisLayerGSHHS.SelfRegisterLayer() ;
{$ENDIF}
