...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoLayerSDTS ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoLayerSDTS"'}
{$ENDIF}
{$IFDEF CLR}
...
//==============================================================================  
  ...
  class procedure GisLayerSDTS.SelfRegisterLayer() ;
  begin
...
{$IFDEF DCC}
  initialization
    GisLayerSDTS.SelfRegisterLayer() ;
{$ENDIF}
