...
{$IFDEF DCC}
  unit GisLayerSHP ;
  {$HPPEMIT '#pragma link "GisLayerSHP"'}
{$ENDIF}
{$IFDEF CLR}
...
//=============================================================================
  ...
  procedure TGIS_LayerSHP.RevertShapes ;
  var
    i : Integer ;
  begin
    inherited ;
...
//==============================================================================
  ...
  class procedure Unit_GisLayerShp.SelfRegisterLayer() ;
  begin
...
{$IFDEF DCC}
  initialization
    Unit_GisLayerShp.SelfRegisterLayer() ;
{$ENDIF}
