...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoControlLegendFormControler ;
{$ENDIF}
{$IFDEF CLR}
...
//==============================================================================
  ...
  begin
    ...
    if FIsVector then begin
      TGIS_LayerVector(oLayerEx).MultipassRendering := TGIS_LayerVector(oLayer).MultipassRendering ;
      TGIS_LayerVector(oLayerEx).IgnoreShapeParams  := TGIS_LayerVector(oLayer).IgnoreShapeParams ;
      TGIS_LayerVector(oLayerEx).Scope              := TGIS_LayerVector(oLayer).Scope ;
      TGIS_LayerVector(oLayerEx).ImportStructure( TGIS_LayerVector(oLayer) ) ;
    end
    else if FIsPixel or FIsGrid then
