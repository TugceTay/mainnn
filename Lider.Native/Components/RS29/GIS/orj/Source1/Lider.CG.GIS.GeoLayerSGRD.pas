...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoLayerSGRD ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoLayerSGRD"'}
{$ENDIF}
{$IFDEF CLR}
...
//==============================================================================
  ...
  class procedure GisLayerSGRD.SelfRegisterLayer() ;
  begin
...
{$IFNDEF OXYGENE}
  initialization
    GisLayerSGRD.SelfRegisterLayer() ;
{$ENDIF}
