...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoFilePixel ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoFilePixel"'}
{$ENDIF}
{$IFDEF CLR}
...
//==============================================================================
  ...
  begin
    ...
    try
      ...
      olist.SaveToFile( GetPathNoExt( Path ) + _ext ) ;
      ...
      olist.SaveToFile( GetPathNoExt( Path ) + '.tab' ) ;
