...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoLayerSqlFireDac ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoLayerSqlFireDac"'}
{$ENDIF}
{$IFDEF CLR}
...
{$IFDEF GIS_NODB}
  {$Message Warn 'Unit Lider.CG.GIS.GeoLayerSqlFireDac not supported - no DB support' }
  interface
  implementation
{$ELSE}
