...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoInterpolation ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoInterpolation"'}
{$ENDIF}
{$IFDEF CLR}
...
{$REGION 'T_Pipeline_PointCloudToGrid'}
  class procedure GisInterpolation.SelfRegisterPipeline ;
  begin
    RegisterPipeline(
...
{$IFDEF DCC}
initialization
  GisInterpolation.SelfRegisterPipeline ;
{$ENDIF}
