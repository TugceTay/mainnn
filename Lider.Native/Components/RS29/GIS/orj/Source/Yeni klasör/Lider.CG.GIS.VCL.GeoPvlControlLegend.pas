...
//=============================================================================
{
  VCL implementation of TGIS_PvlControlLegend
}

unit VCL.GisPvlControlLegend;
...
type
  T_PvlControlLegend = class( TGIS_PvlControlVcl, IGIS_PvlControlLegend, IGIS_PrintableControl )
    protected
      /// <inheritdoc"/>
...
function T_PvlControlLegend.fget_BackgroundColor
  : TGIS_Color ;
begin
  Result :=  GISColor( TGIS_ControlLegend( oControl ).Color );
end;
...
begin
   TGIS_ControlLegend( oControl ).Color := VCLColor( _value ) ;
end;
...
function T_PvlControlLegend.fget_FontColor
  : TGIS_Color ;
begin
  Result := GISColor( TGIS_ControlLegend( oControl ).Font.Color );
end;
...
begin
   TGIS_ControlLegend( oControl ).Font.Color := VCLColor( _value ) ;
end;
...
begin
  oControl := TGIS_ControlLegend.Create( TWinControl( _context.NativeParent ) );
