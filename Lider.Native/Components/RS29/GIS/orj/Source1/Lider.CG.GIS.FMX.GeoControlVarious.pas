...
unit Lider.CG.GIS.FMX.GeoControlVarious ;
{$HPPEMIT '#pragma link "Lider.CG.GIS.FMX.GeoControlVarious"'}
...
//==============================================================================
  ...
  begin
    ...
    frm.cmbFields.ItemIndex := frm.cmbFields.Items.IndexOf( FField ) ;
    ...
    frm.Execute( FOnHelp,
      ...
      begin
        ...
        Field := frm.cmbFields.Items[frm.cmbFields.ItemIndex] ;
