...
{$IFDEF DCC}
  unit GisLayerSqlGmAdo ;
  {$HPPEMIT '#pragma link "GisLayerSqlGmAdo"'}
{$ENDIF}
{$IFDEF CLR}
...
{$IFNDEF GIS_NOADO}
  ...
  class procedure Unit_GisLayerSqlGmAdo.SelfRegisterLayer() ;
  begin
  ...
  {$IFNDEF OXYGENE}
    initialization
      Unit_GisLayerSqlGmAdo.SelfRegisterLayer() ;
  {$ENDIF}
{$ENDIF}
