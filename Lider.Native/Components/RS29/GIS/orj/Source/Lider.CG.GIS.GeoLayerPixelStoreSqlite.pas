...
{$IFDEF DCC}
  unit GisLayerPixelStoreSqlite ;
  {$HPPEMIT '#pragma link "GisLayerPixelStoreSqlite"'}
{$ENDIF}
{$IFDEF CLR}
...
type
  ...
  Unit_GisLayerPixelStoreSqlite = class
    public
...
//==============================================================================
  ...
  class procedure Unit_GisLayerPixelStoreSqlite.SelfRegisterLayer() ;
  begin
...
{$IFNDEF OXYGENE}
  initialization
    Unit_GisLayerPixelStoreSqlite.SelfRegisterLayer() ;
{$ENDIF}
