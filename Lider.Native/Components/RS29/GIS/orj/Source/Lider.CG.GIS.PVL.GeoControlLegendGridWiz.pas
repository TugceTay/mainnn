...
{$IFDEF DCC}
  unit PVL.GisControlLegendGridWiz ;
  {$HPPEMIT '#pragma link "PVL.GisControlLegendGridWiz"'}
{$ENDIF}
{$IFDEF CLR}
...
//==============================================================================
  ...
  begin
    ...
    lblBandAdvanced := TGIS_PvlLabel.Create( pnlFormulaAdvanced.Context ) ;
    ...
    cmbBandAdvanced := TGIS_PvlComboBox.Create( pnlFormulaAdvanced.Context ) ;
  ...
  begin
    ...
    vvedtMax := edtAnalyzeMax.CreateValueValidator ;
    vvedtMax.Precision := 15 ;
    vvedtMax.MinValue := -GIS_MAX_SINGLE ;
    vvedtMax.MaxValue := GIS_MAX_SINGLE ;

    vvedtMin := edtAnalyzeMin.CreateValueValidator ;
    vvedtMin.Precision := 15 ;
    vvedtMin.MinValue := -GIS_MAX_SINGLE ;
    vvedtMin.MaxValue := GIS_MAX_SINGLE ;

    vvedtAvg := edtAnalyzeAvg.CreateValueValidator ;
    vvedtAvg.Precision := 15 ;
    vvedtAvg.MinValue := -GIS_MAX_SINGLE ;
    vvedtAvg.MaxValue := GIS_MAX_SINGLE ;
  ...
  begin
    ...
    lblRampStep := TGIS_PvlLabel.Create( pnlRamp.Context ) ;
    ...
    edtRampStep := TGIS_PvlEdit.Create( pnlRamp.Context ) ;
    edtRampStep.Place( lblRampStep.Width, 0, nil, Context.HMargin, lblRampStep, 0 ) ;

    lblRampLegend := TGIS_PvlLabel.Create( pnlRamp.Context ) ;
    ...
    edtRampLegend := TGIS_PvlEdit.Create( pnlRamp.Context ) ;
    edtRampLegend.Place( lblRampStep.Width, 0, nil, Context.HMargin, lblRampLegend, 0 ) ;

    vvedtStep := edtRampStep.CreateValueValidator ;
    vvedtStep.Precision := 15 ;
    vvedtStep.MinValue := -GIS_MAX_SINGLE ;
    vvedtStep.MaxValue := GIS_MAX_SINGLE ;

    vvedtLegend := edtRampLegend.CreateValueValidator;
    vvedtLegend.Precision := 15 ;
    vvedtLegend.MinValue := -GIS_MAX_SINGLE ;
    vvedtLegend.MaxValue := GIS_MAX_SINGLE ;
...
//    {$ENDIF}
  ...
  begin
    ...
    lblStyleColorMid := TGIS_PvlLabel.Create( pnlStyleParams.Context ) ;
    ...
    cmbStyleColorMid := TGIS_PvlColorComboBox.Create( pnlStyleParams.Context ) ;
    ...
    chkStyleColorRampAdd := TGIS_PvlCheckBox.Create( pnlStyleParams.Context ) ;
    ...
    chkStyleColorHSL := TGIS_PvlCheckBox.Create( pnlStyleParams.Context ) ;
