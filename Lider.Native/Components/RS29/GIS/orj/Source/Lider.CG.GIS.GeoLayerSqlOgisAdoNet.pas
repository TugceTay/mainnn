...
{$IFDEF DCC}
  unit GisLayerSqlOgisAdoNet ;
  {$HPPEMIT '#pragma link "GisLayerSqlOgisAdoNet"'}
{$ENDIF}
{$IFDEF CLR}
...
type
  ...
  Unit_GisLayerSqlOgisAdoNet = class
    public
...
//=============================================================================
  ...
  class procedure Unit_GisLayerSqlOgisAdoNet.SelfRegisterLayer() ;
  begin
...
{$IFNDEF OXYGENE}
  initialization
    Unit_GisLayerSqlOgisAdoNet.SelfRegisterLayer() ;
{$ENDIF}
