...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoLayerCSV ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoLayerCSV"'}
{$ENDIF}
{$IFDEF CLR}
...
type
  ...
  TGIS_LayerCSV = {$IFDEF OXYGENE} public {$ENDIF} class( TGIS_LayerVector )
    ...
    private
      ...
      /// <summary>
      ///   SColum separator in a csv file.
      /// </summary>
      FSeparator : Char ;
      ...
      /// <summary>
      ///   True, if autorecognize sperator and decimal point upon read.
      /// </summary>
    ...
    public
      /// <summary>
      ///   Decimal point symbol. Default is coma.
      /// </summary>
      ...
      /// <summary>
      ///   Column separator separator. Default is coma.
      /// </summary>
      ...
      /// <summary>
      ///   If true then DecimalPoint and Separator will be autorecognize upon
      ///   reading the file.
      /// </summary>
      /// <remarks>
      ///   After readin file AcutRecohgnize is set to false to enaure, that
...
//=============================================================================
  ...
  class procedure GisLayerCSV.SelfRegisterLayer() ;
  begin
