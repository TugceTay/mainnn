...
//=============================================================================
{
  Encapsulation of a GeoMedia SQL Warehouse FireDac access.

  Implementation currently support: MS Jet (Access), MS SQL Server warehouses.
}

{$IFDEF DCC}
  unit Lider.CG.GIS.GeoLayerSqlGmFireDac;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoLayerSqlGmFireDac"'}
{$ENDIF}
{$IFDEF CLR}
...
{$IFDEF GIS_NODB}
  {$Message Warn 'Unit Lider.CG.GIS.GeoLayerSqlGmFireDac not supported - no DB support' }
  interface
  implementation
{$ELSE}
...
type
  ...
  /// </summary>
  TGIS_LayerSqlGmFireDac = class( TGIS_LayerSqlGmAbstract )
    protected
...
//=============================================================================
// TGIS_LayerSqlGmFireDac
//=============================================================================

  constructor TGIS_LayerSqlGmFireDac.Create ;
  begin
    inherited ;
  ...
  destructor TGIS_LayerSqlGmFireDac.Destroy ;
  begin
    FreeObject( oGisDb ) ;
  ...
  procedure TGIS_LayerSqlGmFireDac.fset_SharedConnection(
  ...
  function TGIS_LayerSqlGmFireDac.fget_SharedConnection : TFDConnection;
  begin
    Result := TGIS_DbFireDac( oGisDb ).SharedConnection ;
  end ;

  procedure TGIS_LayerSqlGmFireDac.sqlQueryGetGeometry(
     const _uid       : TGIS_Uid ;
     const _shapetype : TGIS_ShapeType ;
     const _cursor    : Integer
   ) ;
  ...
  function TGIS_LayerSqlGmFireDac.sqlQueryNameGEOUID(
    const _cursor : Integer
  ) : String ;
  begin
    if fixGEOUID < 0 then
  ...
  function TGIS_LayerSqlGmFireDac.sqlQueryGetGEOUID(
    const _cursor : Integer
  ) : Variant ;
  begin
  ...
  procedure TGIS_LayerSqlGmFireDac.sqlTableAppend(
    const _id    : Integer ;
    const _table : String
  ) ;
  begin
  ...
  procedure TGIS_LayerSqlGmFireDac.sqlTableOpenWrite(
    const _id     : Integer ;
    const _table  : String  ;
    const _uidCol : String ;
    const _uidVal : TGIS_Uid
  ...
  procedure TGIS_LayerSqlGmFireDac.sqlTableSetGeometry(
    const _id   : Integer ;
    const _name : String  ;
    const _shp  : TGIS_Shape
  ) ;
  ...
  procedure TGIS_LayerSqlGmFireDac.macroUpdateStart ;
  begin
  ...
  function  TGIS_LayerSqlGmFireDac.bindFieldInternal(
    const _field  : string ;
    const _cursor : Integer
  ) : Integer ;
  begin
  ...
  function TGIS_LayerSqlGmFireDac.getBindedFieldInternal(
  ...
  function TGIS_LayerSqlGmFireDac.PreRecognize(
    const _path     : String ;
    var   _new_path : String
   ) : Boolean ;
  begin
...
initialization
  RegisterLayer( 'DK-TTKLS', GIS_SQL_LAYER_CONNECTOR, TGIS_LayerSqlGmFireDac,
