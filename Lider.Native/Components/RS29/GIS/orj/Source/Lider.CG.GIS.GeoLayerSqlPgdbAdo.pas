...
{$IFDEF DCC}
  unit GisLayerSqlPgdbAdo ;
  {$HPPEMIT '#pragma link "GisLayerSqlPgdbAdo"'}
{$ENDIF}
{$IFDEF CLR}
...
{$IFNDEF GIS_NOADO}
  ...
  class procedure Unit_GisLayerSqlPgdbAdo.SelfRegisterLayer() ;
  begin
  ...
  {$IFNDEF OXYGENE}
    initialization
     Unit_GisLayerSqlPgdbAdo.SelfRegisterLayer() ;
  {$ENDIF}
{$ENDIF}
