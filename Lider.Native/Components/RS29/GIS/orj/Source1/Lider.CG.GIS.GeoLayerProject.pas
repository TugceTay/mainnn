...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoLayerProject ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoLayerProject"'}
{$ENDIF}
{$IFDEF CLR}
...
//==============================================================================
  ...
  class procedure GisLayerProject.SelfRegisterLayer() ;
  begin
...
{$IFNDEF OXYGENE}
  initialization
    GisLayerProject.SelfRegisterLayer() ;
{$ENDIF}
