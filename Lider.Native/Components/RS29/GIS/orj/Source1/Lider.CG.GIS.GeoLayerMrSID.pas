...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoLayerMrSID ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoLayerMrSID"'}
{$ENDIF}
{$IFDEF CLR}
...
//      Result := _bytes ;
  ...
  class procedure GisLayerMrSID.SelfRegisterLayer() ;
    begin
...
{$IFNDEF OXYGENE}
  initialization
    GisLayerMrSID.SelfRegisterLayer() ;
{$ENDIF}
