...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoLayerPixelStore ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoLayerPixelStore"'}
{$ENDIF}
{$IFDEF CLR}
...
//==============================================================================
  ...
  procedure TGIS_LayerPixelStoreAbstract.fset_Antialias(
  ...
  begin
    ...
    while not FStore.Eof do begin
      if (FGridBand = 0) or rgbAsGrid then begin
        extZoom := 1 ;
        prepareMinMaxZGray ;
        FStore.MoveNext ;
        continue ;
