...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoLegendUtils ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoLegendUtils"'}
{$ENDIF}
{$IFDEF CLR}
...
type
  ...
  /// </summary>
  TGIS_LegendRendererAbstract = {$IFDEF OXYGENE} public abstract {$ENDIF} class ( TGIS_BaseObjectDisposable )
...
//==============================================================================
// TGIS_LegendRendererAbstract
//==============================================================================

  function TGIS_LegendRendererAbstract.GetBrushColor
    : TGIS_Color ;
  begin

  end ;

  procedure TGIS_LegendRendererAbstract.SetBrushColor(
  ...
  procedure TGIS_LegendRendererAbstract.DrawCheckBox(
  ...
  procedure TGIS_LegendRendererAbstract.DrawExpandCollapseMarker(
    const _expanded : Boolean ;
    const _rect     : TRect
  ) ;
  begin
  ...
  procedure TGIS_LegendRendererAbstract.DrawRectangle(
    const _rect : TRect
  ) ;
  begin
  ...
  function TGIS_LegendRendererAbstract.GetTextExtent(
    const _selected : Boolean ;
    const _text     : String
  ) : TPoint ;
  begin
  ...
  procedure TGIS_LegendRendererAbstract.DrawText(
    const _selected : Boolean ;
    const _text     : String  ;
    const _rect     : TRect
  ) ;
  ...
  procedure TGIS_LegendRendererAbstract.DrawImage(
  ...
  procedure TGIS_LegendRendererAbstract.CreateTemporaryContext(
    const _width  : Integer ;
    const _height : Integer ;
    const _ppi    : Integer
  ) ;
  ...
  procedure TGIS_LegendRendererAbstract.RenderTemporaryContext(
    const _left : Integer ;
    const _top  : Integer
  ) ;
  begin
...
//==============================================================================
  ...
  begin
    if DataType = TGIS_LegendItemType.Layer then begin
      ...
      if assigned( la ) then begin
        if assigned( la.SubLayers ) and ( iSubLayer > -1 )then
          Result := TGIS_Layer( la.SubLayers[iSubLayer] )
        else
          Result := la ;
      end
      else
...
//==============================================================================
  ...
  function TGIS_LegendIconFactory.GetBitmap : TObject ;
  var
    old_center : Boolean ;
  begin
