...
//=============================================================================
{
  VCL implementation of TGIS_PvlControlPrintPreview
}

unit VCL.GisPvlControlPrintPreview ;
{$HPPEMIT '#pragma link "VCL.GisPvlControlPrintPreview"'}
...
type
  ...
  T_PvlControlPrintPreview = class ( TGIS_PvlControlVcl, IGIS_PvlControlPrintPreview )
    private
...
begin
    ...
    TGIS_ControlPrintPreview( oControl ).Print( _printer as TGIS_PrintManager )
end;
...
begin
  oControl := TGIS_ControlPrintPreview.Create( TWinControl( _context.NativeParent ) );
