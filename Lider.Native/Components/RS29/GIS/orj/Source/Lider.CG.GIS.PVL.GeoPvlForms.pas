...
{$IFDEF DCC}
  unit PVL.GisPvlForms;
  {$HPPEMIT '#pragma link "PVL.GisPvlForms"'}
{$ENDIF}
{$IFDEF CLR}
...
type
 ...
 TGIS_PvlBorderIcon = (
  ...
  IGIS_PvlForm = interface( IGIS_PvlBase )
    ...
    /// <summary>
    ///   Getter for StayOnTop property.
    /// </summary>
    /// <returns>
    ///   StayOnTop of the form
    /// </returns>
    function  fget_StayOnTop    : Boolean;

    /// <summary>
    ///   Setter for StayOnTop property.
    /// </summary>
    /// <param name="_value">
    ///   New StayOnTop value
    /// </param>
    ...
    /// </summary>
    /// <returns>
    ///   Coordinates of the left corner of the form
    /// </returns>
    ...
    /// </summary>
    /// <returns>
    ///   Coordinates of the top corner of the form
    /// </returns>
    ...
    /// <summary>
    ///   Getter for ClientWidth property.
    /// </summary>
    /// <returns>
    ...
    /// <summary>
    ///   Setter for MinHeight property.
    /// </summary>
    /// <returns>
    ///   Minimum height of the client area
    /// </returns>
    ...
    /// <summary>
    ///   Setter for MinWidth property.
    /// </summary>
    /// <returns>
    ///   Minimal width of the client area
    /// </returns>
    ...
    /// <summary>
    ///   Executed whenever Form is resized.
    /// </summary>
    procedure DoResize ;
    ...
    /// <summary>
    ///   Recognizes the state of the window.
    /// </summary>
    /// <returns>
    ///   True if window is locked from rendering.
    /// </returns>
    ...
    /// </summary>
    /// <remarks>
    ///   Form will self destruct upon close. To control ths behaviour see
    ///   Show(_free) overload. Form self destruction is important only
    ///   for Delphi based desktop platforms.
    /// </remarks>
    procedure Show              ;
                                overload;
    ...
    /// </summary>
    /// <param name="_free">
    ///   True, if dialog should be free upon close (same as Show() overload)
    /// </param>
    /// <remarks>
    ///   Paramter _free is important only for Delphi based desktop platforms.
    /// </remarks>
    ...
    /// </returns>
    /// <remarks>
    ///   Parameter _free is important only for Delphi based desktop platforms.
    /// </remarks>
    ...
    /// <summary>
    ///   Interrupts the execution of an application
    ///   so that it can process the message queue.
    /// </summary>
  ...
  TGIS_PvlBaseForm = {$IFDEF OXYGENE}abstract{$ENDIF} class( TGIS_PvlBase, IGIS_PvlForm )
    ...
    public
      ...
      /// <summary>
      ///   True if form should always stay on top.
      /// </summary>
      property StayOnTop          : Boolean
                                    read  fget_StayOnTop
                                    write fset_StayOnTop ;

      /// <summary>
      ///   Form left coordinates.
      /// </summary>
...
function TGIS_PvlBaseForm.fget_StayOnTop
  : Boolean;
begin
  Result := oPlatformFrm.fget_StayOnTop ;
end;

procedure TGIS_PvlBaseForm.fset_StayOnTop(
  const _value : Boolean
);
begin
  oPlatformFrm.fset_StayOnTop( _value ) ;
end;

function TGIS_PvlBaseForm.fget_Left
  : Integer;
begin
  Result := oPlatformFrm.fget_Left ;
end;

procedure TGIS_PvlBaseForm.fset_Left(
  const _value: Integer
) ;
begin
  oPlatformFrm.fset_Left( _value ) ;
end;

function TGIS_PvlBaseForm.fget_Top
  : Integer;
begin
  Result := oPlatformFrm.fget_Top ;
end;

procedure TGIS_PvlBaseForm.fset_Top(
  const _value: Integer
) ;
begin
  oPlatformFrm.fset_Top( _value ) ;
end;

function TGIS_PvlBaseForm.fget_Height
  : Integer;
begin
  Result := oPlatformFrm.fget_Height ;
end;

procedure TGIS_PvlBaseForm.fset_Height(
  const _value: Integer
);
begin
  oPlatformFrm.fset_Height( _value ) ;
end;

function TGIS_PvlBaseForm.fget_Width
  : Integer;
begin
  Result := oPlatformFrm.fget_Width ;
end;

procedure TGIS_PvlBaseForm.fset_Width(
  const _value : Integer
);
begin
  oPlatformFrm.fset_Width( _value ) ;
end;
...
function TGIS_PvlBaseForm.fget_MinHeight
  : Integer;
begin
  Result := oPlatformFrm.fget_MinHeight ;
end;

procedure TGIS_PvlBaseForm.fset_MinHeight(
  const _value : Integer
);
begin
  oPlatformFrm.fset_MinHeight( _value ) ;
end;

function TGIS_PvlBaseForm.fget_MinWidth
  : Integer;
begin
  Result := oPlatformFrm.fget_MinWidth ;
end;

procedure TGIS_PvlBaseForm.fset_MinWidth(
  const _value : Integer
);
begin
  oPlatformFrm.fset_MinWidth( _value ) ;
end;
...
function TGIS_PvlBaseForm.fget_Visible
  : Boolean ;
begin
  Result := oPlatformFrm.fget_Visible ;
end;
...
function TGIS_PvlBaseForm.IsLocked
  : Boolean ;
begin
  Result := oPlatformFrm.IsLocked ;
end;
...
procedure TGIS_PvlBaseForm.DoResize;
begin
  // for safe inheritance only
end;
...
begin
  oPlatformFrm.Show( _free ) ;
end;

procedure TGIS_PvlBaseForm.Hide;
begin
  oPlatformFrm.Hide ;
end;
...
var
  proc : TGIS_Proc ;
  res  :  TGIS_PvlModalResult; //temporart result for non-proc !
begin
  proc := _proc ;

  if not assigned( _proc ) then begin
    ...
    oPlatformFrm.ShowModal( proc, _free ) ;
    Result := res;
  end else
    Result := oPlatformFrm.ShowModal( proc, _free ) ;
end;
...
procedure TGIS_PvlBaseForm.ProcessMessages ;
begin
  oPlatformFrm.ProcessMessages ;
end;
