...
{$IFDEF DCC}
  unit GisLayerSqlSqlite ;
  {$HPPEMIT '#pragma link "GisLayerSqlSqlite"'}
{$ENDIF}
{$IFDEF CLR}
...
//=============================================================================
  ...
  class procedure Unit_GisLayerSqlSqlite.SelfRegisterLayer() ;
  begin
...
{$IFNDEF OXYGENE}
  initialization
    Unit_GisLayerSqlSqlite.SelfRegisterLayer() ;
{$ENDIF}
