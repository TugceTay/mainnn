...
unit Lider.CG.GIS.VCL.GeoPrinters ;
{$HPPEMIT '#pragma link "Lider.CG.GIS.VCL.GeoPrinters"'}
...
type
  ...
  /// </summary>
  // ilker deðiþtirme TGIS_Printer = class( TGIS_ObjectDisposable, IGIS_Printer )
  TGIS_Printer = class( TGIS_ObjectDisposable)
