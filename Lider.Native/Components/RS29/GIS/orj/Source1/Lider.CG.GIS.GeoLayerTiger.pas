...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoLayerTiger ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoLayerTiger"'}
{$ENDIF}
{$IFDEF CLR}
...
//============================================================================
  ...
  class procedure GisLayerTiger.SelfRegisterLayer() ;
  begin
...
{$IFNDEF OXYGENE}
  initialization
    GisLayerTiger.SelfRegisterLayer() ;
{$ENDIF}
