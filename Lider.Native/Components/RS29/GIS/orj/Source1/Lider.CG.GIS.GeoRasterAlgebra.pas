...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoRasterAlgebra ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoRasterAlgebra"'}
{$ENDIF}
{$IFDEF CLR}
...
//==============================================================================
  ...
  class procedure GisRasterAlgebra.SelfRegisterPipeline ;
  begin
...
{$IFDEF DCC}
initialization
  GisRasterAlgebra.SelfRegisterPipeline ;
