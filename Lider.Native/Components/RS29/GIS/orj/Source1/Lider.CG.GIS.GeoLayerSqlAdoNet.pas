...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoLayerSqlAdoNet ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoLayerSqlAdoNet"'}
{$ENDIF}
{$IFDEF CLR}
...
//=============================================================================
  ...
  class procedure GisLayerSqlAdoNet.SelfRegisterLayer() ;
  begin
...
{$IFNDEF OXYGENE}
  initialization
    GisLayerSqlAdoNet.SelfRegisterLayer() ;
{$ENDIF}
