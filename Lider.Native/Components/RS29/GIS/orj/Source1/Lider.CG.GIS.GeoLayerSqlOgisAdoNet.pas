...
//=============================================================================
{
  Encapsulation of OpenGIS SQL - AdoNet access.
}

{$IFDEF DCC}
  unit Lider.CG.GIS.GeoLayerSqlOgisAdoNet ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoLayerSqlOgisAdoNet"'}
{$ENDIF}
{$IFDEF CLR}
...
type
  ...
  GisLayerSqlOgisAdoNet = class
    public
      class procedure SelfRegisterLayer() ;
  end ;

  /// <summary>
  ///   Layer that can read OpenGIS SQL file via AdoNet.
  /// </summary>
  TGIS_LayerSqlOgisAdoNet = {$IFDEF OXYGENE} public {$ENDIF} class( TGIS_LayerSqlOgisAbstract )
    protected
...
//=============================================================================
  ...
  constructor TGIS_LayerSqlOgisAdoNet.Create ;
  begin
    inherited ;
  ...
  procedure TGIS_LayerSqlOgisAdoNet.doDestroy ;
  begin
    FreeObject( oGisDb ) ;
  ...
  function TGIS_LayerSqlOgisAdoNet.sqlQueryNameGEOUID(
    const _cursor : Integer
  ) : String ;
  begin
    if fixGEOUID < 0 then
  ...
  function TGIS_LayerSqlOgisAdoNet.sqlQueryGetGEOUID(
    const _cursor : Integer
  ) : Variant ;
  begin
  ...
  procedure TGIS_LayerSqlOgisAdoNet.sqlTableAppend(
    const _id    : Integer ;
    const _table : String
  ) ;
  begin
  ...
  procedure TGIS_LayerSqlOgisAdoNet.sqlTableOpenWrite(
    const _id     : Integer ;
    const _table  : String  ;
    const _uidCol : String ;
    const _uidVal : TGIS_Uid
  ...
  function  TGIS_LayerSqlOgisAdoNet.bindFieldInternal(
     const _name  : String ;
     const _cursor : Integer
   ) : Integer ;
  begin
  ...
  function TGIS_LayerSqlOgisAdoNet.getBindedFieldInternal(
  ...
  procedure TGIS_LayerSqlOgisAdoNet.Build(
    const _path   : String ;
    const _extent : TGIS_Extent;
    const _type   : TGIS_ShapeType ;
    const _dim    : TGIS_DimensionType
  ...
  function TGIS_LayerSqlOgisAdoNet.PreRecognize(
    const _path     : String ;
    var   _new_path : String
  ) : Boolean ;
  begin
  ...
  class procedure GisLayerSqlOgisAdoNet.SelfRegisterLayer() ;
  begin
    RegisterLayer( 'DK-TTKLS', GIS_SQL_LAYER_CONNECTOR, TGIS_LayerSqlOgisAdoNet,
...
{$IFNDEF OXYGENE}
  initialization
    GisLayerSqlOgisAdoNet.SelfRegisterLayer() ;
{$ENDIF}
