...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoPipelineOperations ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoPipelineOperations"'}
{$ENDIF}
{$IFDEF CLR}
...
class procedure GisPipelineOperations.SelfRegisterPipeline() ;
begin
...
{$IFDEF DCC}
  initialization
    GisPipelineOperations.SelfRegisterPipeline() ;
{$ENDIF}
