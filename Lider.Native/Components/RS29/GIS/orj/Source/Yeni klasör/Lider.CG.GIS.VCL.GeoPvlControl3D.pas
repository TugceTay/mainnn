...
//=============================================================================
{
  VCL implementation of TGIS_PvlControl3D
}

unit VCL.GisPvlControl3D ;
{$HPPEMIT '#pragma link "VCL.GisPvlControl3D"'}
...
type
  ...
  T_PvlControl3D = class( TGIS_PvlControlVcl, IGIS_PvlControl3D )
    private
...
begin
  oControl := TGIS_Control3D.Create( TWinControl( _context.NativeParent ) );
