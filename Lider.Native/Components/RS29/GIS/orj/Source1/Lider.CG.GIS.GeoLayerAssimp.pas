...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoLayerAssimp ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoLayerAssimp"'}
{$ENDIF}
{$IFDEF CLR}
...
//=============================================================================
  ...
  class procedure GisLayerAssimp.SelfRegisterLayer() ;
  begin
...
{$IFDEF DCC}
  initialization
    GisLayerAssimp.SelfRegisterLayer() ;
{$ENDIF}
