...
type
  ...
  /// </summary>
  {$IFNDEF GEN_ARRAY_WRAPPER}
    TGIS_DrawBufF = {$IFDEF OXYGENE} public {$ENDIF} Array of TPointF ;
  {$ELSE}
    {#typehint:array:TPointF}
    TGIS_DrawBufF = {$IFNDEF GENPDK} class {$ELSE} record {$ENDIF}
      ...
      public
        ...
        ///   index of the element
        /// </param>
        property Value[ const _idx : Integer ] : TPointF
          read  dummy
          write dummy;
     end ;
  {$ENDIF}
  ...
  /// <summary>
  ///   Array of TGIS_Point2D
  /// </summary>
  {$IFNDEF GEN_ARRAY_WRAPPER}
    TGIS_PointArray = {$IFDEF OXYGENE} public {$ENDIF} Array of TGIS_Point;
  {$ELSE}
    {#typehint:array:TGIS_Point}
    TGIS_PointArray = {$IFNDEF GENPDK} class {$ELSE} record {$ENDIF}
      // XDK stub definition
      public
        /// <summary>
        ///   Set array size.
...
type
  ...
  /// </summary>
  {$IFDEF OXYGENE}
    TGIS_LayerInfoList = public TList< TGIS_LayerInfo > ;
  {$ELSE}
    TGIS_LayerInfoList = {$IFDEF OXYGENE} public {$ENDIF} class( TObjectList<TGIS_LayerInfo> )
...
const
  // various constants
    ...
    /// </summary>
    GIS_HALF_MAX_SINGLE = GIS_MAX_SINGLE / 2 ;
