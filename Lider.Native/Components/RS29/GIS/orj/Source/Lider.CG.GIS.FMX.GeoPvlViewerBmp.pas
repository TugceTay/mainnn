...
//=============================================================================
{
  FMX implementation of TGIS_PvlViewerBmp
}

unit FMX.GisPvlViewerBmp;
...
type
  T_PvlViewerBmp = class( TGIS_PvlObjectFmx, IGIS_PvlViewerBmp, IGIS_Viewer, IGIS_ViewerBmp )
    protected
      /// <inheritdoc"/>
...
//    Result := TGIS_ViewerBmp( oControl ).fget_DrawBasemapOnly ;
  ...
  begin
    TGIS_ViewerBmp( oControl ).TilePicture := T_FMXBitmap( _value.NativeBitmap ) ;
  end;
