...
{$IFDEF DCC}
  unit GisVectorization;
  {$HPPEMIT '#pragma link "GisVectorization"'}
{$ENDIF}
{$IFDEF CLR}
...
{$REGION 'Pipeline'}
  class procedure Unit_GisVectorization.SelfRegisterPipeline ;
  begin
    RegisterPipeline(
...
{$IFDEF DCC}
  initialization
    Unit_GisVectorization.SelfRegisterPipeline ;
{$ENDIF}
