...
{$IFDEF DCC}
  unit GisLayerSqlOgisAdo ;
  {$HPPEMIT '#pragma link "GisLayerSqlOgisAdo"'}
{$ENDIF}
{$IFDEF CLR}
...
{$IFNDEF GIS_NOADO}
  ...
  class procedure Unit_GisLayerSqlOgisAdo.SelfRegisterLayer() ;
  begin
  ...
  {$IFNDEF OXYGENE}
    initialization
      Unit_GisLayerSqlOgisAdo.SelfRegisterLayer() ;
  {$ENDIF}
{$ENDIF}
