...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoPipeline ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoPipeline"'}
{$ENDIF}
{$IFDEF CLR}
...
class procedure GisPipeline.SelfRegisterPipeline() ;
begin
...
{$IFDEF DCC}
  initialization
    GisPipeline.SelfRegisterPipeline() ;
  finalization
