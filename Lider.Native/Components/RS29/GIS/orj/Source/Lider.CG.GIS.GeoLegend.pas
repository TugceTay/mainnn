...
type
  ...
  /// <summary>
  ///   List of the legend nodes (TGIS_TreeNode).
  /// </summary>
  TGIS_TreeList = class ( TGIS_UncountedInterfacedObject )
    private
      lItems    : TList<TGIS_TreeNode> ;
    ...
    private
      ...
      function  fget_SelectedEx : TGIS_TreeNode ;
      procedure fset_SelectedEx ( const _val : TGIS_TreeNode
                                ) ;
      function  fget_ChangeSelected : TGIS_TreeNode ;
      procedure fset_ChangeSelected ( const _val : TGIS_TreeNode
                                    ) ;
    private
    ...
    public
      ...
      ///   node to add
      /// </param>
      procedure Add         ( const _node : TGIS_TreeNode
                            ) ;
      /// <summary>
      ///   Insert a new node in the list at a given position.
      /// </summary>
      /// <param name="_idx">
      ///   position to insert
      /// </param>
      ...
      ///   node to insert
      /// </param>
      procedure Insert      ( const _idx  : Integer ;
      ...
      ///   node index
      /// </returns>
      function  IndexOf     ( const _node : TGIS_TreeNode
                            ) : Integer ;
      /// <summary>
      ...
      /// </param>
      procedure Move        ( const _src : Integer ;
                              const _dst : Integer
                            ) ;
      /// <summary>
      ///   Search the node in the list and delete it from the list.
      /// </summary>
      /// <param name="_node">
      ///   node to delete
      /// </param>
      ...
      ///   position to delete
      /// </param>
      procedure Delete      ( const _idx : Integer
                            ) ;
      /// <summary>
      ///   Add a child node to the node.
      /// </summary>
      /// <param name="_node">
      ///   if assigned then a child new node of the _node is created
      ///   if not assigned then a new node is added to the list
      /// </param>
      /// <param name="_name">
      ///   text of the node
      /// </param>
      ...
      /// </summary>
      /// <param name="_idx">
      ///   location on the list where the node is inserted
      /// </param>
      /// <param name="_node">
      ///   node to insert
      /// </param>
      ...
      /// <summary>
      ///   Begin an update of the list.
      /// </summary>
      procedure BeginUpdate ;
      /// <summary>
      ///   End an update of the list.
      /// </summary>
      procedure EndUpdate   ;
    public
      /// <summary>
      ...
      property Count    : Integer
                          read  fget_Count ;
      /// <summary>
      ///   Selected node in single select mode.
      /// </summary>
      ...
      /// <summary>
      ///   Selected node in multi select mode.
      /// </summary>
      property SelectedEx : TGIS_TreeNode
                          read  fget_SelectedEx
                          write fset_SelectedEx ;

      /// <summary>
      ///   Change selected node in multi select mode.
      /// </summary>
      property ChangeSelected : TGIS_TreeNode
                          read  fget_ChangeSelected
                          write fset_ChangeSelected ;
  end ;
  ...
  TGIS_TreeNode = class ( TGIS_UncountedInterfacedObject )
    ...
    public
      ...
      /// <param name="_pos">
      ///   location on the list where the node is inserted
      ///   if -1 then the node is added at the end of the list
      /// </param>
      ...
      /// </summary>
      /// <param name="_deep">
      ///   if true then all child nodes are expanded
      /// </param>
      procedure Expand         ( const _deep : Boolean
                               ) ;
      /// <summary>
      ///   Find selected node from the list.
      /// </summary>
      /// <returns>
      ///   selected node
      /// </returns>
    ...
    public
      ...
      property Index    : Integer
                          read  fget_Index ;
      /// <summary>
      ///   Level in the tree of the nodes.
      /// </summary>
  ...
  TGIS_Legend = class ( TGIS_UncountedInterfacedObject,
    ...
    private
      ...
      lstSelectedLayers: TGIS_LayerAbstractList ;
      moveLevel        : Integer ;
      moveTop          : Integer ;
      fOldZoom         : Double  ;
      ptDrag           : TPoint  ;
    ...
    private
      ...
      function  fget_SelectedNodeEx: TGIS_TreeNode ;
      procedure fset_SelectedNodeEx( const _value : TGIS_TreeNode
                                   ) ;
    ...
    private
      ...
      function  ensureTopOffset : Boolean ;
    ...
    public
      ...
      /// </param>
      /// <param name="_isCtrl">
      ///   True, if it is click with control key
      /// </param>
      /// <param name="_isShft">
      ///   True, if it is click with shift key
      /// </param>
      /// <param name="_action">
      ...
      procedure MouseDown         ( const _x       : Double  ;
                                    const _y       : Double  ;
                                    const _isTouch : Boolean ;
                                    const _isCtrl  : Boolean ;
                                    const _isShft  : Boolean ;
                                    var   _action  : Boolean
                                  ) ;
    ...
    public
      ...
      ///   Selected node in multi select mode.
      /// </summary>
      property SelectedNodeEx : TGIS_TreeNode
                            read  fget_SelectedNodeEx
                            write fset_SelectedNodeEx ;
    public
...
//==============================================================================
  ...
  procedure TGIS_TreeNode.doDestroy ;
  begin
    FreeObject( FItems ) ;
    FreeObject( FData ) ;
...
//==============================================================================
  ...
  begin
    inherited Create ;
    lItems := TList<TGIS_TreeNode>.Create ;
    lSelected := _slctd ;
  end ;

  procedure TGIS_TreeList.doDestroy ;
  var
    i  : Integer ;
    nd : TGIS_TreeNode ;
  begin
    if assigned( lItems ) then begin
  ...
  function TGIS_TreeList.fget_Items(
    const _idx : Integer
  ) : TGIS_TreeNode ;
  begin
    if ( lItems.Count = 0 ) or
       ( _idx < 0 ) or ( _idx >= lItems.Count ) then
      Result := nil
    else
      Result := lItems[_idx] ;
  end ;

  function TGIS_TreeList.fget_Count : Integer ;
  begin
    Result := lItems.Count ;
  end ;
  ...
  function TGIS_TreeList.fget_SelectedEx : TGIS_TreeNode ;
  begin
    if lSelected.Count = 0 then
      Result := nil
    else
      Result := lSelected[lSelected.Count-1] ;
  end ;

  procedure TGIS_TreeList.fset_SelectedEx(
    const _val : TGIS_TreeNode
  ) ;
  begin
    if assigned( _val ) then
  ...
  function TGIS_TreeList.fget_ChangeSelected : TGIS_TreeNode ;
  begin
    if lSelected.Count = 0 then
      Result := nil
    else
  ...
  procedure TGIS_TreeList.fset_ChangeSelected(
    const _val : TGIS_TreeNode
  ) ;
  begin
    if assigned( _val ) then
      _val.Selected := not _val.Selected
  end ;
  ...
  procedure TGIS_TreeList.Insert(
    const _idx  : Integer ;
    const _node : TGIS_TreeNode
  ) ;
  begin
    lItems.Insert( _idx, _node ) ;
  end ;

  function TGIS_TreeList.IndexOf(
    const _node : TGIS_TreeNode
  ) : Integer ;
  begin
    Result := lItems.IndexOf( _node ) ;
  end ;

  procedure TGIS_TreeList.Move(
    const _src : Integer ;
    const _dst : Integer
  ) ;
  {$IFDEF OXYGENE}
  ...
  begin
    {$IFDEF OXYGENE}
      n := lItems[ _src ] ;
      lItems.RemoveAt( _src ) ;
      lItems.Insert( _dst, n ) ;
    {$ELSE}
      lItems.Move( _src, _dst ) ;
    {$ENDIF}
  end ;

  procedure TGIS_TreeList.Remove(
    const _node : TGIS_TreeNode
  ) ;
  begin
    lItems.Remove( _node ) ;
  ...
  procedure TGIS_TreeList.Delete(
    const _idx : Integer
  ) ;
  begin
    {$IFDEF OXYGENE}
      lItems.RemoveAt( _idx ) ;
    {$ELSE}
      lItems.Delete( _idx ) ;
    {$ENDIF}
  end ;
...
//==============================================================================
  ...
  begin
    ...
    lstSelectedLayers := TGIS_LayerAbstractList.Create( False ) ;
    sNewSelected := '' ;
    ...
    bDCCDesignMode := False ;
    {$IFDEF DCC}
      // Reare case.In Delphi IDE both FMX and VCL packages are initilised
      // upon startup initialize same factories for both context. If FMX is
      // disabled only for particular VCL project then initialised FMX pointer
      // point nowhere
      if csDesigning in (_owner as TComponent).ComponentState then begin
        bDCCDesignMode := True ;
        oBMPFactory := nil;
        exit ;
      end;
  ...
  begin
    ...
    if not bDCCDesignMode then begin
  ...
  function TGIS_Legend.fget_Layers : TGIS_LayerAbstractList ;
  var
    dt : TGIS_LegendItemData ;
    nd : TGIS_TreeNode ;
    ii : Integer ;

    procedure deepGetLayers( const _node : TGIS_TreeNode ; const _selected : Boolean ) ;
    var
      ddt : TGIS_LegendItemData ;
      dnd : TGIS_TreeNode ;
      i   : Integer ;
    begin
      if not assigned( _node.FItems ) then exit ;

      for i := 0 to _node.FItems.Count-1 do begin
        dnd := _node.FItems[i] ;
        if not assigned( dnd ) then
          continue ;

        ddt := TGIS_LegendItemData( dnd.Data ) ;
        if not assigned( ddt ) then continue ;

        if (ddt.DataType = TGIS_LegendItemType.Layer) and
           (dnd.Selected or _selected) then
          lstSelectedLayers.Add( ddt.Layer )
        else if ddt.DataType = TGIS_LegendItemType.Group then begin
          deepGetLayers( dnd, dnd.Selected or _selected ) ;
        end ;
      end ;
    end ;

  begin
    Result := lstSelectedLayers ;
    lstSelectedLayers.Clear ;

    if isLocked then exit ;

    for ii := 0 to FItems.Count-1 do begin
      nd := FItems[ii] ;
      if not assigned( nd ) then
        continue ;

      dt := TGIS_LegendItemData( nd.Data ) ;
      if not assigned( dt ) then continue ;

      if (dt.DataType = TGIS_LegendItemType.Layer) and nd.Selected then
        lstSelectedLayers.Add( dt.Layer )
      else if dt.DataType = TGIS_LegendItemType.Group then begin
        deepGetLayers( nd, nd.Selected ) ;
      end ;
    end ;
  end ;

  procedure TGIS_Legend.fset_Layers(
  ...
  begin
    ...
    for i := 0 to _value.Count-1 do begin
      node := findLayerNode( TGIS_Layer(_value[i]) ) ;
      if assigned( node ) then begin
        SelectedNodeEx := node ;
        selectedFlag   := True ;
        makeNodeVisible( node ) ;
  ...
  var
    allow : Boolean ;
  begin
    doChanging( self, _value, False, allow ) ;
    if allow then
      FItems.Selected := _value ;
  end ;

  function TGIS_Legend.fget_SelectedNodeEx : TGIS_TreeNode ;
  begin
    Result := FItems.SelectedEx ;
  end ;

  procedure TGIS_Legend.fset_SelectedNodeEx(
    const _value : TGIS_TreeNode
  ) ;
  var
    allow : Boolean ;
  begin
    doChanging( self, _value, True, allow ) ;
    if allow then begin
      if isLocked then
        FItems.SelectedEx := _value
      else
        FItems.ChangeSelected := _value
    end ;
  end ;
  ...
  begin
    ...
    prev := nil ;
    if not IsStringEmpty( la.Name ) then
    ...
    if opShowLayerFullPath and ( _root = '' ) then
      str := la.Path
    else
      str := la.Caption ;
    ...
    if _node = nil then
      node.Data := TGIS_LegendItemData.Create( _layer, '', FViewer )
    else
      node.Data := TGIS_LegendItemData.Create( _layer, _root, FViewer ) ;

    if opShowSubLayers and assigned( la.SubLayers ) then begin
      for i := 0 to la.SubLayers.Count - 1 do
        addLayerNode( TGIS_Layer(la.SubLayers[i]), _root, node ) ;
    end ;
  ...
  function TGIS_Legend.ensureTopOffset : Boolean ;
  var
    tmp : Integer ;
  begin
    Result := True ;
    ...
    if tmp < 0 then
      tmp := 0 ;
    if ( tmp = 0 ) and ( FTopOffset < 0 ) then begin
      Result := False ;
      TopOffset := 0 ;
    end;
    if tmp > 0 then begin
      if FLength + FTopOffset < oParent.ControlClientHeight then begin
        Result := False ;
        TopOffset := - tmp ;
      end;
    end ;
  ...
  var
    ...
    begin
      ...
      if assigned( la.SubLayers ) then
        node := addLayerNode( la, la.Name, nil )
      else
        node := addLayerNode( la, '', nil ) ;
      if assigned( node ) then
        FLastNode := node ;
    end ;
  ...
  function TGIS_Legend.GetNodeAt(
    const _x : Integer ;
    const _y : Integer
  ) : TGIS_TreeNode ;
  var
  ...
  begin
    ...
    if oParent.ControlRightToLeft then
      ...
      rct_left := rct.Left + {$IFDEF JAVA}apScale(16 - _node.Level * 4){$ELSE}apScale( 16 ){$ENDIF} ;
  ...
  begin
    ...
    node := GetNodeAt( ptDrag.X, ptDrag.Y ) ;
  ...
  var
    ...
    begin
      ...
      for ii := StringFirst+2 to StringLast( _dd.ChartMap ) do begin
        ...
        if _dd.ChartMap[ii] = '1' then begin
          ...
          oParent.ControlStyleDrawImage( oBMPFactory.GetBitmap, _l, _t, false ) ;
          if _dd.ChartLegend.Count > ii-StringFirst then begin
    ...
    begin
      ...
      if ppix.ShowLegend then begin
        if not TGIS_Bitmap.IsNilOrEmpty( ppix.LegendImage ) then begin
          if oParent.ControlRightToLeft then
            oParent.ControlStyleDrawImage( ppix.LegendImage,
  ...
  begin
    ...
    //var selNode := findNodeByName( sLastSelected ) ;
...
//      if _node = selNode then
//        oParent.ControlStyleDrawRectangle(
//          rct.Left, rct.Top, rct.Width, rct.Height-1,
//          oParent.ControlStyleGetColor, TGIS_Color.Blue
//        ) ;
    end ;
    ...
    try
      ...
      if _action or not isTouch then begin
        ...
        if _isCtrl then
          ...
          if Mode = TGIS_ControlLegendMode.Layers then begin
              if _isShft and assigned( SelectedNodeEx ) then begin
                if dt.DataType =  TGIS_LegendItemType.Params then begin
                  sidx := Min(node.Parent.Index, SelectedNodeEx.Index) ;
                  eidx := Max(node.Parent.Index, SelectedNodeEx.Index) ;
                end
                else if dt.DataType = TGIS_LegendItemType.Empty then begin
                  sidx := Min(node.Parent.Parent.Index, SelectedNodeEx.Index) ;
                  eidx := Max(node.Parent.Parent.Index, SelectedNodeEx.Index) ;
                end
                else begin
                  sidx := Min(node.Index, SelectedNodeEx.Index) ;
                  eidx := Max(node.Index, SelectedNodeEx.Index) ;
                end ;

                SelectedNodeEx.Selected := False ;
                for i := sidx to eidx do
                  FItems.SelectedEx := FItems[i]
              end
              else
                SelectedNode := node ;
          end
        ...
        sLastSelected := node.Text ;
        if assigned( SelectedNode ) or assigned( SelectedNodeEx ) then
  ...
  begin
    ...
    ptTouch.X := RoundS( _x ) ;
    ptTouch.Y := RoundS( _y ) ;
    MouseDown( _x, _y, True, False, False, _handled ) ;
  end ;
  ...
  var
    ...
    begin
      ...
      for ii := 0 to _g.LayersCount - 1 do begin
        if assigned( TGIS_Layer( _g.Layers[ii] ).SubLayers ) then
          addLayerNode( TGIS_Layer( _g.Layers[ii] ), TGIS_Layer( _g.Layers[ii] ).Name, nn )
        else
          addLayerNode( TGIS_Layer( _g.Layers[ii] ), '', nn )
      end;
  ...
  var
    ...
    begin
      ...
      if not dd.IsVector then
        ...
        if src.Chart.ShowLegend and
           ( not IsStringEmpty( dd.ChartMap ) ) then begin
          for ii := StringFirst+2 to StringLast( dd.ChartMap ) do begin
  ...
  begin
    ...
    if dt.DataType = TGIS_LegendItemType.Params then begin
      if _multi then
        SelectedNodeEx := _node.Parent
      else
        SelectedNode := _node.Parent
    end
    else
    if dt.DataType = TGIS_LegendItemType.Empty then begin
      if _multi then
        SelectedNodeEx := _node.Parent.Parent
      else
  ...
  procedure TGIS_Legend.Expand(
    ...
    begin
      ...
      for i := 0 to _group.GroupsCount - 1 do
        _expand( _group.Groups[i], _deep, _layers ) ;
  ...
  procedure TGIS_Legend.Collapse(
    ...
    begin
      ...
      for i := 0 to _group.GroupsCount - 1 do
        _collapse( _group.Groups[i], _deep, _layers ) ;
  ...
  begin
    _collapse( _group, _deep, _layers ) ;
    safeRepaint ;
  end ;
