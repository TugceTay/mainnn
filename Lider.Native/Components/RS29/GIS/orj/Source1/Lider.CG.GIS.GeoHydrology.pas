...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoHydrology ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoHydrology"'}
{$ENDIF}
{$IFDEF CLR}
...
{$REGION 'Lider.CG.GIS.GeoHydrology'}
class procedure GisHydrology.SelfRegisterPipeline ;
begin
  RegisterPipeline(
    'Hydrology.Basin',
...
{$IFNDEF OXYGENE}
  initialization
    {$IFDEF DCC}
      GisHydrology.SelfRegisterPipeline ;
    {$ENDIF}
