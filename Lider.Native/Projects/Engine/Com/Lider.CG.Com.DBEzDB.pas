...
procedure TlicgBaseDataset.InternalSetToRecord(Buffer: PChar);
begin
...
function TlicgTable.Navigate(Buffer: PChar; GetMode: TGetMode; doCheck: Boolean): TGetResult;
var
  Acceptable: Boolean;
begin
...
function TlicgDesignTable.Navigate(Buffer: PChar; GetMode: TGetMode;
