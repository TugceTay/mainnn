...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoLayerGDAL ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoLayerGDAL"'}
{$ENDIF}
{$IFDEF CLR}
...
//==============================================================================
  ...
  begin
    ...
    if ( CompareText( GetFileExt( Path ), GIS_TTKPS_EXT    ) = 0 ) or
      ...
      try
        ...
        TGIS_FileGDAL(FGDAL).OpenDataset ;
      finally
        FreeObject( config ) ;
      end ;
    end
 ...
 begin
  ...
  class procedure GisLayerGDAL.SelfRegisterLayer() ;
  begin
...
{$IFNDEF OXYGENE}
  initialization
    GisLayerGDAL.SelfRegisterLayer() ;
{$ENDIF}
