...
//=============================================================================
{
  FMX implementation of TGIS_PvlViewerWnd
}

unit FMX.GisPvlViewerWnd;
...
type
  T_PvlViewerWnd = class( TGIS_PvlControlFmx, IGIS_PvlViewerWnd, IGIS_Viewer, IGIS_ViewerWnd )
    protected
      /// <inheritdoc"/>
...
{$REGION 'IGIS_Viewer event helpers'}
...
function T_PvlViewerWnd.fget_Color
  : TGIS_Color;
begin
  Result := GISColor( TGIS_ViewerWnd( oControl ).BackgroundColor );
end;
...
begin
  TGIS_ViewerWnd( oControl ).BackgroundColor := FMXColor( _value );
end;
...
function T_PvlViewerWnd.fget_RotationAngle
  : Double;
begin
  Result := TGIS_ViewerWnd( oControl ).RotationAngleEx; // Important to use GIS not FMX property
end;
...
begin
  TGIS_ViewerWnd( oControl ).RotationAngleEx := _value; // Important to use GIS not FMX property
end;
...
function T_PvlViewerWnd.ChangeHash
  : Int64;
begin
  Result := TGIS_ViewerWnd( oControl ).ChangeHash;
end;
...
function T_PvlViewerWnd.FullExtentZoom
  : Double;
begin
  Result := TGIS_ViewerWnd( oControl ).FullExtentZoom
end;
