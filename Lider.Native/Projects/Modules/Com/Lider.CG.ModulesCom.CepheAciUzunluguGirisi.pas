unit Lider.CG.ModulesCom.CepheAciUzunluguGirisi;
...
type
  TfmCepheAciUzunluguGirisi = class(TForm)
    cxLabel1: TcxLabel;
...
var
  fmCepheAciUzunluguGirisi: TfmCepheAciUzunluguGirisi;

implementation

{$R *.dfm}

class function TfmCepheAciUzunluguGirisi.Execute(ACaption: String; APoly: IlicgEntity; ANokta1: TlicgCoor; ANokta2: TlicgCoor; out AAci: Double; PAlan: Double): Double;
var
  Alan, ParselAlani: Double;
begin
  Result := 0;
  with TfmCepheAciUzunluguGirisi.Create(nil) do
  try
    Caption := ACaption;
    ...
    begin
      ...
      ParselAlani := PAlan;//Abs(APoly.Geometry.Points.Area);
    end;
