...
//=============================================================================
{
  FMX implementation of TGIS_PvlControlScale
}


unit FMX.GisPvlControlScale ;
{$HPPEMIT '#pragma link "FMX.GisPvlControlScale"'}
...
type
  ...
  T_PvlControlScale = class( TGIS_PvlControlFmx, IGIS_PvlControlScale, IGIS_PrintableControl )
    private
...
begin
  TGIS_ControlScale( oControl ).Font := FMXFont( _value ) ;
end ;
...
begin
  TGIS_ControlScale( oControl ).TextColor := FMXColor( _value ) ;
end ;

function T_PvlControlScale.fget_TextColor
  : TGIS_Color ;
begin
  Result := GISColor( TGIS_ControlScale( oControl ).TextColor ) ;
end;
...
begin
  TGIS_ControlScale( oControl ).DividerColor1 := FMXColor( _value ) ;
end ;
...
begin
  TGIS_ControlScale( oControl ).DividerColor2 := FMXColor( _value ) ;
end ;
...
begin
  TGIS_ControlScale( oControl ).ShadowColor := FMXColor( _value ) ;
end ;
...
begin
  oControl := TGIS_ControlScale.Create( TFmxObject( _context.NativeParent ) );
