...
unit Lider.CG.GIS.FMX.GeoPrintLegend ;
{$HPPEMIT '#pragma link "Lider.CG.GIS.FMX.GeoPrintLegend"'}
  ...
  var
    ...
    begin
      ...
      try
        gg.NativeBitmap := _b ;
        if RightToLeft then
          rr := Rect( oBitmap.Width - _l - gg.Width, _t + 3,
                      oBitmap.Width - _l, _t + gg.Height + 3 )
        else
          rr := Rect( _l, _t + 3, _l + gg.Width, _t + gg.Height + 3 ) ;
