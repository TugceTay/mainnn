...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoViewer ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoViewer"'}
{$ENDIF}
{$IFDEF CLR}
...
//                                        {$IFNDEF GIS_NOINLINE1} inline; {$ENDIF}
    ...
    public // IGIS_Viewer public properties
      ...
      /// <inheritdoc from="IGIS_Viewer"/>
      property ViewerParent : IGIS_ViewerParent read fget_ViewerParent ;
...
const
  {$IFDEF CLR}
    ResourceBaseName = 'Lider.CG.GIS.GeoViewer';
  {$ENDIF}
...
begin
  ...
  FCopyright := 'LicadGIS Developer Kernel. ' +
                GIS_VERSION + ' ' +
                GIS_COPYRIGHT ; // ilker deðiþtirme
...
procedure TGIS_Viewer.SetViewport( var _x, _y : Double ) ;
begin
