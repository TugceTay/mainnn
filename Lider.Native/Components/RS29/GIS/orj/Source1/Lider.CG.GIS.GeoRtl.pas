...
unit Lider.CG.GIS.GeoRtl;
{$HPPEMIT '#pragma link "Lider.CG.GIS.GeoRtl"}
...
type
  ...
  /// </summary>
  TGIS_Object = Lider.CG.GIS.GeoBaseObject.TGIS_Object ;

  /// <summary>
  ///   Base object for all TGIS_ classes. Mother of all classes.
  ///   Used when object must be disposed (like stream etc.)
  /// </summary>
  TGIS_ObjectDisposable = Lider.CG.GIS.GeoBaseObject.TGIS_ObjectDisposable ;

  /// <summary>
  ///   Base object for all TGIS_ classes. Mother of all classes.
  ///   Used as a base class for all layers.
  /// </summary>
  TGIS_BaseObjectDisposable = Lider.CG.GIS.GeoBaseObject.TGIS_BaseObjectDisposable ;
...
/// <summary>
///   Check if object has en empty content or is nil.
/// </summary>
/// <param name="_val">
///   object to tested
/// </param>
/// <returns>
///   True, if string has not content.
/// </returns>
function IsStringEmpty( const _val : String
                      ) : Boolean ; inline ;
...
///    </note>
/// </remarks>
function StringLast   ( const _val : String
                      ) : Integer ; inline ;
{$ENDREGION}
...
{$REGION 'Float converters'}
  ...
  begin
    ...
    try
      FormatSettings.DecimalSeparator := '.' ;
      Result := FloatToStr( RoundTo( _val, -_prec ) ) ;
    finally
      FormatSettings.DecimalSeparator := oldsep ;
    end ;
  end ;
