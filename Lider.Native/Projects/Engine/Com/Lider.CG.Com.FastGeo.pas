...
interface
uses
  Lider.CG.Com.GeoTypes, Lider.CG.Com.VectorInt;
{$IFNDEF FASTGEO}
  {$DEFINE FASTGEO}
{$ENDIF}
(****************************************************************************)
...
(**********[ Polygon Vertex type  ]************)
type TPolygon2D     = array of TlicgCoor;
type TPolygon2DPtr  = ^TPolygon2D;
type TPolyLine2D     = array of TlicgCoor;
type TPolyLine2DPtr  = ^TPolyLine2D;
type TPolygon3D     = array of TlicgCoor3D;
...
type TBarycentricUnit       = record x1,y1,x2,y2,x3,y3,delta : double; end;
type TBarycentricUnitPtr    = ^TBarycentricUnit;
type TBarycentricTriplet    = record u,v,w : double; end;
...
type TGeometricObjectPtr = ^TGeometricObject;
     TGeometricObject = record
       case ObjectType : eGeometricObjectTypes of
         geoPoint2D           : (Point2D    : TlicgCoor          );
         geoPoint3D           : (Point3D    : TlicgCoor3D          );
         geoLine2D            : (Line2D     : TlicgLine           );
         geoLine3D            : (Line3D     : TlicgLine3D           );
         geoSegment2D         : (Segment2D  : TSegment2D        );
         geoSegment3D         : (Segment3D  : TSegment3D        );
         geoTriangle2D        : (Triangle2D : TlicgTriangle       );
         geoTriangle3D        : (Triangle3D : TlicgTriangle3D       );
...
const Epsilon_Low       = 1.0E-08;   (* bizdeki ayný _EPSILON       = 1.0E-8; // ilker deðiþtirme 1.0E-16; *)
const FastGeoEpsilon    = Epsilon_Medium;
...
function RobustOrientation(const x1,y1,x2,y2,Px,Py:double):Integer;                                                            overload;
function RobustOrientation(const x1,y1,z1,x2,y2,z2,x3,y3,z3,Px,Py,Pz:double):Integer;                                          overload;
function Orientation(const Point1,Point2:TlicgCoor; const Px,Py:double):Integer;                                                overload;
function Orientation(const Point1,Point2,Point3:TlicgCoor):Integer;                                                             overload;
function Orientation(const Line:TlicgLine; const Point:TlicgCoor):Integer;                                                        overload;
function Orientation(const Segment:TSegment2D; const Point:TlicgCoor):Integer;                                                  overload;
function Orientation(const Point1,Point2,Point3:TlicgCoor3D; const Px,Py,Pz:double):Integer;                                      overload;
function Orientation(const Point1,Point2,Point3,Point4:TlicgCoor3D):Integer;                                                      overload;
function Orientation(const Triangle:TlicgTriangle3D; const Point:TlicgCoor3D):Integer;                                                overload;
...
function Signed(const Point1,Point2:TlicgCoor; const Px,Py:double):double;                                                      overload;
function Signed(const Point1,Point2,Point3:TlicgCoor):double;                                                                   overload;
function Signed(const Line:TlicgLine; const Point:TlicgCoor):double;                                                              overload;
function Signed(const Segment:TSegment2D; const Point:TlicgCoor):double;                                                        overload;
function Signed(const Point1,Point2,Point3:TlicgCoor3D; const Px,Py,Pz:double):double;                                            overload;
function Signed(const Point1,Point2,Point3,Point4:TlicgCoor3D):double;                                                            overload;
function Signed(const Triangle:TlicgTriangle3D; const Point:TlicgCoor3D):double;                                                      overload;
...
function Collinear(const PointA,PointB,PointC:TlicgCoor):Boolean;                                                               overload;
function Collinear(const x1,y1,z1,x2,y2,z2,x3,y3,z3:double):Boolean;                                                           overload;
function Collinear(const PointA,PointB,PointC:TlicgCoor3D):Boolean;                                                               overload;
function RobustCollinear(const x1,y1,x2,y2,x3,y3:double; const Epsilon : double = Epsilon_High):Boolean;                       overload;
function RobustCollinear(const PointA,PointB,PointC:TlicgCoor;  const Epsilon : double = Epsilon_High):Boolean;                 overload;
function Coplanar(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4:double):Boolean;                                                   overload;
function Coplanar(const PointA,PointB,PointC,PointD:TlicgCoor3D):Boolean;                                                         overload;
function IsPointCollinear(const x1,y1,x2,y2,Px,Py:double;                   const Robust : Boolean = False):Boolean;           overload;
function IsPointCollinear(const PointA,PointB,PointC:TlicgCoor;              const Robust : Boolean = False):Boolean;           overload;
function IsPointCollinear(const PointA,PointB:TlicgCoor; const Px,Py:double; const Robust : Boolean = False):Boolean;           overload;
function IsPointCollinear(const Segment:TSegment2D; const PointC:TlicgCoor;  const Robust : Boolean = False):Boolean;           overload;
function IsPointCollinear(const x1,y1,z1,x2,y2,z2,Px,Py,Pz:double):Boolean;                                                    overload;
function IsPointCollinear(const PointA,PointB,PointC:TlicgCoor3D):Boolean;                                                        overload;
function IsPointCollinear(const Segment:TSegment3D; const PointC:TlicgCoor3D):Boolean;                                            overload;
function IsPointOnRightSide(const Px,Py,x1,y1,x2,y2:double):Boolean;                                                           overload;
function IsPointOnRightSide(const x,y:double; const Segment:TSegment2D):Boolean;                                               overload;
function IsPointOnRightSide(const Point:TlicgCoor; const Segment:TSegment2D):Boolean;                                           overload;
function IsPointOnRightSide(const x,y:double; const Line:TlicgLine):Boolean;                                                     overload;
function IsPointOnRightSide(const Point:TlicgCoor; const Line:TlicgLine):Boolean;                                                 overload;
function IsPointOnLeftSide(const Px,Py,x1,y1,x2,y2:double):Boolean;                                                            overload;
function IsPointOnLeftSide(const x,y:double; const Segment:TSegment2D):Boolean;                                                overload;
function IsPointOnLeftSide(const Point:TlicgCoor; const Segment:TSegment2D):Boolean;                                            overload;
function IsPointOnLeftSide(const x,y:double; const Line:TlicgLine):Boolean;                                                      overload;
function IsPointOnLeftSide(const Point:TlicgCoor; const Line:TlicgLine):Boolean;                                                  overload;
...
function Intersect(const Point1,Point2,Point3,Point4:TlicgCoor):Boolean;                                                        overload;
function Intersect(const Segment1,Segment2:TSegment2D):Boolean;                                                                overload;
function Intersect(const Segment1,Segment2:TSegment2D; out ix, iy : double):Boolean;                                           overload;
function Intersect(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4:double; const fuzzy:double = 0.0):Boolean;                        overload;
function Intersect(const P1,P2,P3,P4:TlicgCoor3D; const fuzzy:double = 0.0):Boolean;                                              overload;
function Intersect(const Segment1,Segment2:TSegment3D; const fuzzy:double = 0.0):Boolean;                                      overload;
function Intersect(const Segment:TSegment2D;   const Rectangle : TRectangle):Boolean;                                          overload;
function Intersect(const Segment:TSegment2D;   const Triangle  : TlicgTriangle):Boolean;                                         overload;
function Intersect(const Segment:TSegment2D;   const Quadix    : TQuadix2D):Boolean;                                           overload;
function Intersect(const Segment:TSegment2D;   const Line      : TlicgLine):Boolean;                                             overload;
...
function Intersect(const Line:TlicgLine;         const Triangle  : TlicgTriangle):Boolean;                                         overload;
function Intersect(const Line:TlicgLine;         const Quadix    : TQuadix2D):Boolean;                                           overload;
function Intersect(const Line:TlicgLine;         const Circle    : TCircle):Boolean;                                             overload;
function Intersect(const Line:TlicgLine3D;         const Triangle  : TlicgTriangle3D; out IPoint: TlicgCoor3D):Boolean;                   overload;
function Intersect(const Triangle:TlicgTriangle; const Circle    : TCircle):Boolean;                                             overload;
function Intersect(const Triangle:TlicgTriangle; const Rectangle : TRectangle):Boolean;                                          overload;
function Intersect(const Rectangle1,Rectangle2:TRectangle):Boolean;                                                            overload;
function Intersect(const Triangle1,Triangle2:TlicgTriangle):Boolean;                                                             overload;
...
function SimpleIntersect(const x1,y1,x2,y2,x3,y3,x4,y4:double):Boolean;                                                        overload;
function SimpleIntersect(const Point1,Point2,Point3,Point4:TlicgCoor):Boolean;                                                  overload;
function SimpleIntersect(const Segment1,Segment2:TSegment2D):Boolean;                                                          overload;
function ThickSegmentIntersect(const x1,y1,x2,y2,x3,y3,x4,y4,Thickness:double):Boolean;                                        overload;
function ThickSegmentIntersect(const Point1,Point2,Point3,Point4:TlicgCoor; const Thickness:double):Boolean;                    overload;
function ThickSegmentIntersect(const Segment1,Segment2:TSegment2D;         const Thickness:double):Boolean;                    overload;
function ThickSegmentIntersect(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4,        Thickness:double):Boolean;                    overload;
function ThickSegmentIntersect(const Point1,Point2,Point3,Point4:TlicgCoor3D; const Thickness:double):Boolean;                    overload;
function ThickSegmentIntersect(const Segment1,Segment2:TSegment3D;         const Thickness:double):Boolean;                    overload;
/// <summary>
///   <para>
///     ilker ekleme
///   </para>
///   <para>
///     Doðru ve Vector doðrularýnda kesiþimlerin hepsinin koordinatýný bulur ve listesini getirir.
///     Doðrular sonsuza kadar uzatýr eðer kesiþim varsa True döndürür yoksa
///     False döndürür.
///   </para>
/// </summary>
function IntersectionPoint(const P1, P2:TlicgCoor; AVector: IlicgVector; var AResultVector: IlicgVector): Boolean; overload;  // ilker ekleme
...
///   </para>
/// </summary>
function IntersectionPoint(const P1, P2, P3, P4:TlicgCoor; out ACoor: TlicgCoor): Boolean; overload;  // ilker ekleme
procedure IntersectionPoint(const x1,y1,x2,y2,x3,y3,x4,y4:double; out Nx,Ny:double);                                           overload;
procedure IntersectionPoint(const P1,P2,P3,P4:TlicgCoor; out Nx,Ny:double);                                                     overload;
function  IntersectionPoint(const P1,P2,P3,P4:TlicgCoor):TlicgCoor;                                                              overload;
function  IntersectionPoint(const Segment1,Segment2:TSegment2D):TlicgCoor;                                                      overload;
function  IntersectionPoint(const Line1,Line2:TlicgLine):TlicgCoor;                                                               overload;
procedure IntersectionPoint(const Circle1,Circle2:TCircle; out Point1,Point2:TlicgCoor);                                        overload;
procedure IntersectionPoint(const Segment:TSegment2D; const Triangle:TlicgTriangle; out ICnt:Integer; out I1,I2:TlicgCoor);       overload;
procedure IntersectionPoint(const Line:TlicgLine3D; const Triangle:TlicgTriangle3D; out IPoint:TlicgCoor3D);                              overload;
procedure IntersectionPoint(const x1,y1,x2,y2,Cx,Cy,Radius:double; out ICnt:Integer; out Ix1,Iy1,Ix2,Iy2:double);              overload;
procedure IntersectionPoint(const Segment:TSegment2D; const Circle:TCircle; out ICnt:Integer; out I1,I2:TlicgCoor);             overload;
function  NormalizeAngle  (const Angle : double) : double;
function  VerticalMirror  (const Angle : double) : double;
function  HorizontalMirror(const Angle : double) : double;
function Quadrant(const Angle : double  ):Integer;                                                                             overload;
function Quadrant(const x,y   : double  ):Integer;                                                                             overload;
function Quadrant(const Point : TlicgCoor):Integer;                                                                             overload;
function VertexAngle(x1,y1,x2,y2,x3,y3:double):double;                                                                         overload;
function VertexAngle(const Point1,Point2,Point3:TlicgCoor):double;                                                              overload;
function VertexAngle(x1,y1,z1,x2,y2,z2,x3,y3,z3:double):double;                                                                overload;
function VertexAngle(const Point1,Point2,Point3:TlicgCoor3D):double;                                                              overload;
function OrientedVertexAngle(const x1,y1,x2,y2,x3,y3:double;      const Orient : Integer = Clockwise):double;                  overload;
function OrientedVertexAngle(const Point1,Point2,Point3:TlicgCoor; const Orient : Integer = Clockwise):double;                  overload;
function CartesianAngle(const x,y   : double  ):double;                                                                        overload;
function CartesianAngle(const Point : TlicgCoor):double;                                                                        overload;
function RobustCartesianAngle(const x,y   : double;  const Epsilon : double = Epsilon_High):double;                            overload;
function RobustCartesianAngle(const Point : TlicgCoor;const Epsilon : double = Epsilon_High):double;                            overload;
function SegmentIntersectAngle(const Point1,Point2,Point3,Point4:TlicgCoor):double;                                             overload;
function SegmentIntersectAngle(const Segment1,Segment2:TSegment2D):double;                                                     overload;
function SegmentIntersectAngle(const Point1,Point2,Point3,Point4:TlicgCoor3D):double;                                             overload;
function SegmentIntersectAngle(const Segment1,Segment2:TSegment3D):double;                                                     overload;
function InPortal(const P:TlicgCoor):Boolean;                                                                                   overload;
function InPortal(const P:TlicgCoor3D):Boolean;                                                                                   overload;
function HighestPoint(const Polygon  : TPolygon2D):TlicgCoor;                                                                   overload;
function HighestPoint(const Point    : array of TlicgCoor):TlicgCoor;                                                            overload;
function HighestPoint(const Triangle : TlicgTriangle):TlicgCoor;                                                                  overload;
function HighestPoint(const Triangle : TlicgTriangle3D):TlicgCoor3D;                                                                  overload;
function HighestPoint(const Quadix   : TQuadix2D):TlicgCoor;                                                                    overload;
function HighestPoint(const Quadix   : TQuadix3D):TlicgCoor3D;                                                                    overload;
function LowestPoint(const Polygon   : TPolygon2D):TlicgCoor;                                                                   overload;
function LowestPoint(const Point     : array of TlicgCoor):TlicgCoor;                                                            overload;
function LowestPoint(const Triangle  : TlicgTriangle):TlicgCoor;                                                                  overload;
function LowestPoint(const Triangle  : TlicgTriangle3D):TlicgCoor3D;                                                                  overload;
function LowestPoint(const Quadix    : TQuadix2D):TlicgCoor;                                                                    overload;
function LowestPoint(const Quadix    : TQuadix3D):TlicgCoor3D;                                                                    overload;
function MostLeftPoint(const Polygon: TPolygon2D):TlicgCoor;                                                                    overload;
function MostLeftPoint(const Point: array of TlicgCoor):TlicgCoor;                                                               overload;
function MostRightPoint(const Polygon: TPolygon2D):TlicgCoor;                                                                   overload;
function MostRightPoint(const Point: array of TlicgCoor):TlicgCoor;                                                              overload;
function MostUpperRight(const Polygon: TPolygon2D):TlicgCoor;                                                                   overload;
function MostUpperRight(const Point: array of TlicgCoor):TlicgCoor;                                                              overload;
function MostUpperLeft(const Polygon: TPolygon2D):TlicgCoor;                                                                    overload;
function MostUpperLeft(const Point: array of TlicgCoor):TlicgCoor;                                                               overload;
function MostLowerRight(const Polygon: TPolygon2D):TlicgCoor;                                                                   overload;
function MostLowerRight(const Point: array of TlicgCoor):TlicgCoor;                                                              overload;
function MostLowerLeft(const Polygon: TPolygon2D):TlicgCoor;                                                                    overload;
function MostLowerLeft(const Point: array of TlicgCoor):TlicgCoor;                                                               overload;
...
function Coincident(const Point1,Point2:TlicgCoor):Boolean;                                                                     overload;
function Coincident(const Point1,Point2:TlicgCoor3D):Boolean;                                                                     overload;
...
function Coincident(const Triangle1,Triangle2:TlicgTriangle):Boolean;                                                            overload;
function Coincident(const Triangle1,Triangle2:TlicgTriangle3D):Boolean;                                                            overload;
...
function Parallel(const x1,y1,x2,y2,x3,y3,x4,y4:double;       const Epsilon:double = Epsilon_Medium):Boolean;                  overload;
function Parallel(const Point1,Point2,Point3,Point4:TlicgCoor; const Epsilon:double = Epsilon_Medium):Boolean;                  overload;
function Parallel(const Segment1,Segment2:TSegment2D;         const Epsilon:double = Epsilon_Medium):Boolean;                  overload;
function Parallel(const Line1,Line2:TlicgLine;                  const Epsilon:double = Epsilon_Medium):Boolean;                  overload;
function Parallel(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4:double; const Epsilon:double = Epsilon_Medium):Boolean;            overload;
function Parallel(const Point1,Point2,Point3,Point4:TlicgCoor3D;       const Epsilon:double = Epsilon_Medium):Boolean;            overload;
function Parallel(const Segment1,Segment2:TSegment3D;               const Epsilon:double = Epsilon_Medium):Boolean;            overload;
function Parallel(const Line1,Line2:TlicgLine3D;                        const Epsilon:double = Epsilon_Medium):Boolean;            overload;
function RobustParallel(const x1,y1,x2,y2,x3,y3,x4,y4:double;       const Epsilon:double = Epsilon_Medium):Boolean;            overload;
function RobustParallel(const Point1,Point2,Point3,Point4:TlicgCoor; const Epsilon:double = Epsilon_Medium):Boolean;            overload;
function RobustParallel(const Segment1,Segment2:TSegment2D;         const Epsilon:double = Epsilon_Medium):Boolean;            overload;
function RobustParallel(const Line1,Line2:TlicgLine;                  const Epsilon:double = Epsilon_Medium):Boolean;            overload;
function RobustParallel(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4:double;const Epsilon:double = Epsilon_Medium):Boolean;       overload;
function RobustParallel(const Point1,Point2,Point3,Point4:TlicgCoor3D;      const Epsilon:double = Epsilon_Medium):Boolean;       overload;
function RobustParallel(const Segment1,Segment2:TSegment3D;              const Epsilon:double = Epsilon_Medium):Boolean;       overload;
function RobustParallel(const Line1,Line2:TlicgLine3D;                       const Epsilon:double = Epsilon_Medium):Boolean;       overload;
function Perpendicular(const x1,y1,x2,y2,x3,y3,x4,y4:double;       const Epsilon:double = Epsilon_Medium):Boolean;             overload;
function Perpendicular(const Point1,Point2,Point3,Point4:TlicgCoor; const Epsilon:double = Epsilon_Medium):Boolean;             overload;
function Perpendicular(const Segment1,Segment2:TSegment2D;         const Epsilon:double = Epsilon_Medium):Boolean;             overload;
function Perpendicular(const Line1,Line2:TlicgLine;                  const Epsilon:double = Epsilon_Medium):Boolean;             overload;
function Perpendicular(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4:double; const Epsilon:double = Epsilon_Medium):Boolean;       overload;
function Perpendicular(const Point1,Point2,Point3,Point4:TlicgCoor3D;       const Epsilon:double = Epsilon_Medium):Boolean;       overload;
function Perpendicular(const Segment1,Segment2:TSegment3D;               const Epsilon:double = Epsilon_Medium):Boolean;       overload;
function Perpendicular(const Line1,Line2:TlicgLine3D;                        const Epsilon:double = Epsilon_Medium):Boolean;       overload;
function RobustPerpendicular(const x1,y1,x2,y2,x3,y3,x4,y4:double;       const Epsilon:double = Epsilon_Medium):Boolean;       overload;
function RobustPerpendicular(const Point1,Point2,Point3,Point4:TlicgCoor; const Epsilon:double = Epsilon_Medium):Boolean;       overload;
function RobustPerpendicular(const Segment1,Segment2:TSegment2D;         const Epsilon:double = Epsilon_Medium):Boolean;       overload;
function RobustPerpendicular(const Line1,Line2:TlicgLine;                  const Epsilon:double = Epsilon_Medium):Boolean;       overload;
function RobustPerpendicular(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4:double; const Epsilon:double = Epsilon_Medium):Boolean; overload;
function RobustPerpendicular(const Point1,Point2,Point3,Point4:TlicgCoor3D;       const Epsilon:double = Epsilon_Medium):Boolean; overload;
function RobustPerpendicular(const Segment1,Segment2:TSegment3D;               const Epsilon:double = Epsilon_Medium):Boolean; overload;
function RobustPerpendicular(const Line1,Line2:TlicgLine3D;                        const Epsilon:double = Epsilon_Medium):Boolean; overload;
function LineToLineIntersect(x1,y1,x2,y2,x3,y3,x4,y4:double):Boolean;                                                          overload;
function LineToLineIntersect(Line1,Line2:TlicgLine):Boolean;                                                                     overload;
...
function RectangleWithinRectangle(const x1,y1,x2,y2,x3,y3,x4,y4:double):Boolean;                                               overload;
function RectangleWithinRectangle(const Rectangle1,Rectangle2:TRectangle):Boolean;                                             overload;
function CircleWithinRectangle(const x,y,Radius,x1,y1,x2,y2:double):Boolean;                                                   overload;
function CircleWithinRectangle(const Circle:TCircle; const Rectangle:TRectangle):Boolean;                                      overload;
function TriangleWithinRectangle(const x1,y1,x2,y2,x3,y3,x4,y4,x5,y5:double):Boolean;                                          overload;
function TriangleWithinRectangle(const Triangle:TlicgTriangle; const Rectangle:TRectangle):Boolean;                              overload;
function SegmentWithinRectangle(const x1,y1,x2,y2,x3,y3,x4,y4:double):Boolean;                                                 overload;
...
function PointOfReflection(const Segment:TSegment2D; const P1,P2:TlicgCoor; out RP:TlicgCoor):Boolean;                           overload;
procedure Mirror(const Px,Py,x1,y1,x2,y2:double;     out   Nx,Ny:double);                                                      overload;
function  Mirror(const Point     : TlicgCoor;         const Line:TlicgLine):TlicgCoor;                                             overload;
function  Mirror(const Segment   : TSegment2D;       const Line:TlicgLine):TSegment2D;                                           overload;
function  Mirror(const Rectangle : TRectangle;       const Line:TlicgLine):TRectangle;                                           overload;
function  Mirror(const Triangle  : TlicgTriangle;      const Line:TlicgLine):TlicgTriangle;                                          overload;
function  Mirror(const Quadix    : TQuadix2D;        const Line:TlicgLine):TQuadix2D;                                            overload;
function  Mirror(const Circle    : TCircle;          const Line:TlicgLine):TCircle;                                              overload;
function  Mirror(const Obj       : TGeometricObject; const Line:TlicgLine):TGeometricObject;                                     overload;
procedure NonSymmetricMirror(const Px,Py,x1,y1,x2,y2:double; const Ratio:double; out   Nx,Ny:double);                          overload;
function  NonSymmetricMirror(const Point:TlicgCoor;           const Ratio:double; const Line:TlicgLine):TlicgCoor;                 overload;
function  NonSymmetricMirror(const Segment:TSegment2D;       const Ratio:double; const Line:TlicgLine):TSegment2D;               overload;
function  NonSymmetricMirror(const Rectangle:TRectangle;     const Ratio:double; const Line:TlicgLine):TRectangle;               overload;
function  NonSymmetricMirror(const Triangle:TlicgTriangle;     const Ratio:double; const Line:TlicgLine):TlicgTriangle;              overload;
function  NonSymmetricMirror(const Quadix:TQuadix2D;         const Ratio:double; const Line:TlicgLine):TQuadix2D;                overload;
function  NonSymmetricMirror(const Circle:TCircle;           const Ratio:double; const Line:TlicgLine):TCircle;                  overload;
function  NonSymmetricMirror(const Obj:TGeometricObject;     const Ratio:double; const Line:TlicgLine):TGeometricObject;         overload;
function Distance(const x1,y1,x2,y2:double):double;                                                                            overload;
function Distance(const Point1,Point2:TlicgCoor):double;                                                                        overload;
function Distance(const x1,y1,z1,x2,y2,z2:double):double;                                                                      overload;
function Distance(const Point1,Point2:TlicgCoor3D):double;                                                                        overload;
function Distance(const Point:TlicgCoor; const Segment:TSegment2D):double;                                                      overload;
function Distance(const Point:TlicgCoor; const Rectangle:TRectangle):double;                                                    overload;
function Distance(const Point:TlicgCoor; const Triangle:TlicgTriangle):double;                                                    overload;
function Distance(const Point:TlicgCoor; const Quadix:TQuadix2D):double;                                                        overload;
function Distance(const Line1,Line2:TlicgLine):double;                                                                           overload;
function Distance(const Line1,Line2:TlicgLine3D):double;                                                                           overload;
function Distance(const Segment1,Segment2:TSegment2D):double;                                                                  overload;
function Distance(const Segment1,Segment2:TSegment3D):double;                                                                  overload;
function Distance(const Segment:TSegment2D):double;                                                                            overload;
function Distance(const Segment:TSegment3D):double;                                                                            overload;
function Distance(const Segment:TSegment2D; const Triangle:TlicgTriangle):double;                                                overload;
function Distance(const Segment:TSegment3D; const Triangle:TlicgTriangle3D):double;                                                overload;
function Distance(const Segment:TSegment2D; const Rectangle:TRectangle):double;                                                overload;
function Distance(const Segment:TSegment2D; const Circle:TCircle):double;                                                      overload;
function Distance(const Triangle1,Triangle2:TlicgTriangle):double;                                                               overload;
function Distance(const Triangle:TlicgTriangle; const Rectangle:TRectangle):double;                                              overload;
function Distance(const Rectangle1,Rectangle2:TRectangle):double;                                                              overload;
function Distance(const Triangle:TlicgTriangle; const Circle:TCircle):double;                                                    overload;
function Distance(const Rectangle:TRectangle; const Circle:TCircle):double;                                                    overload;
function Distance(const Point : TlicgCoor; const Circle:TCircle):double;                                                        overload;
function Distance(const Circle1,Circle2:TCircle):double;                                                                       overload;
function Distance(const Sphere1,Sphere2:TSphere):double;                                                                       overload;
function Distance(const Obj1,Obj2:TGeometricObject):double;                                                                    overload;
function LayDistance(const x1,y1,x2,y2:double):double;                                                                         overload;
function LayDistance(const Point1,Point2:TlicgCoor):double;                                                                     overload;
function LayDistance(const x1,y1,z1,x2,y2,z2:double):double;                                                                   overload;
function LayDistance(const Point1,Point2:TlicgCoor3D):double;                                                                     overload;
function LayDistance(const Point:TlicgCoor; const Triangle:TlicgTriangle):double;                                                 overload;
function LayDistance(const Point:TlicgCoor; const Quadix:TQuadix2D):double;                                                     overload;
function LayDistance(const Segment1,Segment2:TSegment2D):double;                                                               overload;
function LayDistance(const Segment1,Segment2:TSegment3D):double;                                                               overload;
function LayDistance(const Line1,Line2:TlicgLine):double;                                                                        overload;
function LayDistance(const Line1,Line2:TlicgLine3D):double;                                                                        overload;
function LayDistance(const Segment:TSegment2D):double;                                                                         overload;
function LayDistance(const Segment:TSegment3D):double;                                                                         overload;
function LayDistance(const Segment:TSegment2D; const Triangle:TlicgTriangle):double;                                             overload;
function LayDistance(const Segment:TSegment3D; const Triangle:TlicgTriangle3D):double;                                             overload;
function ManhattanDistance(const x1,y1,x2,y2:double):double;                                                                   overload;
function ManhattanDistance(const Point1,Point2:TlicgCoor):double;                                                               overload;
function ManhattanDistance(const x1,y1,z1,x2,y2,z2:double):double;                                                             overload;
function ManhattanDistance(const Point1,Point2:TlicgCoor3D):double;                                                               overload;
...
function ManhattanDistance(const Circle1,Circle2:TCircle):double;                                                              overload;
function VectorSumDistance(const x1,y1,x2,y2:double):double;                                                                   overload;
function VectorSumDistance(const Point1,Point2:TlicgCoor):double;                                                               overload;
function VectorSumDistance(const x1,y1,z1,x2,y2,z2:double):double;                                                             overload;
function VectorSumDistance(const Point1,Point2:TlicgCoor3D):double;                                                               overload;
function VectorSumDistance(const Segment:TSegment2D):double;                                                                   overload;
function VectorSumDistance(const Segment:TSegment3D):double;                                                                   overload;
function VectorSumDistance(const Circle1,Circle2:TCircle):double;                                                              overload;
function VectorSumDistance(const Obj1,Obj2:TGeometricObject):double;                                                           overload;
function ChebyshevDistance(const x1,y1,x2,y2:double):double;                                                                   overload;
function ChebyshevDistance(const Point1,Point2:TlicgCoor):double;                                                               overload;
function ChebyshevDistance(const x1,y1,z1,x2,y2,z2:double):double;                                                             overload;
function ChebyshevDistance(const Point1,Point2:TlicgCoor3D):double;                                                               overload;
function ChebyshevDistance(const Segment:TSegment2D):double;                                                                   overload;
function ChebyshevDistance(const Segment:TSegment3D):double;                                                                   overload;
function ChebyshevDistance(const Circle1,Circle2:TCircle):double;                                                              overload;
function InverseChebyshevDistance(const x1,y1,x2,y2:double):double;                                                            overload;
function InverseChebyshevDistance(const Point1,Point2:TlicgCoor):double;                                                        overload;
function InverseChebyshevDistance(const x1,y1,z1,x2,y2,z2:double):double;                                                      overload;
function InverseChebyshevDistance(const Point1,Point2:TlicgCoor3D):double;                                                        overload;
function InverseChebyshevDistance(const Segment:TSegment2D):double;                                                            overload;
function InverseChebyshevDistance(const Segment:TSegment3D):double;                                                            overload;
function InverseChebyshevDistance(const Circle1,Circle2:TCircle):double;                                                       overload;
function DistanceSegmentToSegment(const x1,y1,x2,y2,x3,y3,x4,y4:double):double;                                                overload;
function DistanceSegmentToSegment(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4:double):double;                                    overload;
function LayDistanceSegmentToSegment(const x1,y1,x2,y2,x3,y3,x4,y4:double):double;                                             overload;
function LayDistanceSegmentToSegment(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4:double):double;                                 overload;
function DistanceLineToLine(const x1,y1,x2,y2,x3,y3,x4,y4:double):double;                                                      overload;
function DistanceLineToLine(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4:double):double;                                          overload;
function LayDistanceLineToLine(const x1,y1,x2,y2,x3,y3,x4,y4:double):double;                                                   overload;
function LayDistanceLineToLine(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4:double):double;                                       overload;
function TriangleType(const x1,y1,x2,y2,x3,y3:double):eTriangletype;                                                           overload;
function TriangleType(const x1,y1,z1,x2,y2,z2,x3,y3,z3:double):eTriangletype;                                                  overload;
function TriangleType(const Point1,Point2,Point3:TlicgCoor):eTriangletype;                                                      overload;
function TriangleType(const Point1,Point2,Point3:TlicgCoor3D):eTriangletype;                                                      overload;
function TriangleType(const Triangle:TlicgTriangle):eTriangletype;                                                               overload;
function TriangleType(const Triangle:TlicgTriangle3D):eTriangletype;                                                               overload;
...
function IsEquilateralTriangle(const Point1,Point2,Point3:TlicgCoor):Boolean;                                                   overload;
function IsEquilateralTriangle(const Point1,Point2,Point3:TlicgCoor3D):Boolean;                                                   overload;
function IsEquilateralTriangle(const Triangle:TlicgTriangle):Boolean;                                                            overload;
function IsEquilateralTriangle(const Triangle:TlicgTriangle3D):Boolean;                                                            overload;
...
function IsIsoscelesTriangle(const Point1,Point2,Point3:TlicgCoor):Boolean;                                                     overload;
function IsIsoscelesTriangle(const Point1,Point2,Point3:TlicgCoor3D):Boolean;                                                     overload;
function IsIsoscelesTriangle(const Triangle:TlicgTriangle):Boolean;                                                              overload;
function IsIsoscelesTriangle(const Triangle:TlicgTriangle3D):Boolean;                                                              overload;
...
function IsRightTriangle(const Point1,Point2,Point3:TlicgCoor):Boolean;                                                         overload;
function IsRightTriangle(const Point1,Point2,Point3:TlicgCoor3D):Boolean;                                                         overload;
function IsRightTriangle(const Triangle:TlicgTriangle):Boolean;                                                                  overload;
function IsRightTriangle(const Triangle:TlicgTriangle3D):Boolean;                                                                  overload;
...
function IsScaleneTriangle(const Point1,Point2,Point3:TlicgCoor):Boolean;                                                       overload;
function IsScaleneTriangle(const Point1,Point2,Point3:TlicgCoor3D):Boolean;                                                       overload;
function IsScaleneTriangle(const Triangle:TlicgTriangle):Boolean;                                                                overload;
function IsScaleneTriangle(const Triangle:TlicgTriangle3D):Boolean;                                                                overload;
...
function IsObtuseTriangle(const Point1,Point2,Point3:TlicgCoor):Boolean;                                                        overload;
function IsObtuseTriangle(const Point1,Point2,Point3:TlicgCoor3D):Boolean;                                                        overload;
function IsObtuseTriangle(const Triangle:TlicgTriangle):Boolean;                                                                 overload;
function IsObtuseTriangle(const Triangle:TlicgTriangle3D):Boolean;                                                                 overload;
function TriangleEdge(const Triangle:TlicgTriangle; const Edge:Integer):TSegment2D;                                              overload;
function TriangleEdge(const Triangle:TlicgTriangle3D; const Edge:Integer):TSegment3D;                                              overload;
function RectangleEdge(const Rectangle:TRectangle; const Edge:Integer):TSegment2D;
{function PointOnTriangle(const Px,Py,x1,y1,x2,y2,x3,y3:double):Boolean;                                                        overload;
function PointOnTriangle(const Pnt: TlicgCoor; const Triangle: TlicgTriangle): Boolean;                                           overload;}
function PointInTriangle(const Px,Py,x1,y1,x2,y2,x3,y3:double):Boolean;                                                        overload;
function PointInTriangle(const x,y:double; const Triangle:TlicgTriangle):Boolean;                                                overload;
function PointInTriangle(const Point:TlicgCoor; const Triangle:TlicgTriangle):Boolean;                                            overload;
function PointInCircle(const Px,Py,Cx,Cy,Radius:double):Boolean;                                                               overload;
function PointInCircle(const Px,Py:double; const Circle:TCircle):Boolean;                                                      overload;
function PointInCircle(const Point:TlicgCoor; const Circle:TCircle):Boolean;                                                    overload;
function PointOnCircle(const Px,Py:double; const Circle:TCircle):Boolean;                                                      overload;
function PointOnCircle(const Point:TlicgCoor; const Circle:TCircle):Boolean;                                                    overload;
function TriangleInCircle         (const Triangle:TlicgTriangle; const Circle:TCircle):Boolean;
function TriangleOutsideCircle    (const Triangle:TlicgTriangle; const Circle:TCircle):Boolean;
function TriangleEncompassesCircle(const Triangle:TlicgTriangle; const Circle:TCircle):Boolean;
...
function PointInThreePointCircle(const Px,Py,x1,y1,x2,y2,x3,y3:double):Boolean;                                                overload;
function PointInThreePointCircle(const Point,Point1,Point2,Point3:TlicgCoor):Boolean;                                           overload;
function PointInThreePointCircle(const Point:TlicgCoor; const Triangle:TlicgTriangle):Boolean;                                    overload;
function PointInRectangle(const Px,Py:double;   const x1,y1,x2,y2:double):Boolean;                                             overload;
function PointInRectangle(const Point:TlicgCoor; const x1,y1,x2,y2:double):Boolean;                                             overload;
function PointInRectangle(const Px,Py:double;   const Rectangle:TRectangle):Boolean;                                           overload;
function PointInRectangle(const Point:TlicgCoor; const Rectangle:TRectangle):Boolean;                                           overload;
function TriangleInRectangle(const Triangle:TlicgTriangle; const Rectangle:TRectangle):Boolean;
function TriangleOutsideRectangle(const Triangle:TlicgTriangle; const Rectangle:TRectangle):Boolean;
...
function PointInQuadix(const Point,Point1,Point2,Point3,Point4:TlicgCoor):Boolean;                                              overload;
function PointInQuadix(const x,y:double; const Quadix:TQuadix2D):Boolean;                                                      overload;
function PointInQuadix(const Point:TlicgCoor; const Quadix:TQuadix2D):Boolean;                                                  overload;
function TriangleInQuadix(const Triangle:TlicgTriangle; const Quadix:TQuadix2D):Boolean;
function TriangleOutsideQuadix(const Triangle:TlicgTriangle; const Quadix:TQuadix2D):Boolean;
function PointInSphere(const x,y,z:double; const Sphere:TSphere):Boolean;                                                      overload;
function PointInSphere(const Point3D:TlicgCoor3D; const Sphere:TSphere):Boolean;                                                  overload;
function PointOnSphere(const Point3D:TlicgCoor3D; const Sphere:TSphere):Boolean;                                                  overload;
...
function PointOnPerimeter(const Px,Py,x1,y1,x2,y2,x3,y3:double; Robust:Boolean = False):Boolean;                               overload;
function PointOnPerimeter(const Px,Py,x1,y1,x2,y2,x3,y3,x4,y4:double):Boolean;                                                 overload;
function PointOnPerimeter(const Point:TlicgCoor; const Rectangle : TRectangle):Boolean;                                         overload;
function PointOnPerimeter(const Point:TlicgCoor; const Triangle  : TlicgTriangle):Boolean;                                        overload;
function PointOnPerimeter(const Point:TlicgCoor; const Quadix    : TQuadix2D):Boolean;                                          overload;
function PointOnPerimeter(const Point:TlicgCoor; const Circle    : TCircle):Boolean;                                            overload;
function PointOnPerimeter(const Point:TlicgCoor3D; const Sphere    : TSphere):Boolean;                                            overload;
function PointOnPerimeter(const Point:TlicgCoor; const Polygon   : TPolygon2D):Boolean;                                         overload;
function PointOnPerimeter(const Point:TlicgCoor; const Obj       : TGeometricObject):Boolean;                                   overload;
function PointOnPerimeter(const Point:TlicgCoor3D; const Obj       : TGeometricObject):Boolean;                                   overload;
function PointInObject(const Point:TlicgCoor; const Segment   : TSegment2D ):Boolean;                                           overload;
function PointInObject(const Point:TlicgCoor; const Line      : TlicgLine    ):Boolean;                                           overload;
function PointInObject(const Point:TlicgCoor; const Rectangle : TRectangle ):Boolean;                                           overload;
function PointInObject(const Point:TlicgCoor; const Triangle  : TlicgTriangle):Boolean;                                           overload;
function PointInObject(const Point:TlicgCoor; const Quadix    : TQuadix2D  ):Boolean;                                           overload;
function PointInObject(const Point:TlicgCoor; const Circle    : TCircle    ):Boolean;                                           overload;
function PointInObject(const Point:TlicgCoor; const Polygon   : TPolygon2D ):Boolean;                                           overload;
function PointInObject(const Point:TlicgCoor; const Obj       : TGeometricObject):Boolean;                                      overload;
function GeometricSpan(const Point: array of TlicgCoor):double;                                                                 overload;
function GeometricSpan(const Point: array of TlicgCoor3D):double;                                                                 overload;
procedure CreateEquilateralTriangle(x1,y1,x2,y2:double; out x3,y3:double);                                                     overload;
procedure CreateEquilateralTriangle(const Point1,Point2:TlicgCoor; out Point3:TlicgCoor);                                        overload;
function  CreateEquilateralTriangle(const x1,y1,x2,y2:double):TlicgTriangle;                                                     overload;
function  CreateEquilateralTriangle(const Point1,Point2:TlicgCoor):TlicgTriangle;                                                 overload;
function  CreateEquilateralTriangle(const Cx,Cy,SideLength : double) : TlicgTriangle;                                            overload;
function  CreateEquilateralTriangle(const CenterPoint : TlicgCoor; const SideLength : double) : TlicgTriangle;                    overload;
procedure TorricelliPoint(const x1,y1,x2,y2,x3,y3:double; out Px,Py:double);                                                   overload;
function  TorricelliPoint(const Point1,Point2,Point3:TlicgCoor):TlicgCoor;                                                       overload;
function  TorricelliPoint(const Triangle:TlicgTriangle):TlicgCoor;                                                                overload;
procedure Incenter(const x1,y1,x2,y2,x3,y3:double; out Px,Py:double);                                                          overload;
procedure Incenter(const Triangle:TlicgTriangle; out Px,Py:double);                                                              overload;
function  Incenter(const Point1,Point2,Point3:TlicgCoor):TlicgCoor;                                                              overload;
function  Incenter(const Triangle:TlicgTriangle):TlicgCoor;                                                                       overload;
procedure Circumcenter(const x1,y1,x2,y2,x3,y3:double; out Px,Py:double);                                                      overload;
function  Circumcenter(const Point1,Point2,Point3:TlicgCoor):TlicgCoor;                                                          overload;
function  Circumcenter(const Triangle:TlicgTriangle):TlicgCoor;                                                                   overload;
function Circumcircle(const P1,P2,P3:TlicgCoor):TCircle;                                                                        overload;
function Circumcircle(const Triangle:TlicgTriangle):TCircle;                                                                     overload;
function InscribedCircle(const x1,y1,x2,y2,x3,y3:double):TCircle;                                                              overload;
function InscribedCircle(const P1,P2,P3:TlicgCoor):TCircle;                                                                     overload;
function InscribedCircle(const Triangle:TlicgTriangle):TCircle;                                                                  overload;
procedure ClosestPointOnSegmentFromPoint(const x1,y1,x2,y2,Px,Py:double; out Nx,Ny:double);                                    overload;
procedure ClosestPointOnSegmentFromPoint(const x1,y1,z1,x2,y2,z2,Px,Py,Pz:double; out Nx,Ny,Nz:double);                        overload;
procedure ClosestPointOnLineFromPoint(const x1,y1,x2,y2,Px,Py:double; out Nx,Ny:double);                                       overload;
procedure ClosestPointOnLineFromPoint(const x1,y1,z1,x2,y2,z2,Px,Py,Pz:double; out Nx,Ny,Nz:double);                           overload;
function ClosestPointOnSegmentFromPoint(const x1,y1,x2,y2,Px,Py:double):TlicgCoor;                                              overload;
function ClosestPointOnSegmentFromPoint(const x1,y1,z1,x2,y2,z2,Px,Py,Pz:double):TlicgCoor3D;                                     overload;
function ClosestPointOnSegmentFromPoint(const Segment:TSegment2D; const Point:TlicgCoor):TlicgCoor;                              overload;
function ClosestPointOnSegmentFromPoint(const Segment:TSegment3D; const Point:TlicgCoor3D):TlicgCoor3D;                              overload;
function ClosestPointOnLineFromPoint(const x1,y1,x2,y2,Px,Py:double):TlicgCoor;                                                 overload;
function ClosestPointOnLineFromPoint(const x1,y1,z1,x2,y2,z2,Px,Py,Pz:double):TlicgCoor3D;                                        overload;
function ClosestPointOnLineFromPoint(const Line:TlicgLine; const Point:TlicgCoor):TlicgCoor;                                       overload;
function ClosestPointOnLineFromPoint(const Line:TlicgLine3D; const Point:TlicgCoor3D):TlicgCoor3D;                                       overload;
procedure ClosestPointOnTriangleFromPoint(const x1,y1,x2,y2,x3,y3,Px,Py:double; out Nx,Ny:double);                             overload;
function  ClosestPointOnTriangleFromPoint(const Triangle:TlicgTriangle;  const Px,Py:double  ):TlicgCoor;                         overload;
function  ClosestPointOnTriangleFromPoint(const Triangle:TlicgTriangle;  const Point:TlicgCoor):TlicgCoor;                         overload;
function  ClosestPointOnTriangleFromPoint(const Triangle:TlicgTriangle3D;  const Point:TlicgCoor3D):TlicgCoor3D;                         overload;
procedure ClosestPointOnRectangleFromPoint(const x1,y1,x2,y2,Px,Py:double; out Nx,Ny:double);                                  overload;
function  ClosestPointOnRectangleFromPoint(const Rectangle:TRectangle;  const Px,Py:double  ):TlicgCoor;                        overload;
function  ClosestPointOnRectangleFromPoint(const Rectangle:TRectangle;  const Point:TlicgCoor):TlicgCoor;                        overload;
function ClosestPointOnQuadixFromPoint(const Quadix:TQuadix2D;      const Point:TlicgCoor):TlicgCoor;                            overload;
function ClosestPointOnQuadixFromPoint(const Quadix:TQuadix3D;      const Point:TlicgCoor3D):TlicgCoor3D;                            overload;
function ClosestPointOnCircleFromPoint(const Circle:TCircle;        const Point:TlicgCoor):TlicgCoor;
function ClosestPointOnSphereFromPoint(const Sphere:TSphere;        const Point:TlicgCoor3D):TlicgCoor3D;
function ClosestPointOnAABBFromPoint  (const Rectangle: TRectangle; const Point:TlicgCoor):TlicgCoor;
function ClosestPointOnCircleFromSegment(const Circle:TCircle; Segment:TSegment2D):TlicgCoor;
function ClosestPointOnSphereFromSegment(const Sphere:TSphere; Segment:TSegment3D):TlicgCoor3D;
function MinimumDistanceFromPointToSegment(const Px,Py,x1,y1,x2,y2:double):double;                                             overload;
function MinimumDistanceFromPointToSegment(const Point:TlicgCoor; const Segment:TSegment2D):double;                             overload;
function MinimumDistanceFromPointToSegment(const Px,Py,Pz,x1,y1,z1,x2,y2,z2:double):double;                                    overload;
function MinimumDistanceFromPointToSegment(const Point:TlicgCoor3D; const Segment:TSegment3D):double;                             overload;
function MinimumDistanceFromPointToLine(const Px,Py,x1,y1,x2,y2:double):double;                                                overload;
function MinimumDistanceFromPointToLine(const Point:TlicgCoor; const Line:TlicgLine):double;                                      overload;
function MinimumDistanceFromPointToLine(const Px,Py,Pz,x1,y1,z1,x2,y2,z2:double):double;                                       overload;
function MinimumDistanceFromPointToLine(const Point:TlicgCoor3D; const Line:TlicgLine3D):double;                                      overload;
function MinimumDistanceFromPointToTriangle(const Px,Py,x1,y1,x2,y2,x3,y3:double):double;                                      overload;
function MinimumDistanceFromPointToTriangle(const Point:TlicgCoor; const Triangle:TlicgTriangle):double;                          overload;
function MinimumDistanceFromPointToRectangle(const Px,Py,x1,y1,x2,y2:double):double;                                           overload;
function MinimumDistanceFromPointToRectangle(const Point:TlicgCoor; const Rectangle:TRectangle):double;                         overload;
function MinimumDistanceFromPointToPolygon(const Point:TlicgCoor; const Polygon:TPolygon2D): double                             overload;
procedure SegmentMidPoint(const x1,y1,x2,y2:double; out midx,midy:double);                                                     overload;
procedure SegmentMidPoint(const Segment:TSegment2D; out midx,midy:double);                                                     overload;
function  SegmentMidPoint(const P1,P2:TlicgCoor):TlicgCoor;                                                                      overload;
function  SegmentMidPoint(const Segment:TSegment2D):TlicgCoor;                                                                  overload;
procedure SegmentMidPoint(const x1,y1,z1,x2,y2,z2:double; out midx,midy,midz:double);                                          overload;
function  SegmentMidPoint(const P1,P2:TlicgCoor3D):TlicgCoor3D;                                                                      overload;
function  SegmentMidPoint(const Segment:TSegment3D):TlicgCoor3D;                                                                  overload;
procedure Centroid(const x1,y1,x2,y2:double; out x,y:double);                                                                  overload;
function  Centroid(const P1,P2:TlicgCoor):TlicgCoor;                                                                             overload;
function  Centroid(const Segment:TSegment2D):TlicgCoor;                                                                         overload;
procedure Centroid(const x1,y1,x2,y2,x3,y3:double; out x,y:double);                                                            overload;
procedure Centroid(const Triangle:TlicgTriangle; out x,y:double);                                                                overload;
procedure Centroid(const Rectangle:TRectangle; out x,y:double);                                                                overload;
function  Centroid(const P1,P2,P3:TlicgCoor):TlicgCoor;                                                                          overload;
function  Centroid(const Triangle:TlicgTriangle):TlicgCoor;                                                                       overload;
function  Centroid(const Rectangle:TRectangle):TlicgCoor;                                                                       overload;
procedure Centroid(const Polygon:TPolygon2D; out x,y:double);                                                                  overload;
function  Centroid(const Polygon :TPolygon2D):TlicgCoor;                                                                        overload;
function  Centroid(const Polygon : array of TlicgCoor3D):TlicgCoor3D;                                                                overload;
...
function PointInConvexPolygon(const Px,Py:double; const Polygon:TPolygon2D):Boolean;                                           overload;
function PointInConvexPolygon(const Point:TlicgCoor; const Polygon:TPolygon2D):Boolean;                                         overload;
function PointInConcavePolygon(const Px,Py:double; const Polygon:TPolygon2D):Boolean;                                          overload;
function PointInConcavePolygon(const Point:TlicgCoor; const Polygon:TPolygon2D):Boolean;                                        overload;
function PointOnPolygon(const Px,Py:double;   const Polygon:TPolygon2D):Boolean;                                               overload;
function PointOnPolygon(const Point:TlicgCoor; const Polygon:TPolygon2D):Boolean;                                               overload;
function PointInPolygon(const Px,Py:double;             const Polygon:TPolygon2D):Boolean;                                     overload;
function PointInPolygon(const Point:TlicgCoor;           const Polygon:TPolygon2D):Boolean;                                     overload;
function PointInPolygon(const Point: array of TlicgCoor; const Polygon:TPolygon2D): TBooleanArray;                              overload;
...
function ConvexPolygon(const Polygon: array of TlicgCoor):Boolean;                                                              overload;
...
function RectangularHull(const Point: array of TlicgCoor):TRectangle;                                                           overload;
...
function SphereHull(const Polygon:array of TlicgCoor3D):TSphere;
function CalculateBarycentricBase(const x1,y1,x2,y2,x3,y3:double):double;
function CreateBarycentricUnit(const x1,y1,x2,y2,x3,y3:double):TBarycentricUnit;                                               overload;
function CreateBarycentricUnit(const Triangle : TlicgTriangle):TBarycentricUnit;                                                 overload;
procedure ConvertCartesianToBarycentric(const x1,y1,x2,y2,x3,y3,px,py:double; out u,v,w: double);                              overload;
procedure ConvertCartesianToBarycentric(const BU:TBarycentricUnit; Px,Py:double; out u,v,w: double);                           overload;
procedure ConvertCartesianToBarycentric(const BU:TBarycentricUnit; const Point:TlicgCoor; out BCrd: TBarycentricTriplet);       overload;
function  ConvertCartesianToBarycentric(const BU:TBarycentricUnit; const Point:TlicgCoor): TBarycentricTriplet;                 overload;
procedure ConvertBarycentricToCartesian(const u,v,w,x1,y1,x2,y2,x3,y3:double; out x,y:double);                                 overload;
procedure ConvertBarycentricToCartesian(const u,v,w:double; BU:TBarycentricUnit; out x,y:double);                              overload;
procedure ConvertBarycentricToCartesian(const u,v,w:double; BU:TBarycentricUnit; out Point:TlicgCoor);                          overload;
function  ConvertBarycentricToCartesian(const u,v,w:double; BU:TBarycentricUnit):TlicgCoor;                                     overload;
function Clip(const Segment:TSegment2D; const Rect     : TRectangle;       out CSegment:TSegment2D):Boolean;                   overload;
function Clip(const Segment:TSegment2D; const Triangle : TlicgTriangle;      out CSegment:TSegment2D):Boolean;                   overload;
...
function Area(const x1, y1, x2, y2, x3, y3 : double ): double;  {AA}                                                           overload;
function Area(const Point1,Point2,Point3:TlicgCoor):double;                                                                     overload;
function Area(const x1,y1,z1, x2,y2,z2, x3,y3,z3 : double): double; {AA}                                                       overload;
function Area(const Point1,Point2,Point3:TlicgCoor3D):double;                                                                     overload;
function Area(const Triangle:TlicgTriangle):double;                                                                              overload;
function Area(const Triangle:TlicgTriangle3D):double;                                                                              overload;
function Area(const Quadix:TQuadix2D):double;                                                                                  overload;
function Area(const Quadix:TQuadix3D):double;                                                                                  overload;
function Area(const Rectangle:TRectangle):double;                                                                              overload;
function Area(const Circle:TCircle):double;                                                                                    overload;
function Area(const Polygon:TPolygon2D):double;                                                                                overload;
function Area(const Obj:TGeometricObject):double;                                                                              overload;
function Perimeter(const Triangle  : TlicgTriangle):double;                                                                      overload;
function Perimeter(const Triangle  : TlicgTriangle3D):double;                                                                      overload;
function Perimeter(const Quadix    : TQuadix2D):double;                                                                        overload;
function Perimeter(const Quadix    : TQuadix3D):double;                                                                        overload;
function Perimeter(const Rectangle : TRectangle):double;                                                                       overload;
function Perimeter(const Circle    : TCircle):double;                                                                          overload;
function Perimeter(const Polygon   : TPolygon2D):double;                                                                       overload;
function Perimeter(const Obj       : TGeometricObject):double;                                                                 overload;
function SemiPerimeter(const Triangle : TlicgTriangle):double;                                                                   overload;
function SemiPerimeter(const Triangle : TlicgTriangle3D):double;                                                                   overload;
...
function Rotate(const RotAng:double; const Point:TlicgCoor):TlicgCoor;                                                           overload;
function Rotate(const RotAng:double; const Point,OPoint:TlicgCoor):TlicgCoor;                                                    overload;
function Rotate(const RotAng:double; const Segment  : TSegment2D):TSegment2D;                                                  overload;
function Rotate(const RotAng:double; const Segment  : TSegment2D; const OPoint: TlicgCoor):TSegment2D;                          overload;
function Rotate(const RotAng:double; const Triangle : TlicgTriangle):TlicgTriangle;                                                overload;
function Rotate(const RotAng:double; const Triangle : TlicgTriangle; const OPoint:TlicgCoor):TlicgTriangle;                         overload;
function Rotate(const RotAng:double; const Quadix   : TQuadix2D):TQuadix2D;                                                    overload;
function Rotate(const RotAng:double; const Quadix   : TQuadix2D; const OPoint:TlicgCoor):TQuadix2D;                             overload;
function Rotate(const RotAng:double; const Polygon  : TPolygon2D):TPolygon2D;                                                  overload;
function Rotate(const RotAng:double; const Polygon  : TPolygon2D; const OPoint:TlicgCoor):TPolygon2D;                           overload;
function Rotate(const RotAng:double; const Obj      : TGeometricObject):TGeometricObject;                                      overload;
function Rotate(const RotAng:double; const Obj      : TGeometricObject; const OPoint: TlicgCoor):TGeometricObject;              overload;
...
function Rotate(const Rx,Ry,Rz:double; const Point:TlicgCoor3D):TlicgCoor3D;                                                         overload;
function Rotate(const Rx,Ry,Rz:double; const Point,OPoint:TlicgCoor3D):TlicgCoor3D;                                                  overload;
function Rotate(const Rx,Ry,Rz:double; const Segment  : TSegment3D):TSegment3D;                                                overload;
function Rotate(const Rx,Ry,Rz:double; const Segment  : TSegment3D; const OPoint: TlicgCoor3D):TSegment3D;                        overload;
function Rotate(const Rx,Ry,Rz:double; const Triangle : TlicgTriangle3D):TlicgTriangle3D;                                              overload;
function Rotate(const Rx,Ry,Rz:double; const Triangle : TlicgTriangle3D; const OPoint:TlicgCoor3D):TlicgTriangle3D;                       overload;
function Rotate(const Rx,Ry,Rz:double; const Quadix   : TQuadix3D):TQuadix3D;                                                  overload;
function Rotate(const Rx,Ry,Rz:double; const Quadix   : TQuadix3D; const OPoint:TlicgCoor3D):TQuadix3D;                           overload;
function Rotate(const Rx,Ry,Rz:double; const Polygon  : TPolygon3D):TPolygon3D;                                                overload;
function Rotate(const Rx,Ry,Rz:double; const Polygon  : TPolygon3D; const OPoint:TlicgCoor3D):TPolygon3D;                         overload;
function Rotate(const Rx,Ry,Rz:double; const Obj      : TGeometricObject):TGeometricObject;                                    overload;
function Rotate(const Rx,Ry,Rz:double; const Obj      : TGeometricObject; const OPoint: TlicgCoor3D):TGeometricObject;            overload;
...
function FastRotate(const RotAng:Integer; const Point:TlicgCoor):TlicgCoor;                                                      overload;
function FastRotate(const RotAng:Integer; const Point,OPoint:TlicgCoor):TlicgCoor;                                               overload;
function FastRotate(const RotAng:Integer; const Segment  : TSegment2D):TSegment2D;                                             overload;
function FastRotate(const RotAng:Integer; const Segment  : TSegment2D; const OPoint: TlicgCoor):TSegment2D;                     overload;
function FastRotate(const RotAng:Integer; const Triangle : TlicgTriangle):TlicgTriangle;                                           overload;
function FastRotate(const RotAng:Integer; const Triangle : TlicgTriangle; const OPoint:TlicgCoor):TlicgTriangle;                    overload;
function FastRotate(const RotAng:Integer; const Quadix   : TQuadix2D):TQuadix2D;                                               overload;
function FastRotate(const RotAng:Integer; const Quadix   : TQuadix2D; const OPoint:TlicgCoor):TQuadix2D;                        overload;
function FastRotate(const RotAng:Integer; const Polygon  : TPolygon2D):TPolygon2D;                                             overload;
function FastRotate(const RotAng:Integer; const Polygon  : TPolygon2D; const OPoint:TlicgCoor):TPolygon2D;                      overload;
function FastRotate(const RotAng:Integer; const Obj      : TGeometricObject):TGeometricObject;                                 overload;
function FastRotate(const RotAng:Integer; const Obj      : TGeometricObject; const OPoint: TlicgCoor):TGeometricObject;         overload;
...
function FastRotate(const Rx,Ry,Rz:Integer; const Point:TlicgCoor3D):TlicgCoor3D;                                                    overload;
function FastRotate(const Rx,Ry,Rz:Integer; const Point,OPoint:TlicgCoor3D):TlicgCoor3D;                                             overload;
function FastRotate(const Rx,Ry,Rz:Integer; const Segment  : TSegment3D):TSegment3D;                                           overload;
function FastRotate(const Rx,Ry,Rz:Integer; const Segment  : TSegment3D; const OPoint: TlicgCoor3D):TSegment3D;                   overload;
function FastRotate(const Rx,Ry,Rz:Integer; const Triangle : TlicgTriangle3D):TlicgTriangle3D;                                         overload;
function FastRotate(const Rx,Ry,Rz:Integer; const Triangle : TlicgTriangle3D; const OPoint:TlicgCoor3D):TlicgTriangle3D;                  overload;
function FastRotate(const Rx,Ry,Rz:Integer; const Quadix   : TQuadix3D):TQuadix3D;                                             overload;
function FastRotate(const Rx,Ry,Rz:Integer; const Quadix   : TQuadix3D; const OPoint:TlicgCoor3D):TQuadix3D;                      overload;
function FastRotate(const Rx,Ry,Rz:Integer; const Polygon  : TPolygon3D):TPolygon3D;                                           overload;
function FastRotate(const Rx,Ry,Rz:Integer; const Polygon  : TPolygon3D; const OPoint:TlicgCoor3D):TPolygon3D;                    overload;
function FastRotate(const Rx,Ry,Rz:Integer; const Obj      : TGeometricObject):TGeometricObject;                               overload;
function FastRotate(const Rx,Ry,Rz:Integer; const Obj      : TGeometricObject; const OPoint: TlicgCoor3D):TGeometricObject;       overload;
function Translate(const Dx,Dy:double;   const Point     : TlicgCoor):TlicgCoor;                                                 overload;
function Translate(const Dx,Dy:double;   const Line      : TlicgLine):TlicgLine;                                                   overload;
function Translate(const Dx,Dy:double;   const Segment   : TSegment2D):TSegment2D;                                             overload;
function Translate(const Dx,Dy:double;   const Triangle  : TlicgTriangle):TlicgTriangle;                                           overload;
function Translate(const Dx,Dy:double;   const Quadix    : TQuadix2D):TQuadix2D;                                               overload;
function Translate(const Dx,Dy:double;   const Rectangle : TRectangle):TRectangle;                                             overload;
function Translate(const Dx,Dy:double;   const Circle    : TCircle):TCircle;                                                   overload;
function Translate(const Dx,Dy:double;   const Polygon   : TPolygon2D):TPolygon2D;                                             overload;
function Translate(const Point:TlicgCoor; const Polygon   : TPolygon2D):TPolygon2D;                                             overload;
function Translate(const Dx,Dy:double;   const Obj       : TGeometricObject):TGeometricObject;                                 overload;
function Translate(const Delta:double;   const Point     : TlicgCoor):TlicgCoor;                                                 overload;
function Translate(const Delta:double;   const Line      : TlicgLine):TlicgLine;                                                   overload;
function Translate(const Delta:double;   const Segment   : TSegment2D):TSegment2D;                                             overload;
function Translate(const Delta:double;   const Triangle  : TlicgTriangle):TlicgTriangle;                                           overload;
function Translate(const Delta:double;   const Quadix    : TQuadix2D):TQuadix2D;                                               overload;
function Translate(const Delta:double;   const Rectangle : TRectangle):TRectangle;                                             overload;
function Translate(const Delta:double;   const Circle    : TCircle):TCircle;                                                   overload;
function Translate(const Delta:double;   const Polygon   : TPolygon2D):TPolygon2D;                                             overload;
function Translate(const Delta:double;   const Obj       : TGeometricObject):TGeometricObject;                                 overload;
function Translate(const Dx,Dy,Dz:double; const Point    : TlicgCoor3D):TlicgCoor3D;                                                 overload;
function Translate(const Dx,Dy,Dz:double; const Line     : TlicgLine3D):TlicgLine3D;                                                   overload;
function Translate(const Dx,Dy,Dz:double; const Segment  : TSegment3D):TSegment3D;                                             overload;
function Translate(const Dx,Dy,Dz:double; const Triangle : TlicgTriangle3D):TlicgTriangle3D;                                           overload;
function Translate(const Dx,Dy,Dz:double; const Quadix   : TQuadix3D):TQuadix3D;                                               overload;
function Translate(const Dx,Dy,Dz:double; const Sphere   : TSphere):TSphere;                                                   overload;
function Translate(const Dx,Dy,Dz:double; const Polygon  : TPolygon3D):TPolygon3D;                                             overload;
function Translate(const Point:TlicgCoor3D;  const Polygon  : TPolygon3D):TPolygon3D;                                             overload;
function Translate(const Dx,Dy,Dz:double; const Obj      : TGeometricObject):TGeometricObject;                                 overload;
function Scale(const Dx,Dy:double; const Point     : TlicgCoor):TlicgCoor;                                                       overload;
function Scale(const Dx,Dy:double; const Line      : TlicgLine):TlicgLine;                                                         overload;
function Scale(const Dx,Dy:double; const Segment   : TSegment2D):TSegment2D;                                                   overload;
function Scale(const Dx,Dy:double; const Triangle  : TlicgTriangle):TlicgTriangle;                                                 overload;
function Scale(const Dx,Dy:double; const Quadix    : TQuadix2D):TQuadix2D;                                                     overload;
function Scale(const Dx,Dy:double; const Rectangle : TRectangle):TRectangle;                                                   overload;
function Scale(const Dr   :double; const Circle    : TCircle):TCircle;                                                         overload;
function Scale(const Dx,Dy:double; const Polygon   : TPolygon2D):TPolygon2D;                                                   overload;
function Scale(const Dx,Dy:double; const Obj       : TGeometricObject):TGeometricObject;                                       overload;
function Scale(const Dx,Dy,Dz:double; const Point    : TlicgCoor3D):TlicgCoor3D;                                                     overload;
function Scale(const Dx,Dy,Dz:double; const Line     : TlicgLine3D):TlicgLine3D;                                                       overload;
function Scale(const Dx,Dy,Dz:double; const Segment  : TSegment3D):TSegment3D;                                                 overload;
function Scale(const Dx,Dy,Dz:double; const Triangle : TlicgTriangle3D):TlicgTriangle3D;                                               overload;
function Scale(const Dx,Dy,Dz:double; const Quadix   : TQuadix3D):TQuadix3D;                                                   overload;
function Scale(const Dr      :double; const Sphere   : TSphere):TSphere;                                                       overload;
function Scale(const Dx,Dy,Dz:double; const Polygon  : TPolygon3D):TPolygon3D;                                                 overload;
function Scale(const Dx,Dy,Dz:double; const Obj      : TGeometricObject):TGeometricObject;                                     overload;
procedure ShearXAxis(const Shear,x,y:double; out Nx,Ny:double);                                                                overload;
function ShearXAxis(const Shear:double; const Point    : TlicgCoor):TlicgCoor;                                                   overload;
function ShearXAxis(const Shear:double; const Segment  : TSegment2D):TSegment2D;                                               overload;
function ShearXAxis(const Shear:double; const Triangle : TlicgTriangle):TlicgTriangle;                                             overload;
function ShearXAxis(const Shear:double; const Quadix   : TQuadix2D):TQuadix2D;                                                 overload;
function ShearXAxis(const Shear:double; const Polygon  : TPolygon2D):TPolygon2D;                                               overload;
function ShearXAxis(const Shear:double; const Obj      : TGeometricObject):TGeometricObject;                                   overload;
procedure ShearYAxis(const Shear,x,y:double; out Nx,Ny:double);                                                                overload;
function ShearYAxis(const Shear:double; const Point    : TlicgCoor):TlicgCoor;                                                   overload;
function ShearYAxis(const Shear:double; const Segment  : TSegment2D):TSegment2D;                                               overload;
function ShearYAxis(const Shear:double; const Triangle : TlicgTriangle):TlicgTriangle;                                             overload;
function ShearYAxis(const Shear:double; const Quadix   : TQuadix2D):TQuadix2D;                                                 overload;
function ShearYAxis(const Shear:double; const Polygon  : TPolygon2D):TPolygon2D;                                               overload;
function ShearYAxis(const Shear:double; const Obj      : TGeometricObject):TGeometricObject;                                   overload;
function CenterAtLocation(const Point:TlicgCoor;       const x,y:double):TlicgCoor;                                              overload;
function CenterAtLocation(const Segment:TSegment2D;   const x,y:double):TSegment2D;                                            overload;
function CenterAtLocation(const Triangle:TlicgTriangle; const x,y:double):TlicgTriangle;                                           overload;
function CenterAtLocation(const Rectangle:TRectangle; const x,y:double):TRectangle;                                            overload;
function CenterAtLocation(const Quadix:TQuadix2D;     const x,y:double):TQuadix2D;                                             overload;
function CenterAtLocation(const Circle:TCircle;       const x,y:double):TCircle;                                               overload;
function CenterAtLocation(const Polygon:TPolygon2D;   const x,y:double):TPolygon2D;                                            overload;
function CenterAtLocation(const Point,                      CPoint:TlicgCoor):TlicgCoor;                                         overload;
function CenterAtLocation(const Segment:TSegment2D;   const CPoint:TlicgCoor):TSegment2D;                                       overload;
function CenterAtLocation(const Triangle:TlicgTriangle; const CPoint:TlicgCoor):TlicgTriangle;                                      overload;
function CenterAtLocation(const Rectangle:TRectangle; const CPoint:TlicgCoor):TRectangle;                                       overload;
function CenterAtLocation(const Quadix:TQuadix2D;     const CPoint:TlicgCoor):TQuadix2D;                                        overload;
function CenterAtLocation(const Circle:TCircle;       const CPoint:TlicgCoor):TCircle;                                          overload;
function CenterAtLocation(const Polygon:TPolygon2D;   const CPoint:TlicgCoor):TPolygon2D;                                       overload;
function AABB(const Segment   : TSegment2D   ):TRectangle;                                                                     overload;
function AABB(const Triangle  : TlicgTriangle  ):TRectangle;                                                                     overload;
...
function AABB(const Curve     : TlicgCoorArray):TRectangle;                                                                     overload;
procedure AABB(const Segment   : TSegment2D;    out x1,y1,x2,y2:double);                                                       overload;
procedure AABB(const Triangle  : TlicgTriangle;   out x1,y1,x2,y2:double);                                                       overload;
procedure AABB(const Rectangle : TRectangle;    out x1,y1,x2,y2:double);                                                       overload;
procedure AABB(const Quadix    : TQuadix2D;     out x1,y1,x2,y2:double);                                                       overload;
procedure AABB(const Circle    : TCircle;       out x1,y1,x2,y2:double);                                                       overload;
procedure AABB(const Polygon   : TPolygon2D;    out x1,y1,x2,y2:double);                                                       overload;
procedure AABB(const Curve     : TlicgCoorArray; out x1,y1,x2,y2:double);                                                       overload;
procedure ProjectPoint(const Srcx,Srcy,Dstx,Dsty,Dist:double; out Nx,Ny:double);                                               overload;
procedure ProjectPoint(const Srcx,Srcy,Srcz,Dstx,Dsty,Dstz,Dist:double; out Nx,Ny,Nz:double);                                  overload;
procedure ProjectPoint(const Px,Py,Angle,Distance:double; out Nx,Ny:double);                                                   overload;
procedure ProjectPoint0  (const Px,Py,Distance:double; out Nx,Ny:double);                                                      overload;
procedure ProjectPoint45 (const Px,Py,Distance:double; out Nx,Ny:double);                                                      overload;
procedure ProjectPoint90 (const Px,Py,Distance:double; out Nx,Ny:double);                                                      overload;
procedure ProjectPoint135(const Px,Py,Distance:double; out Nx,Ny:double);                                                      overload;
procedure ProjectPoint180(const Px,Py,Distance:double; out Nx,Ny:double);                                                      overload;
procedure ProjectPoint225(const Px,Py,Distance:double; out Nx,Ny:double);                                                      overload;
procedure ProjectPoint270(const Px,Py,Distance:double; out Nx,Ny:double);                                                      overload;
procedure ProjectPoint315(const Px,Py,Distance:double; out Nx,Ny:double);                                                      overload;
function ProjectPoint(const SrcPoint,DstPoint:TlicgCoor; const Dist:double):TlicgCoor;                                           overload;
function ProjectPoint(const SrcPoint,DstPoint:TlicgCoor3D; const Dist:double):TlicgCoor3D;                                           overload;
function ProjectPoint(const Point:TlicgCoor; Angle,Distance:double):TlicgCoor;                                                   overload;
function ProjectPoint0  (const Point:TlicgCoor; Distance:double):TlicgCoor;                                                      overload;
function ProjectPoint45 (const Point:TlicgCoor; Distance:double):TlicgCoor;                                                      overload;
function ProjectPoint90 (const Point:TlicgCoor; Distance:double):TlicgCoor;                                                      overload;
function ProjectPoint135(const Point:TlicgCoor; Distance:double):TlicgCoor;                                                      overload;
function ProjectPoint180(const Point:TlicgCoor; Distance:double):TlicgCoor;                                                      overload;
function ProjectPoint225(const Point:TlicgCoor; Distance:double):TlicgCoor;                                                      overload;
function ProjectPoint270(const Point:TlicgCoor; Distance:double):TlicgCoor;                                                      overload;
function ProjectPoint315(const Point:TlicgCoor; Distance:double):TlicgCoor;                                                      overload;
function ProjectObject(const Point    : TlicgCoor;         Angle,Distance:double):TlicgCoor;                                     overload;
function ProjectObject(const Segment  : TSegment2D;       Angle,Distance:double):TSegment2D;                                   overload;
function ProjectObject(const Triangle : TlicgTriangle;      Angle,Distance:double):TlicgTriangle;                                  overload;
function ProjectObject(const Quadix   : TQuadix2D;        Angle,Distance:double):TQuadix2D;                                    overload;
function ProjectObject(const Circle   : TCircle;          Angle,Distance:double):TCircle;                                      overload;
function ProjectObject(const Polygon  : TPolygon2D;       Angle,Distance:double):TPolygon2D;                                   overload;
function ProjectObject(const GeoObj   : TGeometricObject; Angle,Distance:double):TGeometricObject;                             overload;
procedure CalculateBezierCoefficients(const Bezier : TQuadraticBezier2D; out ax,bx,ay,by:double);                              overload;
procedure CalculateBezierCoefficients(const Bezier : TQuadraticBezier3D; out ax,bx,ay,by,az,bz:double);                        overload;
procedure CalculateBezierCoefficients(const Bezier : TCubicBezier2D; out ax,bx,cx,ay,by,cy:double);                            overload;
procedure CalculateBezierCoefficients(const Bezier : TCubicBezier3D; out ax,bx,cx,ay,by,cy,az,bz,cz:double);                   overload;
function  PointOnBezier(const StartPoint:TlicgCoor; const ax,bx,ay,by,T:double):TlicgCoor;                                       overload;
function  PointOnBezier(const StartPoint:TlicgCoor3D; const ax,bx,ay,by,az,bz,T:double):TlicgCoor3D;                                 overload;
function  PointOnBezier(const StartPoint:TlicgCoor; const ax,bx,cx,ay,by,cy,T:double):TlicgCoor;                                 overload;
function  PointOnBezier(const StartPoint:TlicgCoor3D; const ax,bx,cx,ay,by,cy,az,bz,cz,T:double):TlicgCoor3D;                        overload;
function  CreateBezier(const Bezier:TQuadraticBezier2D; const PointCount:Integer):TlicgCoorArray;                               overload;
function  CreateBezier(const Bezier:TQuadraticBezier3D; const PointCount:Integer):TlicgCoorArray3D;                               overload;
function  CreateBezier(const Bezier:TCubicBezier2D; const PointCount:Integer):TlicgCoorArray;                                   overload;
function  CreateBezier(const Bezier:TCubicBezier3D; const PointCount:Integer):TlicgCoorArray3D;                                   overload;
...
function CurveLength(const Bezier:TQuadraticBezier2D; const PointCount:Integer):double;                                        overload;
function CurveLength(const Bezier:TQuadraticBezier3D; const PointCount:Integer):double;                                        overload;
function CurveLength(const Bezier:TCubicBezier2D; const PointCount:Integer):double;                                            overload;
function CurveLength(const Bezier:TCubicBezier3D; const PointCount:Integer):double;                                            overload;
procedure ShortenSegment(const Amount:double; out x1,y1,x2,y2:double);                                                         overload;
procedure ShortenSegment(const Amount:double; out x1,y1,z1,x2,y2,z2:double);                                                   overload;
function  ShortenSegment(const Segment:TSegment2D; const Amount:double):TSegment2D;                                            overload;
function  ShortenSegment(const Segment:TSegment3D; const Amount:double):TSegment3D;                                            overload;
procedure LengthenSegment(const Amount:double; out x1,y1,x2,y2:double);                                                        overload;
procedure LengthenSegment(const Amount:double; out x1,y1,z1,x2,y2,z2:double);                                                  overload;
function  LengthenSegment(const Segment:TSegment2D; const Amount:double):TSegment2D;                                           overload;
function  LengthenSegment(const Segment:TSegment3D; const Amount:double):TSegment3D;                                           overload;
function EquatePoint(const x,y:double):TlicgCoor;                                                                               overload;
function EquatePoint(const x,y,z:double):TlicgCoor3D;                                                                             overload;
function EquatePointPtr(const x,y:double):TlicgCoorPtr;                                                                         overload;
function EquatePointPtr(const x,y,z:double):TlicgCoor3DPtr;                                                                       overload;
procedure EquatePoint(const x,y:double; out Point:TlicgCoor);                                                                   overload;
procedure EquatePoint(const x,y,z:double; out Point:TlicgCoor3D);                                                                 overload;
procedure EquatePointPtr(const x,y:double; out Point:TlicgCoorPtr);                                                             overload;
procedure EquatePointPtr(const x,y,z:double; out Point:TlicgCoor3DPtr);                                                           overload;
function EquateCurvePoint(x,y,t:double            ):TCurvePoint2D;                                                             overload;
function EquateCurvePoint(x,y,z,t:double          ):TCurvePoint3D;                                                             overload;
function EquateCurvePoint(Point:TlicgCoor; t:double):TCurvePoint2D;                                                             overload;
function EquateCurvePoint(Point:TlicgCoor3D; t:double):TCurvePoint3D;                                                             overload;
...
function EquateSegment(const Point1,Point2:TlicgCoor):TSegment2D;                                                               overload;
function EquateSegment(const Point1,Point2:TlicgCoor3D):TSegment3D;                                                               overload;
procedure EquateSegment(const x1,y1,x2,y2:double; out Segment:TSegment2D);                                                     overload;
procedure EquateSegment(const x1,y1,z1,x2,y2,z2:double; out Segment:TSegment3D);                                               overload;
function EquateLine(const x1,y1,x2,y2:double):TlicgLine;                                                                         overload;
function EquateLine(const x1,y1,z1,x2,y2,z2:double):TlicgLine3D;                                                                   overload;
function EquateLine(const Point1,Point2:TlicgCoor):TlicgLine;                                                                     overload;
function EquateLine(const Point1,Point2:TlicgCoor3D):TlicgLine3D;                                                                     overload;
procedure EquateLine(const x1,y1,x2,y2:double; out Line:TlicgLine);                                                              overload;
procedure EquateLine(const x1,y1,z1,x2,y2,z2:double; out Line:TlicgLine3D);                                                        overload;
...
function EquateQuadix(const Point1,Point2,Point3,Point4:TlicgCoor):TQuadix2D;                                                   overload;
function EquateQuadix(const Point1,Point2,Point3,Point4:TlicgCoor3D):TQuadix3D;                                                   overload;
procedure EquateQuadix(const x1,y1,x2,y2,x3,y3,x4,y4:double;             out Quadix:TQuadix2D);                                overload;
procedure EquateQuadix(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4:double; out Quadix:TQuadix3D);                                overload;
function  EquateRectangle(const x1,y1,x2,y2:double):TRectangle;                                                                overload;
function  EquateRectangle(const Point1,Point2:TlicgCoor):TRectangle;                                                            overload;
procedure EquateRectangle(const x1,y1,x2,y2:double; out Rect:TRectangle);                                                      overload;
procedure EquateRectangle(const Point1,Point2:TlicgCoor; out Rect:TRectangle);                                                  overload;
function EquateTriangle(const x1,y1,x2,y2,x3,y3:double):TlicgTriangle;                                                           overload;
function EquateTriangle(const x1,y1,z1,x2,y2,z2,x3,y3,z3:double):TlicgTriangle3D;                                                  overload;
function EquateTriangle(const Point1,Point2,Point3:TlicgCoor):TlicgTriangle;                                                      overload;
function EquateTriangle(const Point1,Point2,Point3:TlicgCoor3D):TlicgTriangle3D;                                                      overload;
procedure EquateTriangle(const x1,y1,x2,y2,x3,y3:double;          out Triangle:TlicgTriangle);                                   overload;
procedure EquateTriangle(const x1,y1,z1,x2,y2,z2,x3,y3,z3:double; out Triangle:TlicgTriangle3D);                                   overload;
procedure EquateTriangle(const Point1,Point2,Point3: TlicgCoor;    out Triangle:TlicgTriangle);                                   overload;
procedure EquateTriangle(const Point1,Point2,Point3: TlicgCoor3D;    out Triangle:TlicgTriangle3D);                                   overload;
function  EquateCircle(const x,y,r:double):TCircle;                                                                            overload;
function  EquateCircle(const Point:TlicgCoor; Radius:double):TCircle;                                                           overload;
procedure EquateCircle(const x,y,r:double; out Circle:TCircle);                                                                overload;
function  EquateSphere(const x,y,z,r:double):TSphere;                                                                          overload;
procedure EquateSphere(const x,y,z,r:double; out Sphere:TSphere);                                                              overload;
function EquatePlane(const x1,y1,z1,x2,y2,z2,x3,y3,z3:double):TPlane2D;                                                        overload;
function EquatePlane(const Point1,Point2,Point3:TlicgCoor3D):TPlane2D;                                                            overload;
procedure EquatePlane(const x1,y1,z1,x2,y2,z2,x3,y3,z3:double; out Plane:TPlane2D);                                            overload;
procedure EquatePlane(const Point1,Point2,Point3:TlicgCoor3D;     out Plane:TPlane2D);                                            overload;
procedure EquateBezier(const x1,y1,x2,y2,x3,y3:double;          out Bezier:TQuadraticBezier2D);                                overload;
procedure EquateBezier(const x1,y1,z1,x2,y2,z2,x3,y3,z3:double; out Bezier:TQuadraticBezier3D);                                overload;
function  EquateBezier(const Pnt1,Pnt2,Pnt3:TlicgCoor):TQuadraticBezier2D;                                                      overload;
function  EquateBezier(const Pnt1,Pnt2,Pnt3:TlicgCoor3D):TQuadraticBezier3D;                                                      overload;
procedure EquateBezier(const x1,y1,x2,y2,x3,y3,x4,y4:double;             out Bezier:TCubicBezier2D);                           overload;
procedure EquateBezier(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4:double; out Bezier:TCubicBezier3D);                           overload;
function  EquateBezier(const Pnt1,Pnt2,Pnt3,Pnt4:TlicgCoor):TCubicBezier2D;                                                     overload;
function  EquateBezier(const Pnt1,Pnt2,Pnt3,Pnt4:TlicgCoor3D):TCubicBezier3D;                                                     overload;
function  RectangleToQuadix(x1,y1,x2,y2:double    ):TQuadix2D;                                                                 overload;
function  RectangleToQuadix(Point1,Point2:TlicgCoor):TQuadix2D;                                                                 overload;
function  RectangleToQuadix(Rectangle:TRectangle  ):TQuadix2D;                                                                 overload;
function  TriangleToPolygon(x1,y1,x2,y2,x3,y3:double):TPolygon2D;                                                              overload;
function  TriangleToPolygon(Triangle:TlicgTriangle):TPolygon2D;                                                                  overload;
function  QuadixToPolygon(x1,y1,x2,y2,x3,y3,x4,y4:double):TPolygon2D;                                                          overload;
function  QuadixToPolygon(Quadix:TQuadix2D):TPolygon2D;                                                                        overload;
function  CircleToPolygon(const Cx,Cy,Radius:double; const PointCount:Integer):TPolygon2D;                                     overload;
function  CircleToPolygon(const Circle:TCircle;      const PointCount:Integer):TPolygon2D;                                     overload;
procedure SetGeometricObject(const Primitive:TlicgCoor;    out GeoObj:TGeometricObject);                                        overload;
procedure SetGeometricObject(const Primitive:TlicgCoor3D;    out GeoObj:TGeometricObject);                                        overload;
procedure SetGeometricObject(const Primitive:TlicgLine;     out GeoObj:TGeometricObject);                                        overload;
procedure SetGeometricObject(const Primitive:TlicgLine3D;     out GeoObj:TGeometricObject);                                        overload;
...
procedure SetGeometricObject(const Primitive:TlicgTriangle; out GeoObj:TGeometricObject);                                        overload;
procedure SetGeometricObject(const Primitive:TlicgTriangle3D; out GeoObj:TGeometricObject);                                        overload;
...
procedure GenerateRandomPoints(const Bx1,By1,Bx2,By2:double; var PointList:array of TlicgCoor);                                 overload;
procedure GenerateRandomPoints(const Rectangle:TRectangle;   var PointList:array of TlicgCoor);                                 overload;
procedure GenerateRandomPoints(const Segment:TSegment2D;     var PointList:array of TlicgCoor);                                 overload;
procedure GenerateRandomPoints(const Segment:TSegment3D;     var PointList:array of TlicgCoor3D);                                 overload;
procedure GenerateRandomPoints(const Triangle:TlicgTriangle;   var PointList:array of TlicgCoor);                                 overload;
procedure GenerateRandomPoints(const Circle:TCircle;         var PointList:array of TlicgCoor);                                 overload;
procedure GenerateRandomPoints(const Quadix:TQuadix2D;       var PointList:array of TlicgCoor);                                 overload;
procedure GenerateRandomPointsOnConvexPentagon(const Pentagon : TPolygon2D; var PointList : array of TlicgCoor);
procedure GenerateRandomPointsOnConvexHexagon (const Hexagon  : TPolygon2D; var PointList : array of TlicgCoor);
procedure GenerateRandomPointsOnConvexHeptagon(const Heptagon : TPolygon2D; var PointList : array of TlicgCoor);
procedure GenerateRandomPointsOnConvexOctagon (const Octagon  : TPolygon2D; var PointList : array of TlicgCoor);
procedure GenerateRandomTriangle(const Bx1,By1,Bx2,By2:double; out Triangle : TlicgTriangle);
procedure GenerateRandomQuadix  (const Bx1,By1,Bx2,By2:double; out Quadix   : TQuadix2D);
procedure GenerateRandomCircle  (const Bx1,By1,Bx2,By2:double; out Circle   : TCircle);
...
function Scale(const Vec:TVector2DArray; const Factor:double):TVector2DArray;                                                  overload;
function Scale(const Vec:TVector3DArray; const Factor:double):TVector3DArray;                                                  overload;
...
function IsEqual(const Point1,Point2:TlicgCoor; const Epsilon:double):Boolean;                                                  overload;
function IsEqual(const Point1,Point2:TlicgCoor3D; const Epsilon:double):Boolean;                                                  overload;
function IsEqual(const Point1,Point2:TlicgCoor4D; const Epsilon:double):Boolean;                                                  overload;
function IsEqual(const Val1,Val2:double):Boolean;                                                                              overload;
function IsEqual(const Point1,Point2:TlicgCoor):Boolean;                                                                        overload;
function IsEqual(const Point1,Point2:TlicgCoor3D):Boolean;                                                                        overload;
function NotEqual(const Val1,Val2,Epsilon:double):Boolean;                                                                     overload;
function NotEqual(const Point1,Point2:TlicgCoor; const Epsilon:double):Boolean;                                                 overload;
function NotEqual(const Point1,Point2:TlicgCoor3D; const Epsilon:double):Boolean;                                                 overload;
function NotEqual(const Val1,Val2:double):Boolean;                                                                             overload;
function NotEqual(const Point1,Point2:TlicgCoor):Boolean;                                                                       overload;
function NotEqual(const Point1,Point2:TlicgCoor3D):Boolean;                                                                       overload;
...
function IsDegenerate(const x1,y1,x2,y2:double):Boolean;                                                                       overload;
function IsDegenerate(const Segment:TSegment2D):Boolean;                                                                       overload;
function IsDegenerate(const Line:TlicgLine):Boolean;                                                                             overload;
function IsDegenerate(const x1,y1,z1,x2,y2,z2:double):Boolean;                                                                 overload;
function IsDegenerate(const Segment:TSegment3D):Boolean;                                                                       overload;
function IsDegenerate(const Line:TlicgLine3D):Boolean;                                                                             overload;
function IsDegenerate(const Triangle:TlicgTriangle):Boolean;                                                                     overload;
function IsDegenerate(const Triangle:TlicgTriangle3D):Boolean;                                                                     overload;
...
procedure Swap(var val1,val2           :double);                                                                               overload;
procedure Swap(var val1,val2           :Integer);                                                                              overload;
procedure Swap(var Point1,Point2       :TlicgCoor);                                                                             overload;
procedure Swap(var Point1,Point2       :TlicgCoor3D);                                                                             overload;
procedure Swap(var Segment1,Segment2   :TSegment2D);                                                                           overload;
procedure Swap(var Segment1,Segment2   :TSegment3D);                                                                           overload;
procedure Swap(var Line1,Line2         :TlicgLine);                                                                              overload;
procedure Swap(var Triangle1,Triangle2 :TlicgTriangle);                                                                          overload;
procedure Swap(var Triangle1,Triangle2 :TlicgTriangle3D);                                                                          overload;
...
function  RandomValue(ResInt : Integer = RandomResolutionInt; ResFlt : double = RandomResolutionFlt) : double;
implementation
uses
  Math, Types;
...
function RobustOrientation(const x1,y1,x2,y2,Px,Py:double):Integer;
var
  Orin : double;
begin
  (* Linear determinant of the 3 Geometry.Points *)
  Orin := (x2 - x1) * (py - y1) - (px - x1) * (y2 - y1);
  (*
    Calculation Policy:
...
function RobustOrientation(const x1,y1,z1,x2,y2,z2,x3,y3,z3,Px,Py,Pz:double):Integer;
var
  Px1  : double;
  Px2  : double;
  Px3  : double;
...
function Orientation(const Point1,Point2:TlicgCoor; const Px,Py:double):Integer;
begin
  Result := Orientation(Point1.x,Point1.y,Point2.x,Point2.y,Px,Py);
end;
(* End of Orientation *)

function Orientation(const Point1,Point2,Point3:TlicgCoor):Integer;
begin
  Result := Orientation(Point1.x,Point1.y,Point2.x,Point2.y,Point3.x,Point3.y);
end;
(* End of Orientation *)

function Orientation(const Line:TlicgLine; const Point:TlicgCoor):Integer;
begin
  Result := Orientation(Line[1].x,Line[1].y,Line[2].x,Line[2].y,Point.x,Point.y);
end;
(* End of Orientation *)

function Orientation(const Segment:TSegment2D; const Point:TlicgCoor):Integer;
begin
  Result := Orientation(Segment[1].x,Segment[1].y,Segment[2].x,Segment[2].y,Point.x,Point.y);
end;
(* End of Orientation *)

function Orientation(const Point1,Point2,Point3:TlicgCoor3D; const Px,Py,Pz:double):Integer;
begin
  Result := Orientation(Point1.x,Point1.y,Point1.z,Point2.x,Point2.y,Point2.z,Point3.x,Point3.y,Point3.z,Px,Py,Pz);
end;
(* End of Orientation *)

function Orientation(const Point1,Point2,Point3,Point4:TlicgCoor3D):Integer;
begin
...
function Orientation(const Triangle:TlicgTriangle3D; const Point:TlicgCoor3D):Integer;
begin
...
function Signed(const Point1,Point2:TlicgCoor; const Px,Py:double):double;
begin
  Result := Signed(Point1.x,Point1.y,Point2.x,Point2.y,Px,Py);
end;
(* End of Signed *)

function Signed(const Point1,Point2,Point3:TlicgCoor):double;
begin
  Result := Signed(Point1.x,Point1.y,Point2.x,Point2.y,Point3.x,Point3.y);
end;
(* End of Signed *)

function Signed(const Line:TlicgLine; const Point:TlicgCoor):double;
begin
  Result := Signed(Line[1].x,Line[1].y,Line[2].x,Line[2].y,Point.x,Point.y);
end;
(* End of Signed *)

function Signed(const Segment:TSegment2D; const Point:TlicgCoor):double;
begin
  Result := Signed(Segment[1].x,Segment[1].y,Segment[2].x,Segment[2].y,Point.x,Point.y);
end;
(* End of Signed *)

function Signed(const Point1,Point2,Point3:TlicgCoor3D; const Px,Py,Pz:double):double;
begin
  Result := Signed(Point1.x,Point1.y,Point1.z,Point2.x,Point2.y,Point2.z,Point3.x,Point3.y,Point3.z,Px,Py,Pz);
end;
(* End of Signed *)

function Signed(const Point1,Point2,Point3,Point4:TlicgCoor3D):double;
begin
...
function Signed(const Triangle:TlicgTriangle3D; const Point:TlicgCoor3D):double;
begin
...
var
  ...
  Cz   : double;
begin
  (* Find the difference between the 2 Geometry.Points P2 and P3 to P1 *)
  Dx1 := x2 - x1;
  Dy1 := y2 - y1;
  Dz1 := z2 - z1;
  Dx2 := x3 - x1;
...
function Collinear(const PointA,PointB,PointC:TlicgCoor):Boolean;
begin
  Result := Collinear(PointA.x,PointA.y,PointB.x,PointB.y,PointC.x,PointC.y);
end;
(* End of Collinear *)

function Collinear(const PointA,PointB,PointC:TlicgCoor3D):Boolean;
begin
  Result := Collinear(PointA.x,PointA.y,PointA.z,PointB.x,PointB.y,PointB.z,PointC.x,PointC.y,PointC.z);
end;
(* End of Collinear *)

function RobustCollinear(const x1,y1,x2,y2,x3,y3:double; const Epsilon : double = Epsilon_High):Boolean;
var
  LeyDist1 : double;
  LeyDist2 : double;
  LeyDist3 : double;
...
function RobustCollinear(const PointA,PointB,PointC:TlicgCoor; const Epsilon : double = Epsilon_High):Boolean;
begin
...
function Coplanar(const PointA,PointB,PointC,PointD:TlicgCoor3D):Boolean;
begin
  Result := (Orientation(PointA,PointB,PointC,PointD) = CoplanarOrientation);
end;
(* End of Coplanar *)

function IsPointCollinear(const x1,y1,x2,y2,Px,Py:double; const Robust : Boolean = False):Boolean;
begin
  (*
    This method will return true iff the point (px,py) is collinear
    to Geometry.Points (x1,y1) and (x2,y2) and exists on the segment A(x1,y1)->B(x2,y2)
  *)
...
function IsPointCollinear(const PointA,PointB,PointC:TlicgCoor; const Robust : Boolean = False):Boolean;
begin
 (*
   This method will return true iff the pointC is collinear
   to Geometry.Points A and B and exists on the segment A->B or B->A
 *)
 Result := IsPointCollinear(PointA.x,PointA.y,PointB.x,PointB.y,PointC.x,PointC.y,Robust);
end;
(* End of IsPointCollinear *)

function IsPointCollinear(const PointA,PointB:TlicgCoor; const Px,Py:double; const Robust : Boolean = False):Boolean;
begin
  Result := IsPointCollinear(PointA.x,PointA.y,PointB.x,PointB.y,Px,Py,Robust);
end;
(* End of IsPointCollinear *)

function IsPointCollinear(const Segment:TSegment2D; const PointC:TlicgCoor; const Robust : Boolean = False):Boolean;
begin
...
begin
 (*
   ...
   to Geometry.Points (x1,y1,z1) and (x2,y2,z2) and exists on the segment A(x1,y1,z1)->B(x2,y2,z2)
 *)
 if (((x1 <= px) and (px <= x2)) or ((x2 <= px) and (px <= x1))) and
...
function IsPointCollinear(const PointA,PointB,PointC:TlicgCoor3D):Boolean;
begin
  (*
    This method will return true iff the pointC is collinear
    to Geometry.Points A and B and exists on the segment A->B or B->A
...
function IsPointCollinear(const Segment:TSegment3D; const PointC:TlicgCoor3D):Boolean;
begin
  Result := IsPointCollinear(Segment[1],Segment[2],PointC);
end;
(* End of IsPointCollinear *)

function IsPointOnRightSide(const Px,Py,x1,y1,x2,y2:double):Boolean;
begin
  Result := (((x2 - x1) * (py - y1)) < ((px - x1) * (y2 - y1)));
end;
(* End of IsPointOnRightSide *)

function IsPointOnRightSide(const x,y:double; const Segment:TSegment2D):Boolean;
begin
  Result := IsPointOnRightSide(x,y,Segment[1].x,Segment[1].y,Segment[2].x,Segment[2].y);
end;
(* End of IsPointOnRightSide *)

function IsPointOnRightSide(const Point:TlicgCoor; const Segment:TSegment2D):Boolean;
begin
  Result := IsPointOnRightSide(Point.x,Point.y,Segment);
end;
(* End of IsPointOnRightSide *)

function IsPointOnRightSide(const x,y:double; const Line:TlicgLine):Boolean;
begin
  Result := IsPointOnRightSide(x,y,Line[1].x,Line[1].y,Line[2].x,Line[2].y);
end;
(* End of IsPointOnRightSide *)

function IsPointOnRightSide(const Point:TlicgCoor; const Line:TlicgLine):Boolean;
begin
  Result := IsPointOnRightSide(Point.x,Point.y,Line);
end;
(* End of IsPointOnRightSide *)

function IsPointOnLeftSide(const Px,Py,x1,y1,x2,y2:double):Boolean;
begin
  Result := ((x2 - x1) * (py - y1) > (px - x1) * (y2 - y1));
end;
(* End of IsPointOnLeftSide *)

function IsPointOnLeftSide(const x,y:double; const Segment:TSegment2D):Boolean;
begin
  Result := IsPointOnLeftSide(x,y,Segment[1].x,Segment[1].y,Segment[2].x,Segment[2].y);
end;
(* End of IsPointOnLeftSide *)

function IsPointOnLeftSide(const Point:TlicgCoor; const Segment:TSegment2D):Boolean;
begin
  Result := IsPointOnLeftSide(Point.x,Point.y,Segment);
end;
(* End of IsPointOnLeftSide *)

function IsPointOnLeftSide(const x,y:double; const Line:TlicgLine):Boolean;
begin
  Result := IsPointOnLeftSide(x,y,Line[1].x,Line[1].y,Line[2].x,Line[2].y);
end;
(* End of IsPointOnLeftSide *)

function IsPointOnLeftSide(const Point:TlicgCoor; const Line:TlicgLine):Boolean;
begin
  Result := IsPointOnLeftSide(Point.x,Point.y,Line);
end;
(* End of IsPointOnLeftSide *)

function RotationCCW(const x1,y1,x2,y2,Px,Py : double):Integer;
begin
...
function RotationCW(const x1,y1,x2,y2,Px,Py : double):Integer;
begin
...
begin
  ...
  *)
  ...
  begin
    ...
    begin
      { Aþaðýdaki kod biraz kaygan... hizmeti tam anlayamamýþ olabilirim.  }
      if (IsEqual(x1, x2) and IsEqual(y1, y2)) or (IsEqual(x1, x3) and IsEqual(y1, y3)) or (IsEqual(x1, x4) and IsEqual(y1, y4)) then begin
         ix := x1;
         iy := y1;
      end
      else if (IsEqual(x2, x3) and IsEqual(y2, y3)) or (IsEqual(x2, x4) and IsEqual(y2, y4)) then begin
         ix := x2;
         iy := y2;
      end;
      { AA, burayi ben ekledim... eger herhangi bir noktasý eþit ise saçmalama vaziyeti vuku buldu... }
      (*if IsEqual(x1, x2) and IsEqual(y1, y2) then begin
         ix := x1;
         iy := y1;
      end
      else begin
...
function Intersect(const Point1,Point2,Point3,Point4:TlicgCoor):Boolean;
begin
...
function Intersect(const Segment1,Segment2:TSegment2D; out ix, iy : double):Boolean;
begin
...
function Intersect(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4:double; const fuzzy : double = 0.0):Boolean;
begin
  Result := (IsEqual(LayDistanceSegmentToSegment(x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4),fuzzy));
end;
(* End of Intersect *)

function Intersect(const P1,P2,P3,P4:TlicgCoor3D; const fuzzy:double = 0.0):Boolean;
begin
  Result := Intersect(P1.x,P1.y,P1.z,P2.x,P2.y,P2.z,P3.x,P3.y,P3.z,P4.x,P4.y,P4.z,fuzzy);
end;
(* End of Intersect *)

function Intersect(const Segment1,Segment2:TSegment3D; const fuzzy:double = 0.0):Boolean;
begin
...
function Intersect(const Segment:TSegment2D; const Triangle:TlicgTriangle):Boolean;
begin
...
function Intersect(const Segment:TSegment2D; const Line:TlicgLine):Boolean;
begin
...
function Intersect(const Line:TlicgLine; const Triangle:TlicgTriangle):Boolean;
var
  Or1 : Integer;
  Or2 : Integer;
begin
...
function Intersect(const Line:TlicgLine; const Quadix:TQuadix2D):Boolean;
var
  Or1 : Integer;
  Or2 : Integer;
begin
...
function Intersect(const Line:TlicgLine; const Circle:TCircle):Boolean;
var
  x1 : double;
  y1 : double;
  x2 : double;
...
begin
  (*
    ...
    is either a full intersection (2 Geometry.Points), partial intersection
...
function Intersect(const Line:TlicgLine3D; const Triangle:TlicgTriangle3D; out IPoint: TlicgCoor3D):Boolean;
var
  u   : TVector3D;
  v   : TVector3D;
  n   : TVector3D;
...
function Intersect(const Triangle:TlicgTriangle; const Circle:TCircle):Boolean;
begin
  Result := PointInCircle(ClosestPointOnTriangleFromPoint(Triangle,Circle.x,Circle.y),Circle);
end;
(* End of Intersect *)

function Intersect(const Triangle:TlicgTriangle; const Rectangle : TRectangle):Boolean;
begin
...
function Intersect(const Triangle1,Triangle2:TlicgTriangle):Boolean;
var
  i : Integer;
begin
  Result := False;
...
function SimpleIntersect(const x1,y1,x2,y2,x3,y3,x4,y4:double):Boolean;
begin
  Result := (
             ((Orientation(x1,y1,x2,y2,x3,y3) * Orientation(x1,y1,x2,y2,x4,y4)) <= 0) and
             ((Orientation(x3,y3,x4,y4,x1,y1) * Orientation(x3,y3,x4,y4,x2,y2)) <= 0)
...
function SimpleIntersect(const Point1,Point2,Point3,Point4:TlicgCoor):Boolean;
begin
...
function ThickSegmentIntersect(const x1,y1,x2,y2,x3,y3,x4,y4,Thickness:double):Boolean;
begin
...
function ThickSegmentIntersect(const Point1,Point2,Point3,Point4:TlicgCoor; const Thickness:double):Boolean;
begin
  Result := ThickSegmentIntersect(Point1.x,Point1.y,Point2.x,Point2.y,Point3.x,Point3.y,Point4.x,Point4.y,Thickness);
end;
(* End of ThickSegmentIntersect *)

function ThickSegmentIntersect(const Segment1,Segment2:TSegment2D; const Thickness:double):Boolean;
begin
  Result := ThickSegmentIntersect(Segment1[1],Segment1[2],Segment2[1],Segment2[2],Thickness);
end;
(* End of ThickSegmentIntersect *)

function ThickSegmentIntersect(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4,Thickness:double):Boolean;
begin
  Result := LessThanOrEqual(Thickness * Thickness, LayDistanceSegmentToSegment(x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4));
end;
(* End of ThickSegmentIntersect *)

function ThickSegmentIntersect(const Point1,Point2,Point3,Point4:TlicgCoor3D; const Thickness:double):Boolean;
begin
...
function ThickSegmentIntersect(const Segment1,Segment2:TSegment3D; const Thickness:double):Boolean;
begin
  Result := ThickSegmentIntersect(Segment1[1],Segment1[2],Segment2[1],Segment2[2],Thickness);
end;
(* End of ThickSegmentIntersect *)
...
function IntersectionPoint(const P1, P2:TlicgCoor; AVector: IlicgVector; var AResultVector: IlicgVector): Boolean;
var
  ACoor: TlicgCoor;
begin
  Result := False;
  AResultVector.Clear;
  for var I := 0 to AVector.Count - 2 do
  begin
    if IntersectionPoint(P1, P2, AVector.Coors2D[I], AVector.Coors2D[I + 1], ACoor) then
      AResultVector.Add(ACoor);
  end;
  if AResultVector = nil then
  begin
    Result := False;
    Exit;
  end;
  Result := AResultVector.Count > 0;
end;

function IntersectionPoint(const P1, P2, P3, P4:TlicgCoor; out ACoor: TlicgCoor): Boolean;
var
  Ratio : double;
  dx1   : double;
  dx2   : double;
...
begin
  ...
  dy2 := y1 - y3;
  dy3 := y4 - y3;
  Ratio := dx1 * dy3 - dy1 * dx2; // Determinantý hesapla
  // Eðer determinant 0 ise, çizgiler paraleldir ve kesiþme yoktur
  if NotEqual(Ratio,0.0) then
  begin
    Ratio := (dy2 * dx2 - dx3 * dy3) / Ratio;
    Nx    := x1 + Ratio * dx1;
  ...
  begin   // Eðer determinant 0 ise, çizgiler paraleldir ve kesiþme yoktur
    Result := False;
  end;
end;
(* End of IntersectionPoint *)
procedure IntersectionPoint(const P1,P2,P3,P4:TlicgCoor; out Nx,Ny:double);
begin
  IntersectionPoint(P1.x,P1.y,P2.x,P2.y,P3.x,P3.y,P4.x,P4.y,Nx,Ny);
end;
(* End of IntersectionPoint *)

function IntersectionPoint(const P1,P2,P3,P4:TlicgCoor):TlicgCoor;
begin
  IntersectionPoint(P1.x,P1.y,P2.x,P2.y,P3.x,P3.y,P4.x,P4.y,Result.x,Result.y);
end;
(* End of IntersectionPoint *)

function IntersectionPoint(const Segment1,Segment2:TSegment2D):TlicgCoor;
begin
  Result := IntersectionPoint(Segment1[1],Segment1[2],Segment2[1],Segment2[2]);
end;
(* End of IntersectionPoint *)

function IntersectionPoint(const Line1,Line2:TlicgLine):TlicgCoor;
var
  dx1   : double;
  dx2   : double;
  dx3   : double;
...
procedure IntersectionPoint(const Circle1,Circle2:TCircle; out Point1,Point2:TlicgCoor);
var
  Dist   : double;
  A      : double;
  H      : double;
...
procedure IntersectionPoint(const Segment:TSegment2D; const Triangle:TlicgTriangle; out ICnt:Integer; out I1,I2:TlicgCoor);
var
  Ix : double;
  Iy : double;
begin
...
procedure IntersectionPoint(const Line:TlicgLine3D; const Triangle:TlicgTriangle3D; out IPoint: TlicgCoor3D);
var
  u   : TVector3D;
  v   : TVector3D;
  n   : TVector3D;
...
procedure IntersectionPoint(const x1,y1,x2,y2,Cx,Cy,Radius:double; out ICnt:Integer; out Ix1,Iy1,Ix2,Iy2:double);
var
  Px   : double;
  Py   : double;
  S1In : Boolean;
...
procedure IntersectionPoint(const Segment:TSegment2D; const Circle:TCircle; out ICnt:Integer; out I1,I2:TlicgCoor);
begin
  IntersectionPoint(
...
function Quadrant(const Angle : double  ):Integer;
begin
    Result := 0;
...
function Quadrant(const x,y:double):Integer;
begin
...
function Quadrant(const Point : TlicgCoor):Integer;
begin
...
function VertexAngle(const Point1,Point2,Point3:TlicgCoor):double;
begin
...
function VertexAngle(const Point1,Point2,Point3:TlicgCoor3D):double;
begin
  Result := VertexAngle(Point1.x,Point1.y,Point1.z,Point2.x,Point2.y,Point2.z,Point3.x,Point3.y,Point3.z);
end;
(* End of Vertex Angle *)

function OrientedVertexAngle(const x1,y1,x2,y2,x3,y3:double; const Orient : Integer = Clockwise):double;
begin
...
function OrientedVertexAngle(const Point1,Point2,Point3:TlicgCoor; const Orient : Integer = Clockwise):double;
begin
  Result := OrientedVertexAngle(Point1.x,Point1.y,Point2.x,Point2.y,Point3.x,Point3.y,Orient);
end;
(* End of Oriented Vertex Angle *)

function CartesianAngle(const x,y:double):double;
begin
...
function CartesianAngle(const Point : TlicgCoor):double;
begin
  Result := CartesianAngle(Point.x,Point.y);
end;
(* End of Cartesian Angle *)

function RobustCartesianAngle(const x,y:double; const Epsilon : double = Epsilon_High):double;
begin
  if             (x >  0.0)         and        (y >  0.0)         then Result := (ArcTan( y / x) * _180DivPI)
  else if        (x <  0.0)         and        (y >  0.0)         then Result := (ArcTan(-x / y) * _180DivPI) +  90.0
  else if        (x <  0.0)         and        (y <  0.0)         then Result := (ArcTan( y / x) * _180DivPI) + 180.0
...
function RobustCartesianAngle(const Point : TlicgCoor; const Epsilon : double = Epsilon_High):double;
begin
  Result := RobustCartesianAngle(Point.x,Point.y,Epsilon);
end;
(* End of Robust Cartesian Angle *)

function SegmentIntersectAngle(const Point1,Point2,Point3,Point4:TlicgCoor):double;
var
  TempPoint : TlicgCoor;
begin
  Result := -1;
...
function SegmentIntersectAngle(const Segment1,Segment2:TSegment2D):double;
var
  TempPoint : TlicgCoor;
begin
  Result := -1;
...
function SegmentIntersectAngle(const Point1,Point2,Point3,Point4:TlicgCoor3D):double;
begin
 {
...
function SegmentIntersectAngle(const Segment1,Segment2:TSegment3D):double;
begin
 {
  This section can be completed once line intersection in 3D is complete
 }
...
function InPortal(const P:TlicgCoor):Boolean;
begin
  Result := PointInRectangle(P,MinimumX,MinimumY,MaximumX,MaximumY);
end;
(* End of InPortal *)

function InPortal(const P:TlicgCoor3D):Boolean;
begin
...
function HighestPoint(const Polygon:TPolygon2D):TlicgCoor;
var
  i : Integer;
begin
...
function HighestPoint(const Point: array of TlicgCoor):TlicgCoor;
var
  i : Integer;
begin
...
function HighestPoint(const Triangle:TlicgTriangle):TlicgCoor;
begin
  Result := Triangle[1];
...
function HighestPoint(const Triangle:TlicgTriangle3D):TlicgCoor3D;
begin
  Result := Triangle[1];
  if Triangle[2].y > Result.y then
    Result := Triangle[2];
...
function HighestPoint(const Quadix:TQuadix2D):TlicgCoor;
begin
  Result := Quadix[1];
...
function HighestPoint(const Quadix:TQuadix3D):TlicgCoor3D;
begin
  Result := Quadix[1];
  if Quadix[2].y > Result.y then
    Result := Quadix[2];
...
function LowestPoint(const Polygon: TPolygon2D):TlicgCoor;
var
  i : Integer;
begin
  if Length(Polygon) = 0 then Exit;
...
function LowestPoint(const Point: array of TlicgCoor):TlicgCoor;
var
  i : Integer;
begin
  if Length(Point) = 0 then Exit;
...
function LowestPoint(const Triangle:TlicgTriangle):TlicgCoor;
begin
  Result := Triangle[1];
  if Triangle[2].y < Result.y then
     Result := Triangle[2];
...
function LowestPoint(const Triangle:TlicgTriangle3D):TlicgCoor3D;
begin
  Result := Triangle[1];
  if Triangle[2].y < Result.y then
     Result := Triangle[2];
...
function LowestPoint(const Quadix:TQuadix2D):TlicgCoor;
begin
  Result := Quadix[1];
  if Quadix[2].y < Result.y then
     Result := Quadix[2];
...
function LowestPoint(const Quadix:TQuadix3D):TlicgCoor3D;
begin
  Result := Quadix[1];
  if Quadix[2].y < Result.y then
     Result := Quadix[2];
...
function MostLeftPoint(const Polygon: TPolygon2D):TlicgCoor;
var
  i : Integer;
begin
  if Length(Polygon) = 0 then Exit;
...
function MostLeftPoint(const Point: array of TlicgCoor):TlicgCoor;
begin
  Result := MostLeftPoint(TPolygon2D(@Point));
end;
(* End of Most Left Point *)

function MostRightPoint(const Polygon: TPolygon2D):TlicgCoor;
var
  i : Integer;
begin
  if Length(Polygon) = 0 then Exit;
...
function MostRightPoint(const Point: array of TlicgCoor):TlicgCoor;
begin
  Result := MostRightPoint(TPolygon2D(@Point));
end;
(* End of Most Right Point *)

function MostUpperRight(const Polygon: TPolygon2D):TlicgCoor;
var
  i : Integer;
begin
   if Length(Polygon) = 0 then Exit;
...
function MostUpperRight(const Point: array of TlicgCoor):TlicgCoor;
begin
  Result := MostUpperRight(TPolygon2D(@Point));
end;
(* End of Most Upper Right *)

function MostUpperLeft(const Polygon: TPolygon2D):TlicgCoor;
var
  i : Integer;
begin
  if Length(Polygon) = 0 then Exit;
...
function MostUpperLeft(const Point: array of TlicgCoor):TlicgCoor;
begin
 Result := MostUpperLeft(TPolygon2D(@Point));
end;
(* End of Most Upper Left *)

function MostLowerRight(const Polygon: TPolygon2D):TlicgCoor;
var
  i : Integer;
begin
 if Length(Polygon) = 0 then Exit;
...
function MostLowerRight(const Point: array of TlicgCoor):TlicgCoor;
begin
 Result := MostLowerRight(TPolygon2D(@Point));
end;
(* End of Most Lower Right *)

function MostLowerLeft(const Polygon: TPolygon2D):TlicgCoor;
var
  i : Integer;
begin
 if Length(Polygon) = 0 then Exit;
...
function MostLowerLeft(const Point: array of TlicgCoor):TlicgCoor;
begin
  Result := MostLowerLeft(TPolygon2D(@Point));
end;
(* End of Most Lower Left *)

function _Min(const Point1,Point2:TlicgCoor):TlicgCoor;
begin
...
(* End of Minimum Between 2 Geometry.Points *)

function _Min(const Point1,Point2:TlicgCoor3D):TlicgCoor3D;
begin
       if Point1.x < Point2.x then Result := Point1
  else if Point2.x < Point1.x then Result := Point2
  else if Point1.y < Point2.y then Result := Point1
...
function _Max(const Point1,Point2:TlicgCoor):TlicgCoor;
begin
       if Point1.x > Point2.x then Result := Point1
  else if Point2.x > Point1.x then Result := Point2
  else if Point1.y > Point2.y then Result := Point1
...
(* End of Maximum Between 2 Geometry.Points *)

function _Max(const Point1,Point2:TlicgCoor3D):TlicgCoor3D;
begin
       if Point1.x > Point2.x then Result := Point1
  else if Point2.x > Point1.x then Result := Point2
  else if Point1.y > Point2.y then Result := Point1
...
function Coincident(const Point1,Point2:TlicgCoor):Boolean;
begin
  Result := IsEqual(Point1,Point2);
end;
(* End of Coincident - 2D Geometry.Points *)

function Coincident(const Point1,Point2:TlicgCoor3D):Boolean;
begin
  Result := IsEqual(Point1,Point2);
end;
(* End of Coincident - 3D Geometry.Points *)
...
function Coincident(const Triangle1,Triangle2:TlicgTriangle):Boolean;
var
...
function Coincident(const Triangle1,Triangle2:TlicgTriangle3D):Boolean;
var
  Flag  : array [1..3] of Boolean;
  Count : Integer;
  i     : Integer;
...
function Parallel(const x1,y1,x2,y2,x3,y3,x4,y4:double; const Epsilon : double = Epsilon_Medium):Boolean;
begin
  Result := IsEqual(((y1 - y2) * (x3 - x4)),((y3 - y4) * (x1 - x2)),Epsilon);
end;
(* End of Parallel *)

function Parallel(const Point1,Point2,Point3,Point4:TlicgCoor; const Epsilon : double = Epsilon_Medium):Boolean;
begin
  Result := Parallel(Point1.x,Point1.y,Point2.x,Point2.y,Point3.x,Point3.y,Point4.x,Point4.y,Epsilon);
end;
(* End of Parallel *)

function Parallel(const Segment1,Segment2:TSegment2D; const Epsilon : double = Epsilon_Medium):Boolean;
begin
  Result := Parallel(Segment1[1],Segment1[2],Segment2[1],Segment2[2],Epsilon);
end;
(* End of Parallel *)

function Parallel(const Line1,Line2:TlicgLine; const Epsilon : double = Epsilon_Medium):Boolean;
begin
  Result := Parallel(Line1[1],Line1[2],Line2[1],Line2[2],Epsilon);
end;
(* End of Parallel *)

function Parallel(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4:double; const Epsilon : double = Epsilon_Medium):Boolean;
var
  Dx1 : double;
  Dx2 : double;
  Dy1 : double;
...
function Parallel(const Point1,Point2,Point3,Point4:TlicgCoor3D; const Epsilon : double = Epsilon_Medium):Boolean;
begin
...
function Parallel(const Segment1,Segment2:TSegment3D; const Epsilon : double = Epsilon_Medium):Boolean;
begin
  Result:= Parallel(Segment1[1],Segment1[2],Segment2[1],Segment2[2],Epsilon);
end;
(* End of Parallel *)

function Parallel(const Line1,Line2:TlicgLine3D; const Epsilon : double = Epsilon_Medium):Boolean;
begin
  Result:= Parallel(Line1[1],Line1[2],Line2[1],Line2[2],Epsilon);
end;
(* End of Parallel *)

function RobustParallel(const x1,y1,x2,y2,x3,y3,x4,y4:double; const Epsilon:double = Epsilon_Medium):Boolean;
var
   Px1 : double;
   Py1 : double;
   Px2 : double;
...
function RobustParallel(const Point1,Point2,Point3,Point4:TlicgCoor; const Epsilon:double = Epsilon_Medium):Boolean;
begin
  Result := RobustParallel(Point1.x,Point1.y,Point2.x,Point2.y,Point3.x,Point3.y,Point4.x,Point4.y,Epsilon);
end;
(* End of Robust Parallel *)

function RobustParallel(const Segment1,Segment2:TSegment2D; const Epsilon:double = Epsilon_Medium):Boolean;
begin
  Result := RobustParallel(Segment1[1],Segment1[2],Segment2[1],Segment2[2],Epsilon);
end;
(* End of Robust Parallel *)

function RobustParallel(const Line1,Line2:TlicgLine; const Epsilon:double = Epsilon_Medium):Boolean;
begin
  Result := RobustParallel(Line1[1],Line1[2],Line2[1],Line2[2],Epsilon);
end;
(* End of Robust Parallel *)

function RobustParallel(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4:double;const Epsilon:double = Epsilon_Medium):Boolean;
var
  Px1 : double;
  Py1 : double;
  Pz1 : double;
...
function RobustParallel(const Point1,Point2,Point3,Point4:TlicgCoor3D; const Epsilon:double = Epsilon_Medium):Boolean;
begin
...
function RobustParallel(const Segment1,Segment2:TSegment3D; const Epsilon:double = Epsilon_Medium):Boolean;
begin
  Result := RobustParallel(Segment1[1],Segment1[2],Segment2[1],Segment2[2],Epsilon);
end;
(* End of Robust Parallel *)

function RobustParallel(const Line1,Line2:TlicgLine3D; const Epsilon:double = Epsilon_Medium):Boolean;
begin
  Result := RobustParallel(Line1[1],Line1[2],Line2[1],Line2[2],Epsilon);
end;
(* End of Robust Parallel *)

function Perpendicular(const x1,y1,x2,y2,x3,y3,x4,y4:double; const Epsilon : double = Epsilon_Medium):Boolean;
begin
  Result:= IsEqual(-1.0 * (y2 - y1) * (y4 - y3),(x4 - x3) * (x2 - x1), Epsilon);
end;
(* End of Perpendicular *)

function Perpendicular(const Point1,Point2,Point3,Point4:TlicgCoor; const Epsilon : double = Epsilon_Medium):Boolean;
begin
  Result := Perpendicular(Point1.x,Point1.y,Point2.x,Point2.y,Point3.x,Point3.y,Point4.x,Point4.y,Epsilon);
end;
(* End of Perpendicular *)

function Perpendicular(const Segment1,Segment2:TSegment2D; const Epsilon : double = Epsilon_Medium):Boolean;
begin
  Result:= Perpendicular(Segment1[1],Segment1[2],Segment2[1],Segment2[2],Epsilon);
end;
(* End of Perpendicular *)

function Perpendicular(const Line1,Line2:TlicgLine; const Epsilon : double = Epsilon_Medium):Boolean;
begin
  Result:= Perpendicular(Line1[1],Line1[2],Line2[1],Line2[2],Epsilon);
end;
(* End of Perpendicular *)

function Perpendicular(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4:double; const Epsilon : double = Epsilon_Medium):Boolean;
var
  Dx1 : double;
  Dx2 : double;
  Dy1 : double;
...
function Perpendicular(const Point1,Point2,Point3,Point4:TlicgCoor3D; const Epsilon : double = Epsilon_Medium):Boolean;
begin
...
function Perpendicular(const Segment1,Segment2:TSegment3D; const Epsilon : double = Epsilon_Medium):Boolean;
begin
  Result := Perpendicular(Segment1[1],Segment1[2],Segment2[1],Segment2[2],Epsilon);
end;
(* End of Perpendicular *)

function Perpendicular(const Line1,Line2:TlicgLine3D; const Epsilon : double = Epsilon_Medium):Boolean;
begin
  Result := Perpendicular(Line1[1],Line1[2],Line2[1],Line2[2],Epsilon);
end;
(* End of Perpendicular *)

function RobustPerpendicular(const x1,y1,x2,y2,x3,y3,x4,y4:double; const Epsilon:double = Epsilon_Medium):Boolean;
var
  P1x : double;
  P1y : double;
  P2x : double;
...
function RobustPerpendicular(const Point1,Point2,Point3,Point4:TlicgCoor; const Epsilon:double = Epsilon_Medium):Boolean;
begin
  Result := RobustPerpendicular(Point1.x,Point1.y,Point2.x,Point2.y,Point3.x,Point3.y,Point4.x,Point4.y,Epsilon);
end;
(* End of Robust Perpendicular *)

function RobustPerpendicular(const Segment1,Segment2:TSegment2D; const Epsilon:double = Epsilon_Medium):Boolean;
begin
  Result := RobustPerpendicular(Segment1[1],Segment1[2],Segment2[1],Segment2[2],Epsilon);
end;
(* End of Robust Perpendicular *)

function RobustPerpendicular(const Line1,Line2:TlicgLine; const Epsilon:double = Epsilon_Medium):Boolean;
begin
  Result := RobustPerpendicular(Line1[1],Line1[2],Line2[1],Line2[2],Epsilon);
end;
(* End of Robust Perpendicular *)

function RobustPerpendicular(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4:double; const Epsilon:double = Epsilon_Medium):Boolean;
var
  P1x : double;
  P1y : double;
  P1z : double;
...
function RobustPerpendicular(const Point1,Point2,Point3,Point4:TlicgCoor3D; const Epsilon:double = Epsilon_Medium):Boolean;
begin
...
function RobustPerpendicular(const Segment1,Segment2:TSegment3D; const Epsilon:double = Epsilon_Medium):Boolean;
begin
  Result := RobustPerpendicular(Segment1[1],Segment1[2],Segment2[1],Segment2[2],Epsilon);
end;
(* End of Robust Perpendicular *)

function RobustPerpendicular(const Line1,Line2:TlicgLine3D; const Epsilon:double = Epsilon_Medium):Boolean;
begin
  Result := RobustPerpendicular(Line1[1],Line1[2],Line2[1],Line2[2],Epsilon);
end;
(* End of Robust Perpendicular *)
...
function LineToLineIntersect(Line1,Line2:TlicgLine):Boolean;
begin
...
function RectangleWithinRectangle(const x1,y1,x2,y2,x3,y3,x4,y4:double):Boolean;
begin
...
function CircleWithinRectangle(const x,y,Radius,x1,y1,x2,y2:double):Boolean;
begin
...
function TriangleWithinRectangle(const x1,y1,x2,y2,x3,y3,x4,y4,x5,y5:double):Boolean;
begin
...
function TriangleWithinRectangle(const Triangle:TlicgTriangle; const Rectangle:TRectangle):Boolean;
begin
...
function SegmentWithinRectangle(const x1,y1,x2,y2,x3,y3,x4,y4:double):Boolean;
begin
...
function PointOfReflection(const Segment:TSegment2D; const P1,P2:TlicgCoor; out RP:TlicgCoor):Boolean;
begin
  Result := PointOfReflection(Segment[1].x,Segment[1].y,Segment[2].x,Segment[2].y,P1.x,P1.y,P2.x,P2.y,RP.x,RP.y);
end;
(* End of PointOfReflection *)

procedure Mirror(const Px,Py,x1,y1,x2,y2:double; out Nx,Ny:double);
begin
...
function Mirror(const Point:TlicgCoor; const Line:TlicgLine):TlicgCoor;
begin
  Mirror(Point.x,Point.y,Line[1].x,Line[1].y,Line[2].x,Line[2].y,Result.x,Result.y);
end;
(* End of Mirror *)

function Mirror(const Segment:TSegment2D; const Line:TlicgLine):TSegment2D;
begin
...
function Mirror(const Rectangle:TRectangle; const Line:TlicgLine):TRectangle;
begin
...
function Mirror(const Triangle:TlicgTriangle; const Line:TlicgLine):TlicgTriangle;
begin
...
function Mirror(const Quadix:TQuadix2D; const Line:TlicgLine):TQuadix2D;
begin
...
function Mirror(const Circle:TCircle; const Line:TlicgLine):TCircle;
begin
...
function Mirror(const Obj:TGeometricObject; const Line:TlicgLine):TGeometricObject;
begin
...
procedure NonSymmetricMirror(const Px,Py,x1,y1,x2,y2:double; const Ratio:double; out Nx,Ny:double);
var
  GeneralRatio : double;
begin
  ClosestPointOnLineFromPoint(x1,y1,x2,y2,Px,Py,Nx,Ny);
...
function NonSymmetricMirror(const Point:TlicgCoor; const Ratio:double; const Line:TlicgLine):TlicgCoor;
begin
  NonSymmetricMirror(Point.x,Point.y,Ratio,Line[1].x,Line[1].y,Line[2].x,Line[2].y,Result.x,Result.y);
end;
(* End of Non-symmetric Mirror *)

function NonSymmetricMirror(const Segment:TSegment2D; const Ratio:double; const Line:TlicgLine):TSegment2D;
begin
...
function NonSymmetricMirror(const Rectangle:TRectangle; const Ratio:double; const Line:TlicgLine):TRectangle;
begin
...
function NonSymmetricMirror(const Triangle:TlicgTriangle; const Ratio:double; const Line:TlicgLine):TlicgTriangle;
begin
...
function NonSymmetricMirror(const Quadix:TQuadix2D; const Ratio:double; const Line:TlicgLine):TQuadix2D;
begin
...
function NonSymmetricMirror(const Circle:TCircle; const Ratio:double; const Line:TlicgLine):TCircle;
begin
  Result.Radius := Circle.Radius;
...
function NonSymmetricMirror(const Obj:TGeometricObject; const Ratio:double; const Line:TlicgLine):TGeometricObject;
begin
  Result.ObjectType := Obj.ObjectType;
  case Obj.ObjectType of
...
(* End of Distance *)
function Distance(const Point1,Point2:TlicgCoor):double;
begin
...
function Distance(const Point1,Point2:TlicgCoor3D):double;
begin
  Result := Distance(Point1.x,Point1.y,Point1.z,Point2.x,Point2.y,Point2.z);
end;
(* End of Distance *)

function Distance(const Point:TlicgCoor; const Segment:TSegment2D):double;
begin
  Result := MinimumDistanceFromPointToSegment(Point,Segment);
end;
(* End of Distance *)

function Distance(const Point:TlicgCoor; const Rectangle:TRectangle):double;
begin
  Result := MinimumDistanceFromPointToRectangle(Point,Rectangle);
end;
(* End of Distance *)

function Distance(const Point:TlicgCoor; const Triangle:TlicgTriangle):double;
begin
  Result := MinimumDistanceFromPointToTriangle(Point,Triangle);
end;
(* End of Distance *)

function Distance(const Point:TlicgCoor; const Quadix:TQuadix2D):double;
begin
  Result := sqrt(LayDistance(Point,Quadix));
end;
(* End of Distance *)

function Distance(const Line1,Line2:TlicgLine):double;
begin
...
function Distance(const Line1,Line2:TlicgLine3D):double;
begin
  Result := DistanceLineToLine(
...
function Distance(const Segment1,Segment2:TSegment2D):double;
begin
...
function Distance(const Segment1,Segment2:TSegment3D):double;
begin
  Result := DistanceSegmentToSegment(
...
function Distance(const Segment:TSegment2D; const Triangle:TlicgTriangle):double;
begin
  Result := sqrt(LayDistance(Segment,Triangle));
end;
(* End of Distance *)

function Distance(const Segment:TSegment3D; const Triangle:TlicgTriangle3D):double;
begin
  Result := sqrt(LayDistance(Segment,Triangle));
end;
(* End of Distance *)

function Distance(const Triangle1,Triangle2:TlicgTriangle):double;
var
  i : Integer;
begin
  Result := Min(
...
function Distance(const Triangle:TlicgTriangle; const Rectangle:TRectangle):double;
begin
...
function Distance(const Rectangle1,Rectangle2:TRectangle):double;
var
  Rec1 : TRectangle;
  Rec2 : TRectangle;
begin
...
function Distance(const Segment:TSegment2D; const Rectangle:TRectangle):double;
begin
  Result := Min(
...
function Distance(const Segment:TSegment2D; const Circle:TCircle):double;
begin
   Result := Distance(ClosestPointOnCircleFromSegment(Circle,Segment),Segment);
end;
(* End of Distance *)

function Distance(const Triangle : TlicgTriangle; const Circle:TCircle):double;
var
  Point1 : TlicgCoor;
  Point2 : TlicgCoor;
begin
...
function Distance(const Rectangle : TRectangle; const Circle:TCircle):double;
var
  Point1 : TlicgCoor;
  Point2 : TlicgCoor;
begin
...
function Distance(const Point : TlicgCoor; const Circle:TCircle):double;
begin
...
function Distance(const Circle1,Circle2:TCircle):double;
var
  Dist : double;
begin
  Dist := Distance(Circle1.x,Circle1.y,Circle2.x,Circle2.y);
...
function Distance(const Sphere1,Sphere2:TSphere):double;
var
  Dist : double;
begin
...
function Distance(const Obj1,Obj2:TGeometricObject):double;
begin
  Result := 0.0;
  if (Obj1.ObjectType = geoPoint2D) and (Obj2.ObjectType = geoPoint2D) then
...
function LayDistance(const Point1,Point2:TlicgCoor):double;
begin
...
function LayDistance(const Point1,Point2:TlicgCoor3D):double;
begin
  Result := LayDistance(Point1.x,Point1.y,Point1.z,Point2.x,Point2.y,Point2.z);
end;
(* End of LayDistance *)

function LayDistance(const Point:TlicgCoor; const Triangle:TlicgTriangle):double;
begin
  Result := LayDistance(Point,ClosestPointOnTriangleFromPoint(Triangle,Point));
end;
(* End of LayDistance *)

function LayDistance(const Point:TlicgCoor; const Quadix:TQuadix2D):double;
begin
  Result := LayDistance(Point,ClosestPointOnQuadixFromPoint(Quadix,Point));
end;
(* End of LayDistance *)

function LayDistance(const Segment1,Segment2:TSegment2D):double;
begin
...
function LayDistance(const Segment1,Segment2:TSegment3D):double;
begin
  Result := LayDistanceSegmentToSegment(
                                        Segment1[1].x,Segment1[1].y,Segment1[1].z,Segment1[2].x,Segment1[2].y,Segment1[2].z,
                                        Segment2[1].x,Segment2[1].y,Segment2[1].z,Segment2[2].x,Segment2[2].y,Segment2[2].z
...
function LayDistance(const Line1,Line2:TlicgLine):double;
begin
...
function LayDistance(const Line1,Line2:TlicgLine3D):double;
begin
  Result := LayDistanceLineToLine(
                                  Line1[1].x,Line1[1].y,Line1[1].z,Line1[2].x,Line1[2].y,Line1[2].z,
                                  Line2[1].x,Line2[1].y,Line2[1].z,Line2[2].x,Line2[2].y,Line2[2].z
...
function LayDistance(const Segment:TSegment2D):double;
begin
  Result := LayDistance(Segment[1],Segment[2]);
end;
(* End of LayDistance *)

function LayDistance(const Segment:TSegment3D):double;
begin
  Result := LayDistance(Segment[1],Segment[2]);
end;
(* End of LayDistance *)

function LayDistance(const Segment:TSegment2D; const Triangle:TlicgTriangle):double;
begin
  Result := Min(
                Min(
...
function LayDistance(const Segment:TSegment3D; const Triangle:TlicgTriangle3D):double;
begin
  Result := Min(
                Min(
                    LayDistanceSegmentToSegment(
...
function ManhattanDistance(const Point1,Point2:TlicgCoor):double;
begin
...
function ManhattanDistance(const Point1,Point2:TlicgCoor3D):double;
begin
...
function ManhattanDistance(const Circle1,Circle2:TCircle):double;
begin
  Result := ManhattanDistance(Circle1.x,Circle1.y,Circle2.x,Circle2.y);
end;
(* End of ManhattanDistance *)

function VectorSumDistance(const x1,y1,x2,y2:double):double;
begin
  Result := Abs(x2 - x1) + Abs(y2 - y1);
end;
(* End of VectorSumDistance *)

function VectorSumDistance(const Point1,Point2:TlicgCoor):double;
begin
  Result := VectorSumDistance(Point1.x,Point1.y,Point2.x,Point2.y);
end;
(* End of VectorSumDistance *)

function VectorSumDistance(const x1,y1,z1,x2,y2,z2:double):double;
begin
  Result := Abs(x2 - x1) + Abs(y2 - y1) + Abs(z2 - z1);
end;
(* End of VectorSumDistance *)

function VectorSumDistance(const Point1,Point2:TlicgCoor3D):double;
begin
  Result := VectorSumDistance(Point1.x,Point1.y,Point1.z,Point2.x,Point2.y,Point2.z);
end;
(* End of VectorSumDistance *)

function VectorSumDistance(const Segment:TSegment2D):double;
begin
  Result := VectorSumDistance(Segment[1],Segment[2]);
end;
(* End of VectorSumDistance *)

function VectorSumDistance(const Segment:TSegment3D):double;
begin
  Result := VectorSumDistance(Segment[1],Segment[2]);
end;
(* End of VectorSumDistance *)

function VectorSumDistance(const Circle1,Circle2:TCircle):double;
begin
  Result := VectorSumDistance(Circle1.x,Circle1.y,Circle2.x,Circle2.y);
end;
(* End of VectorSumDistance *)

function VectorSumDistance(const Obj1,Obj2:TGeometricObject):double;
begin
  Result := 0.0;
  if (Obj1.ObjectType = geoPoint2D) and (Obj2.ObjectType = geoPoint2D) then
    Result := Distance(Obj1.Point2D,Obj2.Point2D)
...
function ChebyshevDistance(const x1,y1,x2,y2:double):double;
begin
  Result := Max(abs(x1-x2),abs(y1-y2));
end;
(* End of ChebyshevDistance *)

function ChebyshevDistance(const Point1,Point2:TlicgCoor):double;
begin
  Result := ChebyshevDistance(Point1.x,Point1.y,Point2.x,Point2.y);
end;
(* End of ChebyshevDistance *)

function ChebyshevDistance(const x1,y1,z1,x2,y2,z2:double):double;
begin
  Result := Max(Max(abs(x1-x2),abs(y1-y2)),abs(z1-z2));
end;
(* End of ChebyshevDistance *)

function ChebyshevDistance(const Point1,Point2:TlicgCoor3D):double;
begin
  Result := ChebyshevDistance(Point1.x,Point1.y,Point1.z,Point2.x,Point2.y,Point2.z);
end;
(* End of ChebyshevDistance *)

function ChebyshevDistance(const Segment:TSegment2D):double;
begin
  Result := ChebyshevDistance(Segment[1],Segment[2]);
end;
(* End of ChebyshevDistance *)

function ChebyshevDistance(const Segment:TSegment3D):double;
begin
  Result := ChebyshevDistance(Segment[1],Segment[2]);
end;
(* End of ChebyshevDistance *)

function ChebyshevDistance(const Circle1,Circle2:TCircle):double;
begin
  Result := Max(abs(Circle1.x - Circle2.x),abs(Circle1.y - Circle2.y));
end;
(* End of ChebyshevDistance *)

function InverseChebyshevDistance(const x1,y1,x2,y2:double):double;
begin
  Result := Min(abs(x1 - x2),abs(y1 - y2));
end;
(* End of InverseChebyshevDistance *)

function InverseChebyshevDistance(const Point1,Point2:TlicgCoor):double;
begin
  Result := InverseChebyshevDistance(Point1.x,Point1.y,Point2.x,Point2.y);
end;
(* End of InverseChebyshevDistance *)

function InverseChebyshevDistance(const x1,y1,z1,x2,y2,z2:double):double;
begin
  Result := Min(Min(abs(x1 - x2),abs(y1 - y2)),abs(z1 - z2));
end;
(* End of InverseChebyshevDistance *)

function InverseChebyshevDistance(const Point1,Point2:TlicgCoor3D):double;
begin
  Result := InverseChebyshevDistance(Point1.x,Point1.y,Point1.z,Point2.x,Point2.y,Point2.z);
end;
(* End of InverseChebyshevDistance *)

function InverseChebyshevDistance(const Segment:TSegment2D):double;
begin
  Result := InverseChebyshevDistance(Segment[1],Segment[2]);
end;
(* End of InverseChebyshevDistance *)

function InverseChebyshevDistance(const Segment:TSegment3D):double;
begin
  Result := InverseChebyshevDistance(Segment[1],Segment[2]);
end;
(* End of InverseChebyshevDistance *)

function InverseChebyshevDistance(const Circle1,Circle2:TCircle):double;
begin
  Result := Min(abs(Circle1.x - Circle2.x),abs(Circle1.y - Circle2.y));
end;
(* End of InverseChebyshevDistance *)

function DistanceSegmentToSegment(const x1,y1,x2,y2,x3,y3,x4,y4:double):double;
begin
  Result := sqrt(LayDistanceSegmentToSegment(x1,y1,x2,y2,x3,y3,x4,y4));
end;
(* End of DistanceSegmentToSegment *)

function DistanceSegmentToSegment(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4:double):double;
begin
  Result := sqrt(LayDistanceSegmentToSegment(x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4));
end;
(* End of DistanceSegmentToSegment *)

function LayDistanceSegmentToSegment(const x1,y1,x2,y2,x3,y3,x4,y4:double):double;
var
  ux : double;
  uy : double;
  vx : double;
...
function LayDistanceSegmentToSegment(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4:double):double;
var
  ux : double;
  uy : double;
  uz : double;
...
function DistanceLineToLine(const x1,y1,x2,y2,x3,y3,x4,y4: double):double;
begin
  Result := sqrt(LayDistanceLineToLine(x1,y1,x2,y2,x3,y3,x4,y4));
end;
(* End of DistanceLineToLine *)

function DistanceLineToLine(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4: double):double;
begin
  Result := sqrt(LayDistanceLineToLine(x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4));
end;
(* End of DistanceLineToLine *)

function LayDistanceLineToLine(const x1,y1,x2,y2,x3,y3,x4,y4: double):double;
var
  ux : double;
  uy : double;
  vx : double;
...
function LayDistanceLineToLine(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4: double):double;
var
  ux : double;
  uy : double;
  uz : double;
...
function TriangleType(const x1,y1,x2,y2,x3,y3:double):eTriangletype;
begin
...
function TriangleType(const x1,y1,z1,x2,y2,z2,x3,y3,z3:double):eTriangletype;
begin
...
function TriangleType(const Point1,Point2,Point3:TlicgCoor):eTriangletype;
begin
...
function TriangleType(const Point1,Point2,Point3:TlicgCoor3D):eTriangletype;
begin
...
function TriangleType(const Triangle:TlicgTriangle):eTriangletype;
begin
  Result := TriangleType(Triangle[1],Triangle[2],Triangle[3]);
end;
(* End of Triangletype *)

function TriangleType(const Triangle:TlicgTriangle3D):eTriangletype;
begin
  Result := TriangleType(Triangle[1],Triangle[2],Triangle[3]);
end;
(* End of Triangletype *)
...
function IsEquilateralTriangle(const Point1,Point2,Point3:TlicgCoor):Boolean;
begin
  Result := IsEquilateralTriangle(Point1.x,Point1.y,Point2.x,Point2.y,Point3.x,Point3.y);
end;
(* End of IsEquilateralTriangle *)

function IsEquilateralTriangle(const Point1,Point2,Point3:TlicgCoor3D):Boolean;
begin
  Result := IsEquilateralTriangle(Point1.x,Point1.y,Point1.z,Point2.x,Point2.y,Point2.z,Point3.x,Point3.y,Point3.z);
end;
(* End of IsEquilateralTriangle *)

function IsEquilateralTriangle(const Triangle:TlicgTriangle):Boolean;
begin
  Result := IsEquilateralTriangle(Triangle[1],Triangle[2],Triangle[3]);
end;
(* End of IsEquilateralTriangle *)

function IsEquilateralTriangle(const Triangle:TlicgTriangle3D):Boolean;
begin
  Result := IsEquilateralTriangle(Triangle[1],Triangle[2],Triangle[3]);
end;
(* End of IsEquilateralTriangle *)
...
function IsIsoscelesTriangle(const Point1,Point2,Point3:TlicgCoor):Boolean;
begin
  Result := IsIsoscelesTriangle(Point1.x, Point1.y, Point2.x, Point2.y, Point3.x, Point3.y);
end;
(* End of IsIsoscelesTriangle *)

function IsIsoscelesTriangle(const Point1,Point2,Point3:TlicgCoor3D):Boolean;
begin
  Result := IsIsoscelesTriangle(Point1.x, Point1.y,Point1.z, Point2.x, Point2.y,Point2.z, Point3.x, Point3.y, Point3.z);
end;
(* End of IsIsoscelesTriangle *)

function IsIsoscelesTriangle(const Triangle:TlicgTriangle):Boolean;
begin
  Result := IsIsoscelesTriangle(Triangle[1],Triangle[2],Triangle[3]);
end;
(* End of IsIsoscelesTriangle *)

function IsIsoscelesTriangle(const Triangle:TlicgTriangle3D):Boolean;
begin
  Result := IsIsoscelesTriangle(Triangle[1],Triangle[2],Triangle[3]);
end;
(* End of *)
...
function IsRightTriangle(const Point1,Point2,Point3:TlicgCoor):Boolean;
begin
  Result := IsRightTriangle(Point1.x,Point1.y,Point2.x,Point2.y,Point3.x,Point3.y);
end;
(* End of IsRightTriangle *)

function IsRightTriangle(const Point1,Point2,Point3:TlicgCoor3D):Boolean;
begin
  Result := IsRightTriangle(Point1.x,Point1.y, Point1.z,Point2.x,Point2.y, Point2.z,Point3.x,Point3.y,Point3.z);
end;
(* End of IsRightTriangle *)

function IsRightTriangle(const Triangle:TlicgTriangle):Boolean;
begin
  Result := IsRightTriangle(Triangle[1],Triangle[2],Triangle[3]);
end;
(* End of IsRightTriangle *)

function IsRightTriangle(const Triangle:TlicgTriangle3D):Boolean;
begin
  Result := IsRightTriangle(Triangle[1],Triangle[2],Triangle[3]);
end;
(* End of IsRightTriangle *)
...
function IsScaleneTriangle(const Point1,Point2,Point3:TlicgCoor):Boolean;
begin
  Result := IsScaleneTriangle(Point1.x, Point1.y, Point2.x, Point2.y, Point3.x, Point3.y);
end;
(* End of IsScaleneTriangle *)

function IsScaleneTriangle(const Point1,Point2,Point3:TlicgCoor3D):Boolean;
begin
  Result := IsScaleneTriangle(Point1.x, Point1.y, Point1.z, Point2.x, Point2.y, Point2.z, Point3.x, Point3.y, Point3.z);
end;
(* End of IsScaleneTriangle *)

function IsScaleneTriangle(const Triangle:TlicgTriangle):Boolean;
begin
  Result := IsScaleneTriangle(Triangle[1],Triangle[2],Triangle[3]);
end;
(* End of IsScaleneTriangle *)

function IsScaleneTriangle(const Triangle:TlicgTriangle3D):Boolean;
begin
 Result := IsScaleneTriangle(Triangle[1],Triangle[2],Triangle[3]);
end;
(* End of IsScaleneTriangle *)
...
function IsObtuseTriangle(const Point1,Point2,Point3:TlicgCoor):Boolean;
begin
  Result := IsObtuseTriangle(Point1.x, Point1.y, Point2.x, Point2.y, Point3.x, Point3.y);
end;
(* End of IsObtuseTriangle *)

function IsObtuseTriangle(const Point1,Point2,Point3:TlicgCoor3D):Boolean;
begin
  Result := IsObtuseTriangle(Point1.x, Point1.y, Point1.z, Point2.x, Point2.y, Point2.z, Point3.x, Point3.y ,Point3.z);
end;
(* End of IsObtuseTriangle *)

function IsObtuseTriangle(const Triangle:TlicgTriangle):Boolean;
begin
  Result := IsObtuseTriangle(Triangle[1],Triangle[2],Triangle[3]);
end;
(* End of IsObtuseTriangle *)

function IsObtuseTriangle(const Triangle:TlicgTriangle3D):Boolean;
begin
  Result := IsObtuseTriangle(Triangle[1],Triangle[2],Triangle[3]);
end;
(* End of IsObtuseTriangle *)

function TriangleEdge(const Triangle:TlicgTriangle; const Edge:Integer):TSegment2D;
begin
  case Edge of
...
function TriangleEdge(const Triangle:TlicgTriangle3D; const Edge:Integer):TSegment3D;
begin
  case Edge of
    1: Result := EquateSegment(Triangle[1],Triangle[2]);
    2: Result := EquateSegment(Triangle[2],Triangle[3]);
...
{ AA, ben ekledim. }
{function PointOnTriangle(const Px,Py,x1,y1,x2,y2,x3,y3:double):Boolean;
begin
   result := Collinear( Px,Py,x1,y1,x2,y2 ) or Collinear( Px,Py,x2,y2,x3,y3 ) or Collinear( Px,Py,x3,y3, x1, y1 );
end;
function PointOnTriangle(const Pnt: TlicgCoor; const Triangle: TlicgTriangle): Boolean;
begin
   result := PointOnTriangle( Pnt.X, Pnt.Y, Triangle[1].X, Triangle[1].Y, Triangle[2].X, Triangle[2].Y, Triangle[3].X, Triangle[3].Y );
end;}
{ Kodda bir hata var, tam anlamadim. }
...
function PointInTriangle(const x,y:double; const Triangle:TlicgTriangle):Boolean;
begin
...
function PointInTriangle(const Point:TlicgCoor; const Triangle:TlicgTriangle):Boolean;
begin
...
function PointInCircle(const Px,Py,Cx,Cy,Radius:double):Boolean;
begin
...
function PointInCircle(const Point:TlicgCoor; const Circle:TCircle):Boolean;
begin
...
function PointOnCircle(const Point:TlicgCoor; const Circle:TCircle):Boolean;
begin
...
function PointInThreePointCircle(const Px,Py,x1,y1,x2,y2,x3,y3:double):Boolean;
var
  a11 : double;
  a12 : double;
  a21 : double;
...
function PointInThreePointCircle(const Point,Point1,Point2,Point3:TlicgCoor):Boolean;
begin
...
function PointInThreePointCircle(const Point:TlicgCoor; const Triangle:TlicgTriangle):Boolean;
begin
...
function PointInRectangle(const Point:TlicgCoor; const x1,y1,x2,y2:double):Boolean;
begin
  Result := PointInRectangle(Point.x,Point.y,x1,y1,x2,y2);
end;
(* End of PointInRectangle *)

function PointInRectangle(const Px,Py:double; const Rectangle:TRectangle):Boolean;
begin
  Result := PointInRectangle(Px,Py,Rectangle[1].x,Rectangle[1].y,Rectangle[2].x,Rectangle[2].y);
end;
(* End of PointInRectangle *)

function PointInRectangle(const Point:TlicgCoor; const Rectangle:TRectangle):Boolean;
begin
...
function PointInQuadix(const Point,Point1,Point2,Point3,Point4:TlicgCoor):Boolean;
begin
  Result := PointInQuadix(Point.x,Point.y,Point1.x,Point1.y,Point2.x,Point2.y,Point3.x,Point3.y,Point4.x,Point4.y);
end;
(* End of PointInQuadix *)

function PointInQuadix(const x,y:double; const Quadix:TQuadix2D):Boolean;
begin
  Result := PointInQuadix(x,y,Quadix[1].x,Quadix[1].y,Quadix[2].x,Quadix[2].y,Quadix[3].x,Quadix[3].y,Quadix[4].x,Quadix[4].y);
end;
(* End of PointInQuadix *)

function PointInQuadix(const Point:TlicgCoor; const Quadix:TQuadix2D):Boolean;
begin
...
function PointInSphere(const Point3D:TlicgCoor3D; const Sphere:TSphere):Boolean;
begin
  Result := PointInSphere(Point3D.x,Point3D.y,Point3D.z,Sphere);
end;
(* End of PointInSphere *)

function PointOnSphere(const Point3D:TlicgCoor3D; const Sphere:TSphere):Boolean;
begin
...
function PointOnPerimeter(const Px,Py,x1,y1,x2,y2,x3,y3:double; Robust:Boolean = false):Boolean;
begin
  Result := (
...
function PointOnPerimeter(const Point: TlicgCoor; const Rectangle:TRectangle):Boolean;
begin
  Result := PointOnPerimeter(Point.x,Point.y,Rectangle[1].x,Rectangle[1].y,Rectangle[2].x,Rectangle[2].y);
end;
(* End of PointOnPerimeter *)

function PointOnPerimeter(const Point: TlicgCoor; const Triangle:TlicgTriangle):Boolean;
begin
  Result := PointOnPerimeter(Point.x,Point.y,Triangle[1].x,Triangle[1].y,Triangle[2].x,Triangle[2].y,Triangle[3].x,Triangle[3].y);
end;
(* End of PointOnPerimeter *)

function PointOnPerimeter(const Point: TlicgCoor; const Quadix: TQuadix2D):Boolean;
begin
...
function PointOnPerimeter(const Point: TlicgCoor; const Circle: TCircle):Boolean;
begin
...
function PointOnPerimeter(const Point: TlicgCoor3D; const Sphere: TSphere):Boolean;
begin
...
function PointOnPerimeter(const Point:TlicgCoor; const Polygon : TPolygon2D):Boolean;
begin
  Result := PointOnPolygon(Point.x,Point.y,Polygon);
end;
(* End of PointOnPerimeter *)

function PointOnPerimeter(const Point: TlicgCoor; const Obj:TGeometricObject):Boolean;
begin
  case Obj.ObjectType of
...
function PointOnPerimeter(const Point: TlicgCoor3D; const Obj:TGeometricObject):Boolean;
begin
  case Obj.ObjectType of
...
function PointInObject(const Point:TlicgCoor; const Segment:TSegment2D):Boolean;
begin
  Result := IsPointCollinear(Segment,Point);
end;
(* End of Point In Object *)

function PointInObject(const Point:TlicgCoor; const Line:TlicgLine):Boolean;
begin
  Result := Collinear(Line[1],Line[2],Point);
end;
(* End of Point In Object *)

function PointInObject(const Point:TlicgCoor; const Rectangle:TRectangle):Boolean;
begin
  Result := PointInRectangle(Point,Rectangle);
end;
(* End of Point In Object *)

function PointInObject(const Point:TlicgCoor; const Triangle:TlicgTriangle):Boolean;
begin
  Result := PointInTriangle(Point,Triangle);
end;
(* End of Point In Object *)

function PointInObject(const Point:TlicgCoor; const Quadix:TQuadix2D):Boolean;
begin
  Result := PointInQuadix(Point,Quadix);
end;
(* End of Point In Object *)

function PointInObject(const Point:TlicgCoor; const Circle:TCircle):Boolean;
begin
  Result := PointInCircle(Point,Circle);
end;
(* End of Point In Object *)

function PointInObject(const Point:TlicgCoor; const Polygon:TPolygon2D ):Boolean;
begin
  Result := PointInPolygon(Point,Polygon);
end;
(* End of Point In Object *)

function PointInObject(const Point:TlicgCoor; const Obj : TGeometricObject):Boolean;
begin
  case Obj.ObjectType of
...
function GeometricSpan(const Point: array of TlicgCoor):double;
var
  TempDistance : double;
  i            : Integer;
  j            : Integer;
...
function GeometricSpan(const Point: array of TlicgCoor3D):double;
var
  TempDistance : double;
  i            : Integer;
  j            : Integer;
...
const Sin60 : double = 0.86602540378443864676372317075294;
const Cos60 : double = 0.50000000000000000000000000000000;
begin
...
procedure CreateEquilateralTriangle(const Point1,Point2:TlicgCoor; out Point3:TlicgCoor);
begin
  CreateEquilateralTriangle(Point1.x,Point1.y,Point2.x,Point2.y,Point3.x,Point3.y);
end;
(* End of Create Equilateral Triangle *)

function CreateEquilateralTriangle(const x1,y1,x2,y2:double):TlicgTriangle;
begin
  Result[1].x := x1;
  Result[1].y := y1;
  Result[2].x := x2;
...
function CreateEquilateralTriangle(const Point1,Point2:TlicgCoor):TlicgTriangle;
begin
  Result[1] := Point1;
  Result[2] := Point2;
...
function CreateEquilateralTriangle(const Cx,Cy,SideLength : double) : TlicgTriangle;
begin
  Result := CenterAtLocation(CreateEquilateralTriangle(-SideLength * 0.5 , 0.0, SideLength * 0.5, 0.0),Cx,Cy);
end;
(* End of Create Equilateral Triangle *)

function CreateEquilateralTriangle(const CenterPoint : TlicgCoor; const SideLength : double) : TlicgTriangle;
begin
...
function TorricelliPoint(const Point1,Point2,Point3:TlicgCoor):TlicgCoor;
begin
  TorricelliPoint(Point1.x,Point1.y,Point2.x,Point2.y,Point3.x,Point3.y,Result.x,Result.y);
end;
(* End of Create Torricelli Point *)

function TorricelliPoint(const Triangle:TlicgTriangle):TlicgCoor;
begin
...
procedure Incenter(const Triangle:TlicgTriangle; out Px,Py:double);
begin
  Incenter(Triangle[1].x,Triangle[1].y,Triangle[2].x,Triangle[2].y,Triangle[3].x,Triangle[3].y,Px,Py);
end;
(* End of Incenter *)

function Incenter(const Point1,Point2,Point3:TlicgCoor):TlicgCoor;
begin
  Incenter(Point1.x,Point1.y,Point2.x,Point2.y,Point3.x,Point3.y,Result.x,Result.y);
end;
(* End of Incenter *)

function Incenter(const Triangle:TlicgTriangle):TlicgCoor;
begin
...
function Circumcircle(const Triangle:TlicgTriangle):TCircle;
begin
  Result := CircumCircle(Triangle[1],Triangle[2],Triangle[3]);
end;
(* End of TriangleCircumCircle *)

function InscribedCircle(const x1,y1,x2,y2,x3,y3:double):TCircle;
var
  Perimeter : double;
  Side12    : double;
  Side23    : double;
...
function InscribedCircle(const P1,P2,P3:TlicgCoor):TCircle;
begin
  Result := InscribedCircle(P1.x,P1.y,P2.x,P2.y,P3.x,P3.y);
end;
(* End of InscribedCircle *)

function InscribedCircle(const Triangle:TlicgTriangle):TCircle;
begin
  Result := InscribedCircle(Triangle[1],Triangle[2],Triangle[3]);
end;
(* End of InscribedCircle *)

procedure ClosestPointOnSegmentFromPoint(const x1,y1,x2,y2,Px,Py:double; out Nx,Ny:double);
var
  Vx    : double;
  Vy    : double;
  Wx    : double;
...
procedure ClosestPointOnSegmentFromPoint(const x1,y1,z1,x2,y2,z2,Px,Py,Pz:double; out Nx,Ny,Nz:double);
var
  Vx    : double;
  Vy    : double;
  Vz    : double;
...
procedure ClosestPointOnLineFromPoint(const x1,y1,z1,x2,y2,z2,Px,Py,Pz:double; out Nx,Ny,Nz:double);
var
  Vx    : double;
  Vy    : double;
  Vz    : double;
...
function ClosestPointOnSegmentFromPoint(const x1,y1,x2,y2,Px,Py:double):TlicgCoor;
begin
  ClosestPointOnSegmentFromPoint(x1,y1,x2,y2,Px,Py,Result.x,Result.y);
end;
(* End of ClosestPointOnSegmentFromPoint *)

function ClosestPointOnSegmentFromPoint(const x1,y1,z1,x2,y2,z2,Px,Py,Pz:double):TlicgCoor3D;
begin
  ClosestPointOnSegmentFromPoint(x1,y1,z1,x2,y2,z2,Px,Py,Pz,Result.x,Result.y,Result.z);
end;
(* End of ClosestPointOnSegmentFromPoint *)

function ClosestPointOnSegmentFromPoint(const Segment:TSegment2D; const Point:TlicgCoor):TlicgCoor;
begin
  ClosestPointOnSegmentFromPoint(Segment[1].x,Segment[1].y,Segment[2].x,Segment[2].y,Point.x,Point.y,Result.x,Result.y);
end;
(* End of ClosestPointOnSegmentFromPoint *)

function ClosestPointOnSegmentFromPoint(const Segment:TSegment3D; const Point:TlicgCoor3D):TlicgCoor3D;
begin
...
function ClosestPointOnLineFromPoint(const x1,y1,x2,y2,Px,Py:double):TlicgCoor;
begin
  ClosestPointOnLineFromPoint(x1,y1,x2,y2,Px,Py,Result.x,Result.y)
end;
(* End of ClosestPointOnLineFromPoint *)

function ClosestPointOnLineFromPoint(const x1,y1,z1,x2,y2,z2,Px,Py,Pz:double):TlicgCoor3D;
begin
  ClosestPointOnLineFromPoint(x1,y1,z1,x2,y2,z2,Px,Py,Pz,Result.x,Result.y,Result.z);
end;
(* End of ClosestPointOnLineFromPoint *)

function ClosestPointOnLineFromPoint(const Line:TlicgLine; const Point:TlicgCoor):TlicgCoor;
begin
  ClosestPointOnLineFromPoint(Line[1].x,Line[1].y,Line[2].x,Line[2].y,Point.x,Point.y,Result.x,Result.y);
end;
(* End of ClosestPointOnLineFromPoint *)

function ClosestPointOnLineFromPoint(const Line:TlicgLine3D; const Point:TlicgCoor3D):TlicgCoor3D;
begin
...
procedure ClosestPointOnTriangleFromPoint(const x1,y1,x2,y2,x3,y3,Px,Py:double; out Nx,Ny : double);
begin
...
function ClosestPointOnTriangleFromPoint(const Triangle:TlicgTriangle; const Px,Py:double):TlicgCoor;
begin
...
function ClosestPointOnTriangleFromPoint(const Triangle:TlicgTriangle; const Point:TlicgCoor):TlicgCoor;
begin
  Result := ClosestPointOnTriangleFromPoint(Triangle,Point.x,Point.y);
end;
(* Closest Point On Triangle 2D From Point *)

function ClosestPointOnTriangleFromPoint(const Triangle:TlicgTriangle3D; const Point:TlicgCoor3D):TlicgCoor3D;
var
  Leydist1 : double;
  Leydist2 : double;
  Leydist3 : double;
...
procedure ClosestPointOnRectangleFromPoint(const x1,y1,x2,y2,Px,Py:double; out Nx,Ny:double);
begin
...
function ClosestPointOnRectangleFromPoint(const Rectangle:TRectangle; const Px,Py:double):TlicgCoor;
begin
  ClosestPointOnRectangleFromPoint(Rectangle[1].x,Rectangle[1].y,Rectangle[2].x,Rectangle[2].y,Px,Py,Result.x,Result.y);
end;
(* Closest Point On Rectangle From Point *)

function ClosestPointOnRectangleFromPoint(const Rectangle:TRectangle; const Point:TlicgCoor):TlicgCoor;
begin
  Result := ClosestPointOnRectangleFromPoint(Rectangle,Point.x,Point.y);
end;
(* Closest Point On Rectangle From Point *)

function ClosestPointOnQuadixFromPoint(const Quadix:TQuadix2D; const Point:TlicgCoor):TlicgCoor;
var
  MinDist   : double;
  TempDist  : double;
  TempPoint : TlicgCoor;
...
function ClosestPointOnQuadixFromPoint(const Quadix:TQuadix3D; const Point:TlicgCoor3D):TlicgCoor3D;
(*
var
  Leydist1 : double;
  Leydist2 : double;
...
function MinimumDistanceFromPointToSegment(const Point:TlicgCoor; const Segment:TSegment2D):double;
begin
  Result := MinimumDistanceFromPointToSegment(Point.x,Point.y,Segment[1].x,Segment[1].y,Segment[2].x,Segment[2].y);
end;
(* End of Minimum Distance From Point to Segment *)

function MinimumDistanceFromPointToSegment(const Px,Py,Pz,x1,y1,z1,x2,y2,z2:double):double;
var
  Nx    : double;
  Ny    : double;
  Nz    : double;
...
function MinimumDistanceFromPointToSegment(const Point:TlicgCoor3D; const Segment:TSegment3D):double;
begin
...
function MinimumDistanceFromPointToLine(const Point:TlicgCoor; const Line:TlicgLine):double;
begin
  Result := MinimumDistanceFromPointToLine(Point.x,Point.y, Line[1].x,Line[1].y,Line[2].x,Line[2].y);
end;
(* End of Minimum Distance From Point to Line *)

function MinimumDistanceFromPointToLine(const Px,Py,Pz,x1,y1,z1,x2,y2,z2:double):double;
var
  Nx : double;
  Ny : double;
  Nz : double;
...
function MinimumDistanceFromPointToLine(const Point:TlicgCoor3D; const Line:TlicgLine3D):double;
begin
  Result := MinimumDistanceFromPointToLine(Point.x,Point.y,Point.z,Line[1].x,Line[1].y,Line[1].z,Line[2].x,Line[2].y,Line[2].z);
end;
(* End of Minimum Distance From Point to Line *)

function MinimumDistanceFromPointToTriangle(const Px,Py,x1,y1,x2,y2,x3,y3:double):double;
var
  Nx : double;
  Ny : double;
begin
...
function MinimumDistanceFromPointToTriangle(const Point:TlicgCoor; const Triangle:TlicgTriangle):double;
begin
...
function MinimumDistanceFromPointToRectangle(const Px,Py,x1,y1,x2,y2:double):double;
var
  Nx : double;
  Ny : double;
begin
...
function MinimumDistanceFromPointToRectangle(const Point:TlicgCoor; const Rectangle:TRectangle):double;
begin
  Result := MinimumDistanceFromPointToRectangle(Point.x,Point.y,Rectangle[1].x,Rectangle[1].y,Rectangle[2].x,Rectangle[2].y);
end;
(* End of Minimum Distance From Point to Rectangle *)

function MinimumDistanceFromPointToPolygon(const Point:TlicgCoor; const Polygon:TPolygon2D):double;
var
  i        : Integer;
  j        : Integer;
  TempDist : double;
...
procedure SegmentMidPoint(const Segment:TSegment2D; out midx, midy:double);
begin
  SegmentMidPoint(Segment[1].x,Segment[1].y,Segment[2].x,Segment[2].y,midx,midy);
end;
(* End of SegmentMidPoint *)

function SegmentMidPoint(const P1,P2:TlicgCoor):TlicgCoor;
begin
  SegmentMidPoint(P1.x,P1.y,P2.x,P2.y,Result.x,Result.y);
end;
(* End of SegmentMidPoint *)

function SegmentMidPoint(const Segment:TSegment2D):TlicgCoor;
begin
...
function SegmentMidPoint(const P1,P2:TlicgCoor3D):TlicgCoor3D;
begin
  SegmentMidpoint(P1.x,P1.y,P1.z,P2.x,P2.y,P2.z,Result.x,Result.y,Result.z);
end;
(* End of SegmentMidPoint *)

function SegmentMidPoint(const Segment:TSegment3D):TlicgCoor3D;
begin
 Result := SegmentMidPoint(Segment[1],Segment[2]);
end;
(* End of SegmentMidPoint *)

procedure Centroid(const x1,y1,x2,y2:double; out x,y:double);
begin
  x := (x1 + x2) * 0.5;
  y := (y1 + y2) * 0.5;
end;
...
function Centroid(const P1,P2:TlicgCoor):TlicgCoor;
begin
  Centroid(P1.x,P1.y,P2.x,P2.y,Result.x,Result.y);
end;
(* End of Centroid *)

function Centroid(const Segment:TSegment2D):TlicgCoor;
begin
  Result := Centroid(Segment[1],Segment[2]);
end;
(* End of Centroid *)

procedure Centroid(const x1,y1,x2,y2,x3,y3:double; out x,y:double);
var
  midx1 : double;
  midy1 : double;
  midx2 : double;
...
(* End of Centroid *)
procedure Centroid(const Triangle:TlicgTriangle; out x,y:double);
begin
...
procedure Centroid(const Rectangle:TRectangle; out x,y:double);
begin
...
function Centroid(const P1,P2,P3:TlicgCoor):TlicgCoor;
begin
  Centroid(P1.x,P1.y,P2.x,P2.y,P3.x,P3.y,Result.x,Result.y);
end;
(* End of Centroid *)

function Centroid(const Triangle:TlicgTriangle):TlicgCoor;
begin
  Result := Centroid(Triangle[1],Triangle[2],Triangle[3]);
end;
(* End of Centroid *)

function Centroid(const Rectangle:TRectangle):TlicgCoor;
begin
  Centroid(Rectangle,Result.x,Result.y);
end;
(* End of Centroid *)

procedure Centroid(const Polygon:TPolygon2D; out x,y:double);
var
  i    : Integer;
  j    : Integer;
  asum : double;
...
function Centroid(const Polygon:TPolygon2D): TlicgCoor;
begin
  Centroid(Polygon,Result.x,Result.y);
end;
(* End of PolygonCentroid *)

function Centroid(const Polygon : array of TlicgCoor3D):TlicgCoor3D;
var
  TotalArea : double;
  TempArea  : double;
  i         : Integer;
...
function PointInConvexPolygon(const Px,Py:double; const Polygon:TPolygon2D):Boolean;
var
  i                  : Integer;
  j                  : Integer;
...
function PointInConvexPolygon(const Point:TlicgCoor; const Polygon:TPolygon2D):Boolean;
begin
  Result := PointInConvexPolygon(Point.x,Point.y,Polygon);
end;
(* End of PointInConvexPolygon *)

function PointInConcavePolygon(const Px,Py:double; const Polygon:TPolygon2D):Boolean;
begin
 (* to be implemented at a later date *)
  Result := False;
end;
...
function PointInConcavePolygon(const Point:TlicgCoor; const Polygon:TPolygon2D):Boolean;
begin
  Result := PointInConcavePolygon(Point.x,Point.y,Polygon);
end;
(* End of PointInConcavePolygon *)

function PointOnPolygon(const Px,Py:double; const Polygon:TPolygon2D):Boolean;
var
  i : Integer;
  j : Integer;
begin
  ...
  for i := 0 to Length(Polygon) - 1 do
  begin
    { y nin ayni oldugu kenarlarda calismiyor. esitligin ikinci kismini da <= yapmalisin. }
...
function PointOnPolygon(const Point:TlicgCoor; const Polygon:TPolygon2D):Boolean;
begin
  Result := PointOnPolygon(Point.x,Point.y,Polygon);
end;
(* End of PointOnPolygon *)

function PointInPolygon(const Px,Py:double; const Polygon:TPolygon2D):Boolean;
var
  i : Integer;
  j : Integer;
begin
...
function PointInPolygon(const Point:TlicgCoor; const Polygon:TPolygon2D):Boolean;
begin
  Result := PointInPolygon(Point.x,Point.y,Polygon);
end;
(* End PointInPolygon *)

function PointInPolygon(const Point: array of TlicgCoor; const Polygon:TPolygon2D): TBooleanArray;
var
  i               : Integer;
  j               : Integer;
  k               : Integer;
...
function ConvexPolygon(const Polygon:array of TlicgCoor):Boolean;
var
  i                  : Integer;
  j                  : Integer;
  k                  : Integer;
...
function RectangularHull(const Point:array of TlicgCoor):TRectangle;
var
  MaxX : double;
  MaxY : double;
  MinX : double;
...
function CreateBarycentricUnit(const x1,y1,x2,y2,x3,y3:double):TBarycentricUnit;
begin
  Result.x1    := x1;
  Result.y1    := y1;
  Result.x2    := x2;
...
function CreateBarycentricUnit(const Triangle : TlicgTriangle):TBarycentricUnit;
begin
...
procedure ConvertCartesianToBarycentric(const x1,y1,x2,y2,x3,y3,px,py:double; out u,v,w: double);
var
  BarycentricBase : double;
begin
...
procedure ConvertCartesianToBarycentric(const BU:TBarycentricUnit; Px,Py:double; out u,v,w: double);
var
  BarycentricBase : double;
begin
...
procedure ConvertCartesianToBarycentric(const BU:TBarycentricUnit; const Point:TlicgCoor; out BCrd: TBarycentricTriplet);
begin
  ConvertCartesianToBarycentric(BU,Point.x,Point.y,BCrd.u,BCrd.v,BCrd.w);
end;
(* End Of Convert Cartesian to Barycentric *)

function ConvertCartesianToBarycentric(const BU:TBarycentricUnit; const Point:TlicgCoor): TBarycentricTriplet;
begin
  ConvertCartesianToBarycentric(BU,Point,Result);
end;
(* End Of Convert Cartesian to Barycentric *)

procedure ConvertBarycentricToCartesian(const u,v,w,x1,y1,x2,y2,x3,y3:double; out x,y:double);
begin
  x := u * x1 + v * x2 + w * x3;
  y := u * y1 + v * y2 + w * y3;
end;
...
procedure ConvertBarycentricToCartesian(const u,v,w:double; BU:TBarycentricUnit; out x,y:double);
begin
  ConvertBarycentricToCartesian(u,v,w,BU.x1,BU.y1,BU.x2,BU.y2,BU.x3,BU.y3,x,y);
end;
(* End Of Convert Barycentric to Cartesian *)

procedure ConvertBarycentricToCartesian(const u,v,w:double; BU:TBarycentricUnit; out Point:TlicgCoor);
begin
  ConvertBarycentricToCartesian(u,v,w,BU.x1,BU.y1,BU.x2,BU.y2,BU.x3,BU.y3,Point.x,Point.y);
end;
(* End Of Convert Barycentric to Cartesian *)

function ConvertBarycentricToCartesian(const u,v,w:double; BU:TBarycentricUnit):TlicgCoor;
begin
...
function Clip(const Segment:TSegment2D; const Rect:TRectangle; out CSegment:TSegment2D):Boolean;
 ...
 const CLIP_LEFT   = 4;
 const CLIP_RIGHT  = 8;
  function OutCode(const x,y:double):Integer;
  begin
    Result := 0;
    if y < Rect[1].y then
...
function Clip(const Segment:TSegment2D; const Triangle:TlicgTriangle; out CSegment:TSegment2D):Boolean;
var
  Pos : Integer;
begin
  Pos := 1;
...
(* End of Clip *)
function Area( const x1, y1, x2, y2, x3, y3 : double ): double;
begin
  Result := 0.5 * ( (x1 * (y2 - y3)) + (x2 * (y3 - y1)) + (x3 * (y1 - y2)) );
end;
function Area(const Point1,Point2,Point3:TlicgCoor):double;
begin
  Result := 0.5 *
                  (
...
(* End of Area 3-2D Geometry.Points *)
function Area( const x1,y1,z1, x2,y2,z2, x3,y3,z3 : double ): double;
var
  Dx1 : double;
  Dx2 : double;
  Dy1 : double;
...
function Area(const Point1,Point2,Point3:TlicgCoor3D):double;
var
  Dx1 : double;
  Dx2 : double;
  Dy1 : double;
...
(* End of Area 3-3D Geometry.Points *)

function Area(const Triangle:TlicgTriangle):double;
begin
  Result := 0.5 *
                 (
...
function Area(const Triangle:TlicgTriangle3D):double;
var
  Dx1 : double;
  Dx2 : double;
  Dy1 : double;
...
function Area(const Quadix:TQuadix2D):double;
begin
  Result := 0.5 *
                 (
...
function Area(const Quadix:TQuadix3D):double;
begin
  Result := (
...
function Area(const Rectangle:TRectangle):double;
begin
  Result := abs(Rectangle[2].x - Rectangle[1].x) * abs(Rectangle[2].y - Rectangle[1].y);
end;
(* End of Area *)

function Area(const Circle:TCircle):double;
begin
  Result := PI2 * Circle.Radius * Circle.Radius;
end;
(* End of Area *)

function Area(const Polygon:TPolygon2D):double;
var
  i : Integer;
  j : Integer;
begin
...
function Area(const Obj:TGeometricObject):double;
begin
  case Obj.ObjectType of
...
function Perimeter(const Triangle:TlicgTriangle):double;
begin
...
function Perimeter(const Triangle:TlicgTriangle3D):double;
begin
  Result:= Distance(Triangle[1],Triangle[2]) +
           Distance(Triangle[2],Triangle[3]) +
           Distance(Triangle[3],Triangle[1]);
...
function Perimeter(const Quadix:TQuadix2D):double;
begin
...
function Perimeter(const Quadix:TQuadix3D):double;
begin
  Result:= Distance(Quadix[1],Quadix[2]) +
           Distance(Quadix[2],Quadix[3]) +
           Distance(Quadix[3],Quadix[4]) +
...
function Perimeter(const Rectangle:TRectangle):double;
begin
  Result:= 2 * (abs(Rectangle[2].x - Rectangle[1].x) + abs(Rectangle[2].y - Rectangle[1].y));
end;
(* End of Perimeter *)

function Perimeter(const Circle:TCircle):double;
begin
  Result:= 2 * Pi * Circle.Radius;
end;
(* End of Perimeter *)

function Perimeter(const Polygon:TPolygon2D):double;
var
  i : Integer;
  j : Integer;
begin
...
function Perimeter(const Obj:TGeometricObject):double;
begin
  case Obj.ObjectType of
...
function SemiPerimeter(const Triangle : TlicgTriangle):double;
begin
  Result := Perimeter(Triangle) * 0.5;
end;
(* End of Perimeter *)

function SemiPerimeter(const Triangle : TlicgTriangle3D):double;
begin
  Result := Perimeter(Triangle) * 0.5;
end;
(* End of Perimeter *)
...
function Rotate(const RotAng:double; const Point:TlicgCoor):TlicgCoor;
begin
  Rotate(RotAng,Point.x,Point.y,Result.x,Result.y);
end;
(* End of Rotate Point *)

function Rotate(const RotAng:double; const Point,OPoint:TlicgCoor):TlicgCoor;
begin
  Rotate(RotAng,Point.x,Point.y,OPoint.x,OPoint.y,Result.x,Result.y);
end;
(* End of Rotate Point About Origin *)

function Rotate(const RotAng:double; const Segment:TSegment2D):TSegment2D;
begin
...
function Rotate(const RotAng:double; const Segment:TSegment2D; const OPoint:TlicgCoor):TSegment2D;
begin
...
function Rotate(const RotAng:double; const Triangle:TlicgTriangle):TlicgTriangle;
begin
...
function Rotate(const RotAng:double; const Triangle:TlicgTriangle; const OPoint:TlicgCoor):TlicgTriangle;
begin
...
function Rotate(const RotAng:double; const Quadix:TQuadix2D):TQuadix2D;
begin
...
function Rotate(const RotAng:double; const Quadix:TQuadix2D; const OPoint:TlicgCoor):TQuadix2D;
begin
...
function Rotate(const RotAng:double; const Polygon:TPolygon2D):TPolygon2D;
var
  i : Integer;
begin
  SetLength(Result,Length(Polygon));
...
function Rotate(const RotAng:double; const Polygon:TPolygon2D; const OPoint:TlicgCoor):TPolygon2D;
var
  i : Integer;
begin
  SetLength(Result,Length(Polygon));
...
function Rotate(const RotAng:double; const Obj:TGeometricObject):TGeometricObject;
begin
  case Obj.ObjectType of
...
function Rotate(const RotAng:double; const Obj:TGeometricObject; const OPoint: TlicgCoor):TGeometricObject;
begin
  case Obj.ObjectType of
...
function Rotate(const Rx,Ry,Rz:double; const Point:TlicgCoor3D):TlicgCoor3D;
begin
  Rotate(Rx,Ry,Rz,Point.x,Point.y,Point.z,Result.x,Result.y,Result.z);
end;
(* End of Rotate 3D Point *)

function Rotate(const Rx,Ry,Rz:double; const Point,OPoint:TlicgCoor3D):TlicgCoor3D;
begin
  Rotate(Rx,Ry,Rz,Point.x,Point.y,Point.z,OPoint.x,OPoint.y,OPoint.z,Result.x,Result.y,Result.z);
end;
(* End of Rotate 3D Point About Origin Point *)

function Rotate(const Rx,Ry,Rz:double; const Segment:TSegment3D):TSegment3D;
begin
...
function Rotate(const Rx,Ry,Rz:double; const Segment:TSegment3D; const OPoint:TlicgCoor3D):TSegment3D;
begin
...
function Rotate(const Rx,Ry,Rz:double; const Triangle:TlicgTriangle3D):TlicgTriangle3D;
begin
...
function Rotate(const Rx,Ry,Rz:double; const Triangle:TlicgTriangle3D; const OPoint:TlicgCoor3D):TlicgTriangle3D;
begin
...
function Rotate(const Rx,Ry,Rz:double; const Quadix:TQuadix3D):TQuadix3D;
begin
...
function Rotate(const Rx,Ry,Rz:double; const Quadix:TQuadix3D; const OPoint:TlicgCoor3D):TQuadix3D;
begin
...
function Rotate(const Rx,Ry,Rz:double; const Polygon:TPolygon3D):TPolygon3D;
var
  i : Integer;
begin
  SetLength(Result,Length(Polygon));
...
function Rotate(const Rx,Ry,Rz:double; const Polygon:TPolygon3D; const OPoint:TlicgCoor3D):TPolygon3D;
var
  i : Integer;
begin
  SetLength(Result,Length(Polygon));
...
function Rotate(const Rx,Ry,Rz:double; const Obj:TGeometricObject):TGeometricObject;
begin
  case Obj.ObjectType of
...
function Rotate(const Rx,Ry,Rz:double; const Obj:TGeometricObject; const OPoint: TlicgCoor3D):TGeometricObject;
begin
  case Obj.ObjectType of
...
function FastRotate(const RotAng:Integer; const Point:TlicgCoor):TlicgCoor;
begin
  FastRotate(RotAng,Point.x,Point.y,Result.x,Result.y);
end;
(* End of Fast Rotation *)

function FastRotate(const RotAng:Integer; const Point,OPoint:TlicgCoor):TlicgCoor;
begin
...
function FastRotate(const RotAng:Integer; const Segment:TSegment2D; const OPoint:TlicgCoor):TSegment2D;
begin
...
function FastRotate(const RotAng:Integer; const Triangle:TlicgTriangle):TlicgTriangle;
begin
...
function FastRotate(const RotAng:Integer; const Triangle:TlicgTriangle; const OPoint:TlicgCoor):TlicgTriangle;
begin
...
function FastRotate(const RotAng:Integer; const Quadix:TQuadix2D; const OPoint:TlicgCoor):TQuadix2D;
begin
...
function FastRotate(const RotAng:Integer; const Polygon:TPolygon2D; const OPoint:TlicgCoor):TPolygon2D;
var
  i : Integer;
begin
  SetLength(Result,Length(Polygon));
...
function FastRotate(const RotAng:Integer; const Obj:TGeometricObject; const OPoint: TlicgCoor):TGeometricObject;
begin
  case Obj.ObjectType of
...
function FastRotate(const Rx,Ry,Rz:Integer; const Point:TlicgCoor3D):TlicgCoor3D;
begin
  FastRotate(Rx,Ry,Rz,Point.x,Point.y,Point.z,Result.x,Result.y,Result.z);
end;
(* End of Fast Rotation *)

function FastRotate(const Rx,Ry,Rz:Integer; const Point,OPoint:TlicgCoor3D):TlicgCoor3D;
begin
...
function FastRotate(const Rx,Ry,Rz:Integer; const Segment:TSegment3D; const OPoint:TlicgCoor3D):TSegment3D;
begin
...
function FastRotate(const Rx,Ry,Rz:Integer; const Triangle:TlicgTriangle3D):TlicgTriangle3D;
begin
...
function FastRotate(const Rx,Ry,Rz:Integer; const Triangle:TlicgTriangle3D; const OPoint:TlicgCoor3D):TlicgTriangle3D;
begin
...
function FastRotate(const Rx,Ry,Rz:Integer; const Quadix:TQuadix3D; const OPoint:TlicgCoor3D):TQuadix3D;
begin
...
function FastRotate(const Rx,Ry,Rz:Integer; const Polygon:TPolygon3D; const OPoint:TlicgCoor3D):TPolygon3D;
var
  i : Integer;
begin
  SetLength(Result,Length(Polygon));
...
function FastRotate(const Rx,Ry,Rz:Integer; const Obj:TGeometricObject; const OPoint: TlicgCoor3D):TGeometricObject;
begin
  case Obj.ObjectType of
...
function Translate(const Dx,Dy:double; const Point:TlicgCoor):TlicgCoor;
begin
  Result.x := Point.x + Dx;
  Result.y := Point.y + Dy;
end;
...
function Translate(const Dx,Dy:double; const Line:TlicgLine):TlicgLine;
begin
...
function Translate(const Dx,Dy:double; const Segment:TSegment2D):TSegment2D;
begin
...
function Translate(const Dx,Dy:double; const Triangle:TlicgTriangle):TlicgTriangle;
begin
...
function Translate(const Dx,Dy:double; const Quadix:TQuadix2D):TQuadix2D;
begin
...
function Translate(const Dx,Dy:double; const Rectangle:TRectangle):TRectangle;
begin
...
function Translate(const Dx,Dy:double; const Circle:TCircle):TCircle;
begin
...
function Translate(const Dx,Dy:double; const Polygon:TPolygon2D):TPolygon2D;
var
  i : Integer;
begin
  SetLength(Result,Length(Polygon));
...
function Translate(const Point:TlicgCoor; const Polygon:TPolygon2D):TPolygon2D;
begin
  Result:= Translate(Point.x,Point.y,Polygon);
end;
(* End of Translate *)

function Translate(const Dx,Dy:double; const Obj:TGeometricObject):TGeometricObject;
begin
  case Obj.ObjectType of
...
function Translate(const Delta:double; const Point:TlicgCoor):TlicgCoor;
begin
  Result := Translate(Delta,Delta,Point);
end;
(* End of Translate *)

function Translate(const Delta:double; const Line:TlicgLine):TlicgLine;
begin
  Result := Translate(Delta,Delta,Line);
end;
(* End of Translate *)

function Translate(const Delta:double; const Segment:TSegment2D):TSegment2D;
begin
  Result := Translate(Delta,Delta,Segment);
end;
(* End of Translate *)

function Translate(const Delta:double; const Triangle:TlicgTriangle):TlicgTriangle;
begin
  Result := Translate(Delta,Delta,Triangle);
end;
(* End of Translate *)

function Translate(const Delta:double; const Quadix:TQuadix2D):TQuadix2D;
begin
  Result := Translate(Delta,Delta,Quadix);
end;
(* End of Translate *)

function Translate(const Delta:double; const Rectangle:TRectangle):TRectangle;
begin
  Result := Translate(Delta,Delta,Rectangle);
end;
(* End of Translate *)

function Translate(const Delta:double; const Circle:TCircle):TCircle;
begin
  Result := Translate(Delta,Delta,Circle);
end;
(* End of Translate *)

function Translate(const Delta:double; const Polygon:TPolygon2D):TPolygon2D;
begin
  Result := Translate(Delta,Delta,Polygon);
end;
(* End of Translate *)

function Translate(const Delta:double; const Obj:TGeometricObject):TGeometricObject;
begin
  Result := Translate(Delta,Delta,Obj);
end;
(* End of Translate *)

function Translate(const Dx,Dy,Dz:double; const Point:TlicgCoor3D):TlicgCoor3D;
begin
  Result.x := Point.x + Dx;
  Result.y := Point.y + Dy;
  Result.z := Point.z + Dz;
...
function Translate(const Dx,Dy,Dz:double; const Line:TlicgLine3D):TlicgLine3D;
begin
  Result[1].x := Line[1].x + Dx;
  Result[1].y := Line[1].y + Dy;
...
function Translate(const Dx,Dy,Dz:double; const Segment:TSegment3D):TSegment3D;
begin
  Result[1].x := Segment[1].x + Dx;
  Result[1].y := Segment[1].y + Dy;
...
function Translate(const Dx,Dy,Dz:double; const Triangle:TlicgTriangle3D):TlicgTriangle3D;
begin
  Result[1].x := Triangle[1].x + Dx;
  Result[1].y := Triangle[1].y + Dy;
...
function Translate(const Dx,Dy,Dz:double; const Quadix:TQuadix3D):TQuadix3D;
begin
  Result[1].x := Quadix[1].x + Dx;
  Result[1].y := Quadix[1].y + Dy;
...
function Translate(const Dx,Dy,Dz:double; const Polygon:TPolygon3D):TPolygon3D;
var
  i : Integer;
begin
  SetLength(Result,Length(Polygon));
...
function Translate(const Point:TlicgCoor3D; const Polygon:TPolygon3D):TPolygon3D;
begin
  Result := Translate(Point.x,Point.y,Point.z,Polygon);
end;
(* End of Translate *)

function Translate(const Dx,Dy,Dz:double; const Obj:TGeometricObject):TGeometricObject;
begin
  case Obj.ObjectType of
...
function Scale(const Dx,Dy:double; const Point:TlicgCoor):TlicgCoor;
begin
  Result.x := Point.x * Dx;
  Result.y := Point.y * Dy;
end;
...
function Scale(const Dx,Dy:double; const Line:TlicgLine):TlicgLine;
begin
  Result[1].x := Line[1].x * Dx;
  Result[1].y := Line[1].y * Dy;
  Result[2].x := Line[2].x * Dx;
...
function Scale(const Dx,Dy:double; const Segment:TSegment2D):TSegment2D;
begin
  Result[1].x := Segment[1].x * Dx;
  Result[1].y := Segment[1].y * Dy;
...
function Scale(const Dx,Dy:double; const Triangle:TlicgTriangle):TlicgTriangle;
begin
  Result[1].x := Triangle[1].x * Dx;
  Result[1].y := Triangle[1].y * Dy;
  Result[2].x := Triangle[2].x * Dx;
...
function Scale(const Dx,Dy:double; const Quadix:TQuadix2D):TQuadix2D;
begin
  Result[1].x := Quadix[1].x * Dx;
  Result[1].y := Quadix[1].y * Dy;
  Result[2].x := Quadix[2].x * Dx;
...
function Scale(const Dx,Dy:double; const Rectangle:TRectangle):TRectangle;
begin
  Result[1].x := Rectangle[1].x * Dx;
  Result[1].y := Rectangle[1].y * Dy;
  Result[2].x := Rectangle[2].x * Dx;
...
function Scale(const Dr:double; const Circle:TCircle):TCircle;
begin
  Result.x      := Circle.x;
  Result.y      := Circle.y;
...
function Scale(const Dx,Dy:double; const Polygon:TPolygon2D):TPolygon2D;
var
  i : Integer;
begin
  SetLength(Result,Length(Polygon));
...
function Scale(const Dx,Dy:double; const Obj:TGeometricObject):TGeometricObject;
begin
  case Obj.ObjectType of
...
function Scale(const Dx,Dy,Dz:double; const Point:TlicgCoor3D):TlicgCoor3D;
begin
  Result.x := Point.x * Dx;
  Result.y := Point.y * Dy;
  Result.z := Point.z * Dz;
...
function Scale(const Dx,Dy,Dz:double; const Line:TlicgLine3D):TlicgLine3D;
begin
  Result[1].x := Line[1].x * Dx;
  Result[1].y := Line[1].y * Dy;
  Result[1].z := Line[1].z * Dz;
...
function Scale(const Dx,Dy,Dz:double; const Segment:TSegment3D):TSegment3D;
begin
  Result[1].x := Segment[1].x * Dx;
  Result[1].y := Segment[1].y * Dy;
  Result[1].z := Segment[1].z * Dz;
...
function Scale(const Dx,Dy,Dz:double; const Triangle:TlicgTriangle3D):TlicgTriangle3D;
begin
  Result[1].x := Triangle[1].x * Dx;
  Result[1].y := Triangle[1].y * Dy;
  Result[1].z := Triangle[1].z * Dz;
...
function Scale(const Dx,Dy,Dz:double; const Quadix:TQuadix3D):TQuadix3D;
begin
  Result[1].x := Quadix[1].x * Dx;
  Result[1].y := Quadix[1].y * Dy;
  Result[1].z := Quadix[1].z * Dz;
...
function Scale(const Dx,Dy,Dz:double; const Polygon:TPolygon3D):TPolygon3D;
var
  i : Integer;
begin
  SetLength(Result,Length(Polygon));
...
function Scale(const Dx,Dy,Dz:double; const Obj:TGeometricObject):TGeometricObject;
begin
  case Obj.ObjectType of
...
(* End of Shear Cartesian Cooriante Along X-Axis *)

function ShearXAxis(const Shear:double; const Point:TlicgCoor):TlicgCoor;
begin
  ShearXAxis(Shear,Point.x,Point.y,Result.x,Result.y);
end;
(* End of Shear 2D Point Along X-Axis *)

function ShearXAxis(const Shear:double; const Segment:TSegment2D):TSegment2D;
begin
...
function ShearXAxis(const Shear:double; const Triangle:TlicgTriangle):TlicgTriangle;
begin
...
function ShearXAxis(const Shear:double; const Quadix:TQuadix2D):TQuadix2D;
begin
...
function ShearXAxis(const Shear:double; const Polygon:TPolygon2D):TPolygon2D;
var
  i : Integer;
begin
  SetLength(Result,Length(Polygon));
...
function ShearXAxis(const Shear:double; const Obj:TGeometricObject):TGeometricObject;
begin
  case Obj.ObjectType of
...
(* End of Shear Cartesian Cooriante Along Y-Axis *)

function ShearYAxis(const Shear:double; const Point:TlicgCoor):TlicgCoor;
begin
  ShearYAxis(Shear,Point.x,Point.y,Result.x,Result.y);
end;
(* End of Shear 2D Point Along Y-Axis *)

function ShearYAxis(const Shear:double; const Segment:TSegment2D):TSegment2D;
begin
...
function ShearYAxis(const Shear:double; const Triangle:TlicgTriangle):TlicgTriangle;
begin
...
function ShearYAxis(const Shear:double; const Quadix:TQuadix2D):TQuadix2D;
begin
...
function ShearYAxis(const Shear:double; const Polygon:TPolygon2D):TPolygon2D;
var
  i : Integer;
begin
  SetLength(Result,Length(Polygon));
...
function ShearYAxis(const Shear:double; const Obj:TGeometricObject):TGeometricObject;
begin
  case Obj.ObjectType of
...
function CenterAtLocation(const Point:TlicgCoor; const x,y:double):TlicgCoor;
begin
  Result.x := x;
  Result.y := y;
end;
...
function CenterAtLocation(const Segment:TSegment2D; const x,y:double):TSegment2D;
var
  Cx : double;
  Cy : double;
begin
...
function CenterAtLocation(const Triangle:TlicgTriangle; const x,y:double):TlicgTriangle;
var
  Cx : double;
  Cy : double;
begin
...
function CenterAtLocation(const Rectangle:TRectangle; const x,y:double):TRectangle;
var
  Cx : double;
  Cy : double;
begin
...
function CenterAtLocation(const Quadix:TQuadix2D; const x,y:double):TQuadix2D;
begin
 (* to Be Completed *)
end;
(* End Of Center At Location *)

function CenterAtLocation(const Circle:TCircle; const x,y:double):TCircle;
begin
  Result.x := x;
  Result.y := y;
end;
...
function CenterAtLocation(const Polygon:TPolygon2D; const x,y:double):TPolygon2D;
var
  Cx : double;
  Cy : double;
begin
...
function CenterAtLocation(const Point, CPoint:TlicgCoor):TlicgCoor;
begin
  Result := CenterAtLocation(Point,CPoint.x,Point.y);
end;
(* End Of Center At Location *)

function CenterAtLocation(const Segment:TSegment2D; const CPoint:TlicgCoor):TSegment2D;
begin
  Result := CenterAtLocation(Segment,CPoint.x,CPoint.y);
end;
(* End Of Center At Location *)

function CenterAtLocation(const Triangle:TlicgTriangle; const CPoint:TlicgCoor):TlicgTriangle;
begin
  Result := CenterAtLocation(Triangle,CPoint.x,CPoint.y);
end;
(* End Of Center At Location *)

function CenterAtLocation(const Rectangle:TRectangle; const CPoint:TlicgCoor):TRectangle;
begin
  Result := CenterAtLocation(Rectangle,CPoint.x,CPoint.y);
end;
(* End Of Center At Location *)

function CenterAtLocation(const Quadix:TQuadix2D; const CPoint:TlicgCoor):TQuadix2D;
begin
  Result := CenterAtLocation(Quadix,CPoint.x,CPoint.y);
end;
(* End Of Center At Location *)

function CenterAtLocation(const Circle:TCircle; const CPoint:TlicgCoor):TCircle;
begin
  Result := CenterAtLocation(Circle,CPoint.x,CPoint.y);
end;
(* End Of Center At Location *)

function CenterAtLocation(const Polygon:TPolygon2D; const CPoint:TlicgCoor):TPolygon2D;
begin
...
function AABB(const Triangle : TlicgTriangle):TRectangle;
var
  i  : Integer;
begin
...
function AABB(const Curve : TlicgCoorArray):TRectangle;
var
  i  : Integer;
begin
...
procedure AABB(const Segment : TSegment2D; out x1,y1,x2,y2:double);
var
...
procedure AABB(const Triangle : TlicgTriangle; out x1,y1,x2,y2:double);
var
   Rectangle : TRectangle;
begin
...
(* End Of AABB *)
procedure AABB(const Rectangle : TRectangle;  out x1,y1,x2,y2:double);
var
...
procedure AABB(const Quadix : TQuadix2D; out x1,y1,x2,y2:double);
var
   Rectangle : TRectangle;
begin
...
procedure AABB(const Circle : TCircle; out x1,y1,x2,y2:double);
var
   Rectangle : TRectangle;
begin
...
procedure AABB(const Polygon : TPolygon2D; out x1,y1,x2,y2:double);
var
   Rectangle : TRectangle;
begin
...
procedure AABB(const Curve : TlicgCoorArray; out x1,y1,x2,y2:double);
var
   Rectangle : TRectangle;
begin
...
procedure ProjectPoint(const Srcx,Srcy,Dstx,Dsty,Dist:double; out Nx,Ny:double);
var
  DistRatio : double;
begin
...
procedure ProjectPoint(const Srcx,Srcy,Srcz,Dstx,Dsty,Dstz,Dist:double; out Nx,Ny,Nz:double);
var
  DistRatio : double;
begin
...
procedure ProjectPoint(const Px,Py,Angle,Distance:double; out Nx,Ny:double);
var
  Dx : double;
  Dy : double;
begin
...
procedure ProjectPoint0  (const Px,Py,Distance:double; out Nx,Ny:double);
begin
  Nx := Px + Distance;
  Ny := Py;
end;
...
procedure ProjectPoint45(const Px,Py,Distance:double; out Nx,Ny:double);
begin
...
procedure ProjectPoint90(const Px,Py,Distance:double; out Nx,Ny:double);
begin
  Nx := Px;
  Ny := Py + Distance;
end;
...
procedure ProjectPoint135(const Px,Py,Distance:double; out Nx,Ny:double);
begin
  Nx := Px - 0.70710678118654752440084436210485 * Distance;
  Ny := Py + 0.70710678118654752440084436210485 * Distance;
end;
...
procedure ProjectPoint180(const Px,Py,Distance:double; out Nx,Ny:double);
begin
  Nx := Px - Distance;
  Ny := Py;
end;
...
procedure ProjectPoint225(const Px,Py,Distance:double; out Nx,Ny:double);
begin
  Nx := Px - 0.70710678118654752440084436210485 * Distance;
  Ny := Py - 0.70710678118654752440084436210485 * Distance;
end;
...
procedure ProjectPoint270(const Px,Py,Distance:double; out Nx,Ny:double);
begin
  Nx := Px;
  Ny := Py - Distance;
end;
...
procedure ProjectPoint315(const Px,Py,Distance:double; out Nx,Ny:double);
begin
  Nx := Px + 0.70710678118654752440084436210485 * Distance;
  Ny := Py - 0.70710678118654752440084436210485 * Distance;
end;
...
function ProjectPoint(const SrcPoint,DstPoint:TlicgCoor; const Dist:double):TlicgCoor;
begin
  ProjectPoint(SrcPoint.x,SrcPoint.y,DstPoint.x,DstPoint.y,Dist,Result.x,Result.y);
end;
(* End of Project Point 2D *)

function ProjectPoint(const SrcPoint,DstPoint:TlicgCoor3D; const Dist:double):TlicgCoor3D;
begin
  ProjectPoint(SrcPoint.x,SrcPoint.y,SrcPoint.z,DstPoint.x,DstPoint.y,DstPoint.z,Dist,Result.x,Result.y,Result.z);
end;
(* End of Project Point 3D *)

function ProjectPoint(const Point:TlicgCoor; Angle,Distance:double):TlicgCoor;
begin
  ProjectPoint(Point.x,Point.y,Angle,Distance,Result.x,Result.y);
end;
(* End of Project Point 2D *)

function ProjectPoint0(const Point:TlicgCoor; Distance:double):TlicgCoor;
begin
  ProjectPoint0(Point.x,Point.y,Distance,Result.x,Result.y);
end;
(* End of Project Point 2D *)

function ProjectPoint45(const Point:TlicgCoor; Distance:double):TlicgCoor;
begin
  ProjectPoint45(Point.x,Point.y,Distance,Result.x,Result.y);
end;
(* End of Project Point 2D *)

function ProjectPoint90(const Point:TlicgCoor; Distance:double):TlicgCoor;
begin
  ProjectPoint90(Point.x,Point.y,Distance,Result.x,Result.y);
end;
(* End of Project Point 2D *)

function ProjectPoint135(const Point:TlicgCoor; Distance:double):TlicgCoor;
begin
  ProjectPoint135(Point.x,Point.y,Distance,Result.x,Result.y);
end;
(* End of Project Point 2D *)

function ProjectPoint180(const Point:TlicgCoor; Distance:double):TlicgCoor;
begin
  ProjectPoint180(Point.x,Point.y,Distance,Result.x,Result.y);
end;
(* End of Project Point 2D *)

function ProjectPoint225(const Point:TlicgCoor; Distance:double):TlicgCoor;
begin
  ProjectPoint225(Point.x,Point.y,Distance,Result.x,Result.y);
end;
(* End of Project Point 2D *)

function ProjectPoint270(const Point:TlicgCoor; Distance:double):TlicgCoor;
begin
  ProjectPoint270(Point.x,Point.y,Distance,Result.x,Result.y);
end;
(* End of Project Point 2D *)

function ProjectPoint315(const Point:TlicgCoor; Distance:double):TlicgCoor;
begin
  ProjectPoint315(Point.x,Point.y,Distance,Result.x,Result.y);
end;
(* End of Project Point 2D *)

function ProjectObject(const Point:TlicgCoor; Angle,Distance:double):TlicgCoor;
begin
  Result := ProjectPoint(Point,Angle,Distance);
end;
(* End of Project Object *)

function ProjectObject(const Segment:TSegment2D; Angle,Distance:double):TSegment2D;
begin
...
function ProjectObject(const Triangle:TlicgTriangle; Angle,Distance:double):TlicgTriangle;
begin
...
function ProjectObject(const Quadix:TQuadix2D; Angle,Distance:double):TQuadix2D;
begin
...
function ProjectObject(const Circle:TCircle; Angle,Distance:double):TCircle;
begin
  ProjectPoint(Circle.x,Circle.y,Angle,Distance,Result.x,Result.y);
end;
(* End of Project Object *)

function ProjectObject(const Polygon : TPolygon2D; Angle,Distance:double):TPolygon2D;
var
  i : Integer;
begin
  Setlength(Result,Length(Polygon));
...
function ProjectObject(const GeoObj : TGeometricObject; Angle,Distance:double):TGeometricObject;
begin
...
procedure CalculateBezierCoefficients(const Bezier:TQuadraticBezier2D; out ax,bx,ay,by:double);
begin
...
procedure CalculateBezierCoefficients(const Bezier:TQuadraticBezier3D; out ax,bx,ay,by,az,bz:double);
begin
  bx := 2.0 * (Bezier[1].x - Bezier[0].x);
  by := 2.0 * (Bezier[1].y - Bezier[0].y);
...
procedure CalculateBezierCoefficients(const Bezier:TCubicBezier2D; out ax,bx,cx,ay,by,cy:double);
begin
...
procedure CalculateBezierCoefficients(const Bezier:TCubicBezier3D; out ax,bx,cx,ay,by,cy,az,bz,cz:double);
begin
  cx := 3.0 * (Bezier[1].x - Bezier[0].x);
  cy := 3.0 * (Bezier[1].y - Bezier[0].y);
...
function PointOnBezier(const StartPoint:TlicgCoor; const ax,bx,ay,by,T:double):TlicgCoor;
var
  tSqr  : double;
begin
  tSqr     := t * t;
...
function PointOnBezier(const StartPoint:TlicgCoor3D; const ax,bx,ay,by,az,bz,T:double):TlicgCoor3D;
var
  tSqr  : double;
begin
  tSqr     := t * t;
...
function PointOnBezier(const StartPoint:TlicgCoor; const ax,bx,cx,ay,by,cy,T:double):TlicgCoor;
var
  tSqr  : double;
  tCube : double;
begin
...
function PointOnBezier(const StartPoint:TlicgCoor3D; const ax,bx,cx,ay,by,cy,az,bz,cz,T:double):TlicgCoor3D;
var
  tSqr  : double;
  tCube : double;
begin
...
function CreateBezier(const Bezier:TQuadraticBezier2D; const PointCount:Integer) : TlicgCoorArray;
var
  ax : double;
  ay : double;
  bx : double;
...
function CreateBezier(const Bezier:TQuadraticBezier3D; const PointCount:Integer) : TlicgCoorArray3D;
var
  ax : double;
  ay : double;
  az : double;
...
function CreateBezier(const Bezier:TCubicBezier2D; const PointCount:Integer) : TlicgCoorArray;
var
  ax : double;
  bx : double;
  cx : double;
...
function CreateBezier(const Bezier:TCubicBezier3D; const PointCount:Integer) : TlicgCoorArray3D;
var
  ax : double;
  bx : double;
  cx : double;
...
function CurveLength(const Bezier:TQuadraticBezier2D; const PointCount:Integer):double;
var
   i     : Integer;
   Curve : TlicgCoorArray;
begin
  Result := 0;
...
function CurveLength(const Bezier:TQuadraticBezier3D; const PointCount:Integer):double;
var
   i     : Integer;
   Curve : TlicgCoorArray3D;
begin
  Result := 0;
  Curve  := CreateBezier(Bezier,PointCount);
  for i := 0 To Length(Curve) - 2 do
...
function CurveLength(const Bezier:TCubicBezier2D; const PointCount:Integer):double;
var
   i     : Integer;
   Curve : TlicgCoorArray;
begin
...
function CurveLength(const Bezier:TCubicBezier3D; const PointCount:Integer):double;
var
   i     : Integer;
   Curve : TlicgCoorArray3D;
begin
...
procedure ShortenSegment(const Amount:double; out x1,y1,x2,y2:double);
var
...
procedure ShortenSegment(const Amount:double; out x1,y1,z1,x2,y2,z2:double);
var
  SegmentLength : double;
  DistRatio     : double;
  Dx            : double;
...
function ShortenSegment(const Segment:TSegment2D; const Amount : double):TSegment2D;
begin
  Result := Segment;
...
function ShortenSegment(const Segment:TSegment3D; const Amount : double):TSegment3D;
begin
  Result := Segment;
...
procedure LengthenSegment(const Amount:double; out x1,y1,x2,y2:double);
var
  SegmentLength : double;
  DistRatio     : double;
  Dx            : double;
...
procedure LengthenSegment(const Amount:double; out x1,y1,z1,x2,y2,z2:double);
var
  SegmentLength : double;
  DistRatio     : double;
  Dx            : double;
...
function LengthenSegment(const Segment:TSegment2D; const Amount:double):TSegment2D;
begin
  Result := Segment;
...
function LengthenSegment(const Segment:TSegment3D; const Amount:double):TSegment3D;
begin
  Result := Segment;
...
function EquatePoint(const x,y:double):TlicgCoor;
begin
  Result.x := x;
  Result.y := y;
end;
...
function EquatePoint(const x,y,z:double):TlicgCoor3D;
begin
  Result.x := x;
  Result.y := y;
  Result.z := z;
...
function EquatePointPtr(const x,y:double):TlicgCoorPtr;
begin
  New(Result);
...
function EquatePointPtr(const x,y,z:double):TlicgCoor3DPtr;
begin
  New(Result);
...
procedure EquatePoint(const x,y:double; out Point:TlicgCoor);
begin
  Point.x := x;
  Point.y := y;
end;
...
procedure EquatePoint(const x,y,z:double; out Point:TlicgCoor3D);
begin
  Point.x := x;
  Point.y := y;
  Point.z := z;
...
procedure EquatePointPtr(const x,y:double; out Point:TlicgCoorPtr);
begin
 Point := EquatePointPtr(x,y);
end;
(* End of Equate Point *)

procedure EquatePointPtr(const x,y,z:double; out Point:TlicgCoor3DPtr);
begin
 Point := EquatePointPtr(x,y,z);
end;
(* End of Equate Point *)

function EquateCurvePoint(x,y,t:double):TCurvePoint2D;
begin
  Result.x := x;
  Result.y := y;
  Result.t := t;
...
function EquateCurvePoint(x,y,z,t:double):TCurvePoint3D;
begin
  Result.x := x;
  Result.y := y;
  Result.z := z;
...
function EquateCurvePoint(Point:TlicgCoor; t:double):TCurvePoint2D;
begin
  Result.x := Point.x;
  Result.y := Point.y;
  Result.t := t;
...
function EquateCurvePoint(Point:TlicgCoor3D; t:double):TCurvePoint3D;
begin
  Result.x := Point.x;
  Result.y := Point.y;
  Result.z := Point.z;
...
function EquateSegment(const Point1,Point2:TlicgCoor):TSegment2D;
begin
  Result := EquateSegment(Point1.x,Point1.y,Point2.x,Point2.y);
end;
(* End of Equate Segment *)

function EquateSegment(const Point1,Point2:TlicgCoor3D):TSegment3D;
begin
...
procedure EquateSegment(const x1,y1,x2,y2:double; out Segment:TSegment2D);
begin
  Segment[1].x := x1;
  Segment[1].y := y1;
  Segment[2].x := x2;
...
procedure EquateSegment(const x1,y1,z1,x2,y2,z2:double; out Segment:TSegment3D);
begin
  Segment[1].x := x1;
  Segment[1].y := y1;
  Segment[1].z := z1;
...
function EquateLine(const x1,y1,x2,y2:double):TlicgLine;
begin
  Result[1].x := x1;
  Result[1].y := y1;
  Result[2].x := x2;
...
function EquateLine(const x1,y1,z1,x2,y2,z2:double):TlicgLine3D;
begin
  Result[1].x := x1;
  Result[1].y := y1;
  Result[1].z := z1;
...
function EquateLine(const Point1,Point2:TlicgCoor):TlicgLine;
begin
  Result := EquateLine(Point1.x,Point1.y,Point2.x,Point2.y);
end;
(* End of Equate Segment *)

function EquateLine(const Point1,Point2:TlicgCoor3D):TlicgLine3D;
begin
  Result := EquateLine(Point1.x,Point1.y,Point1.z,Point1.x,Point2.y,Point2.z);
end;
(* End of Equate Segment *)

procedure EquateLine(const x1,y1,x2,y2:double; out Line:TlicgLine);
begin
  Line[1].x := x1;
  Line[1].y := y1;
  Line[2].x := x2;
...
procedure EquateLine(const x1,y1,z1,x2,y2,z2:double; out Line:TlicgLine3D);
begin
  Line[1].x := x1;
  Line[1].y := y1;
  Line[1].z := z1;
...
function EquateQuadix(const Point1,Point2,Point3,Point4:TlicgCoor):TQuadix2D;
begin
  Result := EquateQuadix(
                         Point1.x,Point1.y,
                         Point2.x,Point2.y,
...
function EquateQuadix(const Point1,Point2,Point3,Point4:TlicgCoor3D):TQuadix3D;
begin
  Result := EquateQuadix(
...
procedure EquateQuadix(const x1,y1,x2,y2,x3,y3,x4,y4:double; out Quadix:TQuadix2D);
begin
  Quadix[1].x := x1;
  Quadix[1].y := y1;
  Quadix[2].x := x2;
...
procedure EquateQuadix(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4:double; out Quadix:TQuadix3D);
begin
  Quadix[1].x := x1;
  Quadix[1].y := y1;
  Quadix[1].z := z1;
...
function EquateRectangle(const Point1,Point2:TlicgCoor):TRectangle;
begin
  Result := EquateRectangle(Point1.x,Point1.y,Point2.x,Point2.y);
end;
(* End of Equate Rectangle *)

procedure EquateRectangle(const x1,y1,x2,y2:double; out Rect:TRectangle);
begin
  if x1 <= x2 then
  begin
    Rect[1].x := x1;
...
procedure EquateRectangle(const Point1,Point2:TlicgCoor; out Rect:TRectangle);
begin
  EquateRectangle(Point1.x,Point1.y,Point2.x,Point2.y,Rect);
end;
(* End of Equate Rectangle *)

function EquateTriangle(const x1,y1,x2,y2,x3,y3:double):TlicgTriangle;
begin
  Result[1].x := x1;
  Result[1].y := y1;
  Result[2].x := x2;
...
function EquateTriangle(const x1,y1,z1,x2,y2,z2,x3,y3,z3:double):TlicgTriangle3D;
begin
  Result[1].x := x1;
  Result[2].x := x2;
  Result[3].x := x3;
...
(* End of Equate Triangle *)
function EquateTriangle(const Point1,Point2,Point3: TlicgCoor):TlicgTriangle;
begin
  Result[1] := Point1;
  Result[2] := Point2;
  Result[3] := Point3;
...
function EquateTriangle(const Point1,Point2,Point3: TlicgCoor3D):TlicgTriangle3D;
begin
 Result[1] := Point1;
 Result[2] := Point2;
 Result[3] := Point3;
...
procedure EquateTriangle(const x1,y1,x2,y2,x3,y3:double; out Triangle:TlicgTriangle);
begin
 Triangle[1].x := x1;
 Triangle[2].x := x2;
 Triangle[3].x := x3;
...
procedure EquateTriangle(const x1,y1,z1,x2,y2,z2,x3,y3,z3:double; out Triangle:TlicgTriangle3D);
begin
  Triangle[1].x := x1;
  Triangle[2].x := x2;
  Triangle[3].x := x3;
...
procedure EquateTriangle(const Point1,Point2,Point3:TlicgCoor; out Triangle:TlicgTriangle);
begin
  Triangle[1] := Point1;
  Triangle[2] := Point2;
  Triangle[3] := Point3;
...
procedure EquateTriangle(const Point1,Point2,Point3:TlicgCoor3D; out Triangle:TlicgTriangle3D);
begin
  Triangle[1] := Point1;
  Triangle[2] := Point2;
  Triangle[3] := Point3;
...
function EquateCircle(const Point:TlicgCoor; Radius:double):TCircle;
begin
  Result := EquateCircle(Point.x,Point.y,Radius);
end;
(* End of Equate Circle *)

procedure EquateCircle(const x,y,r:double; out Circle:TCircle);
begin
  Circle.x      := x;
  Circle.y      := y;
  Circle.Radius := r;
...
procedure EquateSphere(const x,y,z,r:double; out Sphere:TSphere);
begin
  Sphere.x      := x;
  Sphere.y      := y;
  Sphere.z      := z;
...
function EquatePlane(const Point1,Point2,Point3:TlicgCoor3D):TPlane2D;
begin
  Result := EquatePlane(Point1.x,Point1.y,Point1.z,Point2.x,Point2.y,Point2.z,Point3.x,Point3.y,Point3.z);
end;
(* End of Equate Plane *)

procedure EquatePlane(const x1,y1,z1,x2,y2,z2,x3,y3,z3:double; out Plane:TPlane2D);
begin
  Plane := EquatePlane(x1,y1,z1,x2,y2,z2,x3,y3,z3);
end;
(* End of Equate Plane *)

procedure EquatePlane(const Point1,Point2,Point3:TlicgCoor3D; out Plane:TPlane2D);
begin
  EquatePlane(Point1.x,Point1.y,Point1.z,Point2.x,Point2.y,Point2.z,Point3.x,Point3.y,Point3.z,Plane);
end;
(* End of Equate Plane *)

procedure EquateBezier(const x1,y1,x2,y2,x3,y3:double; out Bezier:TQuadraticBezier2D);
begin
  Bezier[0].x := x1;
  Bezier[0].y := y1;
  Bezier[1].x := x2;
...
procedure EquateBezier(const x1,y1,z1,x2,y2,z2,x3,y3,z3:double; out Bezier:TQuadraticBezier3D);
begin
  Bezier[0].x := x1;
  Bezier[0].y := y1;
  Bezier[0].z := z1;
...
function EquateBezier(const Pnt1,Pnt2,Pnt3:TlicgCoor):TQuadraticBezier2D;
begin
  Result[0] := Pnt1;
  Result[1] := Pnt2;
  Result[2] := Pnt3;
...
function EquateBezier(const Pnt1,Pnt2,Pnt3:TlicgCoor3D):TQuadraticBezier3D;
begin
  Result[0] := Pnt1;
  Result[1] := Pnt2;
  Result[2] := Pnt3;
...
procedure EquateBezier(const x1,y1,x2,y2,x3,y3,x4,y4:double; out Bezier:TCubicBezier2D);
begin
  Bezier[0].x := x1;
  Bezier[0].y := y1;
  Bezier[1].x := x2;
...
procedure EquateBezier(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4:double; out Bezier:TCubicBezier3D);
begin
  Bezier[0].x := x1;
  Bezier[0].y := y1;
  Bezier[0].z := z1;
...
function EquateBezier(const Pnt1,Pnt2,Pnt3,Pnt4:TlicgCoor):TCubicBezier2D;
begin
  Result[0] := Pnt1;
  Result[1] := Pnt2;
  Result[2] := Pnt3;
...
function EquateBezier(const Pnt1,Pnt2,Pnt3,Pnt4:TlicgCoor3D):TCubicBezier3D;
begin
  Result[0] := Pnt1;
  Result[1] := Pnt2;
  Result[2] := Pnt3;
...
function RectangleToQuadix(x1,y1,x2,y2:double):TQuadix2D;
begin
...
function RectangleToQuadix(Point1,Point2:TlicgCoor):TQuadix2D;
begin
...
function TriangleToPolygon(x1,y1,x2,y2,x3,y3:double):TPolygon2D;
begin
  SetLength(Result,3);
...
function TriangleToPolygon(Triangle:TlicgTriangle):TPolygon2D;
begin
...
function QuadixToPolygon(x1,y1,x2,y2,x3,y3,x4,y4:double):TPolygon2D;
begin
  SetLength(Result,4);
  Result[0] := EquatePoint(x1,y1);
  Result[1] := EquatePoint(x2,y2);
...
function CircleToPolygon(const Cx,Cy,Radius:double; const PointCount:Integer):TPolygon2D;
var
  i     : Integer;
  Angle : double;
begin
...
procedure SetGeometricObject(const Primitive:TlicgCoor; out GeoObj:TGeometricObject);
begin
...
procedure SetGeometricObject(const Primitive:TlicgCoor3D; out GeoObj:TGeometricObject);
begin
...
procedure SetGeometricObject(const Primitive:TlicgLine; out GeoObj:TGeometricObject);
begin
...
procedure SetGeometricObject(const Primitive:TlicgLine3D; out GeoObj:TGeometricObject);
begin
...
procedure SetGeometricObject(const Primitive:TlicgTriangle; out GeoObj:TGeometricObject);
begin
...
procedure SetGeometricObject(const Primitive:TlicgTriangle3D; out GeoObj:TGeometricObject);
begin
...
function GenerateRandomValue(Range : double; Resolution : double = 10000000.0) : double;
begin
...
procedure GenerateRandomPoints(const Bx1,By1,Bx2,By2:double; var PointList: array of TlicgCoor);
var
  i  : Integer;
  Dx : double;
  Dy : double;
...
(* End of Generate Random Geometry.Points *)

procedure GenerateRandomPoints(const Rectangle:TRectangle; var PointList: array of TlicgCoor);
begin
  GenerateRandomPoints(Rectangle[1].x,Rectangle[1].y,Rectangle[2].x,Rectangle[2].y,PointList);
end;
(* End of Generate Random Geometry.Points *)

procedure GenerateRandomPoints(const Segment:TSegment2D; var PointList:array of TlicgCoor);
var
  i     : Integer;
  Dist  : double;
  Ratio : double;
...
procedure GenerateRandomPoints(const Segment:TSegment3D; var PointList:array of TlicgCoor3D);
var
  i     : Integer;
  Dist  : double;
  Ratio : double;
...
procedure GenerateRandomPoints(const Triangle:TlicgTriangle; var PointList:array of TlicgCoor);
var
  a : double;
  b : double;
  c : double;
...
procedure GenerateRandomPoints(const Circle:TCircle; var PointList:array of TlicgCoor);
var
  i           : Integer;
  RandomAngle : double;
  CPoint      : TlicgCoor;
...
procedure GenerateRandomPoints(const Quadix:TQuadix2D; var PointList : array of TlicgCoor);
...
var
  i            : Integer;
  Triangle     : TlicgTriangle;
  Quadix       : TQuadix2D;
  QRndPoint    : array of TlicgCoor;
  TRndPoint    : array of TlicgCoor;
  QRndPntCnt   : Integer;
  TRndPntCnt   : Integer;
begin
...
(* End of Generate Random Geometry.Points On Convex Pentagon *)
...
var
  ...
  Quadix1     : TQuadix2D;
  Quadix2     : TQuadix2D;
  Q1RndPoint  : array of TlicgCoor;
  Q2RndPoint  : array of TlicgCoor;
  Q1RndPntCnt : Integer;
  Q2RndPntCnt : Integer;
begin
...
(* End of Generate Random Geometry.Points On Convex Hexagon *)
...
(* End of Generate Random Geometry.Points On Convex Heptagon *)
...
(* End of Generate Random Geometry.Points On Convex Octagon *)
...
function Scale(const Vec:TVector2DArray; const Factor:double):TVector2DArray;
var
  i : Integer;
begin
...
function Scale(const Vec:TVector3DArray; const Factor:double):TVector3DArray;
var
  i : Integer;
begin
  SetLength(Result,Length(Vec));
...
function IsEqual(const Point1,Point2:TlicgCoor; const Epsilon:double):Boolean;
begin
  Result := (IsEqual(Point1.x,Point2.x,Epsilon) and IsEqual(Point1.y,Point2.y,Epsilon));
end;
(* End of Is Equal *)

function IsEqual(const Point1,Point2:TlicgCoor3D; const Epsilon:double):Boolean;
begin
  Result := (IsEqual(Point1.x,Point2.x,Epsilon) and IsEqual(Point1.y,Point2.y,Epsilon) and IsEqual(Point1.z,Point2.z,Epsilon));
end;
function IsEqual(const Point1,Point2:TlicgCoor4D; const Epsilon:double):Boolean;                                                  overload;
begin
  Result := ( IsEqual(Point1.x,Point2.x,Epsilon) and
              IsEqual(Point1.y,Point2.y,Epsilon) and
              IsEqual(Point1.z,Point2.z,Epsilon) and
              IsEqual(Point1.N,Point2.N,Epsilon));
end;
function IsEqual(const Val1,Val2:double):Boolean;
begin
  Result := IsEqual( Val1, Val2, FastGeoEpsilon );
end;

function IsEqual(const Point1,Point2:TlicgCoor):Boolean;
begin
  Result := (IsEqual( Point1.x, Point2.x, FastGeoEpsilon ) and IsEqual( Point1.y, Point2.y, FastGeoEpsilon ));
end;

function IsEqual(const Point1,Point2:TlicgCoor3D):Boolean;
begin
  Result := (IsEqual(Point1.x,Point2.x, FastGeoEpsilon) and IsEqual(Point1.y,Point2.y,FastGeoEpsilon) and IsEqual(Point1.z,Point2.z,FastGeoEpsilon));
end;
...
function NotEqual(const Point1,Point2:TlicgCoor; const Epsilon:double):Boolean;
begin
  Result := (NotEqual(Point1.x,Point2.x,Epsilon) or NotEqual(Point1.y,Point2.y,Epsilon));
end;
(* End of not Equal *)

function NotEqual(const Point1,Point2:TlicgCoor3D; const Epsilon:double):Boolean;
begin
...
begin
  Result := NotEqual(Val1,Val2,FastGeoEpsilon);
end;
(* End of not Equal *)

function NotEqual(const Point1,Point2:TlicgCoor):Boolean;
begin
  Result := (NotEqual(Point1.x,Point2.x,FastGeoEpsilon) or NotEqual(Point1.y,Point2.y,FastGeoEpsilon));
end;
(* End of not Equal *)

function NotEqual(const Point1,Point2:TlicgCoor3D):Boolean;
begin
  Result := (NotEqual(Point1.x,Point2.x,FastGeoEpsilon) or NotEqual(Point1.y,Point2.y,FastGeoEpsilon) or NotEqual(Point1.z,Point2.z,FastGeoEpsilon));
end;
(* End of not Equal *)
...
begin
  Result := IsEqualZero(Val,FastGeoEpsilon);
end;
(* End of IsEqualZero *)

function IsDegenerate(const x1,y1,x2,y2:double):Boolean;
begin
...
function IsDegenerate(const Line:TlicgLine):Boolean;
begin
  Result := IsDegenerate(Line[1].x,Line[1].y,Line[2].x,Line[2].y);
end;
(* End of IsDegenerate *)

function IsDegenerate(const x1,y1,z1,x2,y2,z2:double):Boolean;
begin
...
function IsDegenerate(const Line:TlicgLine3D):Boolean;
begin
  Result := IsDegenerate(Line[1].x,Line[1].y,Line[1].z,Line[2].x,Line[2].y,Line[2].z);
end;
(* End of IsDegenerate *)

function IsDegenerate(const Triangle:TlicgTriangle):Boolean;
begin
...
function IsDegenerate(const Triangle:TlicgTriangle3D):Boolean;
begin
  Result := Collinear(Triangle[1],Triangle[2],Triangle[3]) or
            (IsEqual(Triangle[1],Triangle[2]))             or
            (IsEqual(Triangle[1],Triangle[3]))             or
...
begin
  Result :=
           (* Stage 1 unique Geometry.Points check *)
...
begin
  with Arc do
    Result := IsDegenerate(x1,y1,x2,y2)                                    or
              ...
              (Lider.CG.Com.FastGEO.Orientation (x1,y1,x2,y2,Px,Py) <> Arc.Orientation);
end;
(* End of IsDegenerate *)
...
procedure Swap(var val1,val2:double);
var
  Temp : double;
begin
  Temp := Val1;
...
procedure Swap(var Point1,Point2:TlicgCoor);
begin
...
procedure Swap(var Point1,Point2:TlicgCoor3D);
begin
  Swap(Point1.x,Point2.x);
  Swap(Point1.y,Point2.y);
...
procedure Swap(var Line1,Line2:TlicgLine);
begin
...
procedure Swap(var Triangle1,Triangle2:TlicgTriangle);
begin
...
procedure Swap(var Triangle1,Triangle2:TlicgTriangle3D);
begin
  Swap(Triangle1[1],Triangle2[1]);
  Swap(Triangle1[2],Triangle2[2]);
  Swap(Triangle1[3],Triangle2[3]);
...
function ExtendedFloatingPointTest:Boolean;
  (*
    Yet to be completed! **************************
  *)
  function RotationTest(RadiusLength : double) : Boolean;
  const delta_angle = 0.036;
  var
  InitialPoint : TlicgCoor;
  Point        : TlicgCoor;
  TempPoint    : TlicgCoor;
  i            : Integer;
  begin
...
function ExecuteTests : TNumericPrecisionResult;
begin
  Result.EEResult      := LessThanOrEqual(SystemEpsilon,FastGeoEpsilon);
