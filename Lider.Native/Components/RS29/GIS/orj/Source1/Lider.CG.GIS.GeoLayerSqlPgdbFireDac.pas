...
//=============================================================================
{
  Encapsulation of ESRI Personal Geodatabase SQL Layer - FireDac access.
}

{$IFDEF DCC}
  unit Lider.CG.GIS.GeoLayerSqlPgdbFireDac ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoLayerSqlPgdbFireDac"'}
{$ENDIF}
{$IFDEF CLR}
...
{$IFDEF GIS_NODB}
  {$Message Warn 'Unit Lider.CG.GIS.GeoLayerSqlOgisFireDac not supported - no DB support' }
  interface
  implementation

uses Lider.CG.GIS.GeoFunctions;
{$ELSE}
...
type
  ...
  /// <summary>
  ///   Layer that can read ESRI Personal Geodatabase SQL layer via FireDac.
  /// </summary>
  TGIS_LayerSqlPgdbFireDac = class( TGIS_LayerSqlPgdbAbstract )
    private
      /// <summary>
...
//=============================================================================
// TGIS_LayerSqlPgdbFireDac
//=============================================================================

  constructor TGIS_LayerSqlPgdbFireDac.Create ;
  begin
    inherited ;
  ...
  destructor TGIS_LayerSqlPgdbFireDac.Destroy ;
  begin
    FreeObject( oGisDb ) ;
  ...
  procedure TGIS_LayerSqlPgdbFireDac.fset_SharedConnection(
  ...
  function TGIS_LayerSqlPgdbFireDac.fget_SharedConnection : TFDConnection;
  begin
    Result := TGIS_DbFireDac( oGisDb ).SharedConnection ;
  end ;

  procedure TGIS_LayerSqlPgdbFireDac.sqlQueryGetGeometry(
    const _uid    : TGIS_Uid ;
    const _type   : TGIS_ShapeType ;
    const _cursor : Integer
  ) ;
  ...
  function TGIS_LayerSqlPgdbFireDac.sqlQueryNameGEOUID(
    const _cursor : Integer
  ) : String ;
  begin
    if fixGEOUID < 0 then
  ...
  function TGIS_LayerSqlPgdbFireDac.sqlQueryGetGEOUID(
    const _cursor : Integer
  ) : OleVariant ;
  begin
  ...
  procedure TGIS_LayerSqlPgdbFireDac.sqlTableAppend(
    const _id    : Integer ;
    const _table : String  ;
    const _type  : TGIS_ShapeType
  ) ;
  ...
  procedure TGIS_LayerSqlPgdbFireDac.sqlTableOpenWrite(
    const _id     : Integer ;
    const _table  : String  ;
    const _uidCol : String ;
    const _uidVal : TGIS_Uid
  ...
  procedure TGIS_LayerSqlPgdbFireDac.sqlTableSetGeometry(
    const _id   : Integer ;
    const _name : String  ;
    const _shp  : TGIS_Shape
  ) ;
  ...
  procedure TGIS_LayerSqlPgdbFireDac.macroUpdateStart ;
  begin
  ...
  function  TGIS_LayerSqlPgdbFireDac.bindFieldInternal(
    const _field  : string ;
    const _cursor : Integer
  ) : Integer ;
  begin
  ...
  function TGIS_LayerSqlPgdbFireDac.getBindedFieldInternal(
  ...
  function TGIS_LayerSqlPgdbFireDac.PreRecognize(
    const _path     : String ;
      var _new_path : String
   ) : Boolean ;
  begin
...
initialization
  RegisterLayer( 'DK-TTKLS', GIS_SQL_LAYER_CONNECTOR, TGIS_LayerSqlPgdbFireDac,
