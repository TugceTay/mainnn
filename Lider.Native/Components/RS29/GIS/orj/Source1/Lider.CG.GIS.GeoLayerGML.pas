...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoLayerGML ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoLayerGML"'}
{$ENDIF}
{$IFDEF CLR}
...
const
   ...
   // Prefixex
    ...
    GML_XMLNS_GML_G_WWW = 'https://www.lideryazilim.com/GML' ; // ilker deðiþtirme
    ...
    GML_XMLNS_SCHEMA_L  = 'http://www.opengis.net/gml'+
                          ' feature.xsd https://www.lideryazilim.com/GML ' ; // ilker deðiþtirme
    GML_TATUKGIS_MAP    = 'LicadGIS';
 ...
 function TGIS_LayerGML.lastPathElement : String ;
  ...
  begin
    if ( _name = GML_MULTI_POINT ) then begin
      ...
      if not addingMLine and not addingMCurve and not addingCCurve then begin
          addingLine := True;
          addLine;
      end
      else if not addingCCurve  then
        addShapePart;
    end
  ...
  const
    schemaDef =
     ...
     '<xsd:schema targetNamespace="https://www.lideryazilim.com/GML"'+
     ' xmlns:g="https://www.lideryazilim.com/GML"'+
     ' xmlns:gml="http://www.opengis.net/gml"'+
     ' xmlns:xsd="http://www.w3.org/2001/XMLSchema" '+
     'elementFormDefault="qualified" version="1.0">'+
     '<xsd:import namespace="http://www.opengis.net/gml" '+
     'schemaLocation="feature.xsd"/>'+
     '<xsd:element name="LicadGIS" type="g:LicadGISType" '+
     'substitutionGroup="gml:_FeatureCollection"/>'+
     '<xsd:element name="PROPERTIES" type="g:PROPERTIESType" '+
     'substitutionGroup="gml:_Feature"/>'+
     '<xsd:complexType name="LicadGISType"><xsd:complexContent>'+
     ...
     '</xsd:extension></xsd:complexContent></xsd:complexType></xsd:schema>'; // ilker deðiþtirme
    attribDef =
