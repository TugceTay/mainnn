...
//=============================================================================
{
  ...
  too large to include in Lider.CG.GIS.GeoLayerVector (to which this unit is actually
  related).
}

{$IFDEF DCC}
  unit Lider.CG.GIS.GeoArcLabel ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoArcLabel"'}
{$ENDIF}
{$IFDEF CLR}
