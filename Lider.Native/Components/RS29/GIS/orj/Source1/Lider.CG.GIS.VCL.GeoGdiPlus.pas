...
unit Lider.CG.GIS.VCL.GeoGdiPlus ;
{$HPPEMIT '#pragma link "Lider.CG.GIS.VCL.GeoGdiPlus"'}
...
//=============================================================================
  ...
  begin
    ...
    GdipCreateBitmapFromScan0( bmp.Width, bmp.Height, 4 * bmp.Width,
                               PixelFormat32bppARGB, PBYTE(scan0), img ) ;
    //GdipCreateBitmapFromHBITMAP( bmp.Handle, 0, img ) ;
  ...
  begin
    ...
    GdipCreateBitmapFromScan0( bmp.Width, bmp.Height, 4 * bmp.Width,
                               PixelFormat32bppPARGB, PBYTE(scan0), bitmap ) ;
    nativeImage := bitmap ;
  end ;
