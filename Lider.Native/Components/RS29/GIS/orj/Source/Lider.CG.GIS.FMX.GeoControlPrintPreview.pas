...
unit FMX.GisControlPrintPreview ;
{$HPPEMIT '#pragma link "FMX.GisControlPrintPreview"'}
...
type
  ...
  TGIS_ControlPrintPreview = class( TRectangle, IGIS_Subscribe )
...
{$R FMX.GisControlPrintPreview_16x16.RES}
