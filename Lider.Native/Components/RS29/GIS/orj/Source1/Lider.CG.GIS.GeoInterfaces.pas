...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoInterfaces ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoInterfaces"'}
{$ENDIF}
{$IFDEF CLR}
...
type
  ...
  IGIS_Editor = {$IFDEF OXYGENE} public {$ENDIF} interface
    ...
    {$REGION IGIS_Editor public methods}
      ...
      /// </summary>
      /// <param name="_pos">
      ///   where point must be inserted; points are counted from 1
      /// </param>
      /// <param name="_ptg">
  ...
  IGIS_Viewer = {$IFDEF OXYGENE} public {$ENDIF} interface( IInterface )
    ...
    {$REGION IGIS_Viewer public methods}
      ...
      /// </param>
      /// <returns>
      ///   Layer itself or nil if not found.
      /// </returns>
