...
unit FMX.GisPvl;
{$HPPEMIT '#pragma link "FMX.GisPvl"'}
...
type
  ...
  TGIS_PvlControlFmx = class;
  TGIS_PvlContextFmx = class;

  {#gendoc:hide}
  // component to be addes a proxe to a form to allow automatic disposal
  TGIS_PvlComponentFmx = class( TComponent )
    public
      constructor Create  (       _owner   : TComponent
                          ); override ;
      destructor  Destroy ;  override ;
    public
      procedure   Add     ( const _control : TGIS_PvlControlFmx
                          ) ;
      procedure   Remove  ( const _control : TGIS_PvlControlFmx
                          ) ;

    private
      oOwner      : TGIS_PvlContextFmx ;
      oMaster     : TGIS_PvlContext;
      lstControls : TObjectList<TGIS_PvlControlFmx> ;
  end;

  {#gendoc:hide}
  TGIS_PvlContextFmx = class( TGIS_PvlContextBase, IGIS_PvlContext )
    protected
      oMaster                           : TGIS_PvlContext;
      oParent                           : TObject;
      iHMargin                          : Integer;
      iVMargin                          : Integer;
      bBiDi                             : Boolean;
      oOwner                            : TGIS_PvlComponentFmx;
                                                 // component to be owned by
  ...
  {#gendoc:hide}
  TGIS_PvlObjectFmx = class( TGIS_PvlBaseFmx, IGIS_PvlObject )
    public
      constructor Create          ( const _context    : TGIS_PvlContext;
                                    const _parent     : IGIS_PvlBase
                                  );
  ...
  {#gendoc:hide}
  TGIS_PvlControlFmx = class( TGIS_PvlBaseFmx, IGIS_PvlControl )
    public
      constructor Create          ( const _context    : TGIS_PvlContext;
                                    const _parent     : IGIS_PvlBase
                                  );
    ...
    private
      ...
      FOnDblClick                   : TGIS_PvlEvent;
      FOnMouseDown                  : TGIS_PvlMouseEvent;
      FOnMouseMove                  : TGIS_PvlMouseMoveEvent;
      FOnMouseUp                    : TGIS_PvlMouseEvent;
      FOnMouseWheel                 : TGIS_PvlMouseWheelEvent;
      FOnMouseEnter                 : TGIS_PvlEvent;
      FOnMouseLeave                 : TGIS_PvlEvent;

    protected
      procedure doOnClick           (       _sender     : TObject
                                    ); virtual;
      procedure doOnDblClick        (       _sender     : TObject
                                    ); virtual;
      ...
      procedure doOnMouseMove       (       _sender     : TObject       ;
                                            _shift      : TShiftState   ;
                                            _x          : Single        ;
                                            _y          : Single
                                    ); virtual;
      procedure doOnMouseUp         (       _sender     : TObject       ;
                                            _button     : TMouseButton  ;
                                            _shift      : TShiftState   ;
                                            _x          : Single        ;
                                            _y          : Single
                                    ); virtual;
      procedure doOnMouseWheel      (       _sender     : TObject       ;
                                            _shift      : TShiftState   ;
                                            _delta      : Integer       ;
                                      var   _handled    : Boolean
                                    ); virtual;
      procedure doOnMouseEnter      (       _sender     : TObject
                                    ); virtual;
...
type
  ...
  T_PvlLabel = class( TGIS_PvlControlFmx, IGIS_PvlLabel )
    protected
      /// <inheritdoc"/>
      procedure doCreate          ( const _context    : TGIS_PvlContext
                                  );
  ...
  T_PvlIconButton = class ( TGIS_PvlControlFmx, IGIS_PvlIconButton )
    private
      icon_bitmap                 : TBitmap ;
    protected
      /// <inheritdoc"/>
  ...
  T_PvlButton = class( TGIS_PvlControlFmx, IGIS_PvlButton )
    protected
      /// <inheritdoc"/>
      procedure doCreate          ( const _context    : TGIS_PvlContext
                                  );
  ...
  T_PvlModalButton = class( TGIS_PvlControlFmx, IGIS_PvlModalButton )
    protected
      /// <inheritdoc"/>
      procedure doCreate          ( const _context    : TGIS_PvlContext
                                  );
  ...
  T_PvlEdit = class( TGIS_PvlControlFmx, IGIS_PvlEdit )
    protected
      /// <inheritdoc"/>
      procedure doCreate          ( const _context    : TGIS_PvlContext
                                  );
  ...
  T_PvlMemo = class( TGIS_PvlControlFmx, IGIS_PvlMemo )
    protected
      /// <inheritdoc"/>
      procedure doCreate          ( const _context    : TGIS_PvlContext
                                  );
  ...
  T_PvlColorPreview = class ( TGIS_PvlControlFmx, IGIS_PvlColorPreview )
    protected
      /// <inheritdoc"/>
      procedure doCreate          ( const _context    : TGIS_PvlContext
                                  );
  ...
  T_PvlColorWheel = class( TGIS_PvlControlFmx, IGIS_PvlColorWheel )
    private
      vScaleFactor                : Single ;
    protected
      /// <inheritdoc"/>
  ...
  T_PvlColorBar = class( TGIS_PvlControlFmx, IGIS_PvlColorBar )
    private
      vScaleFactor                : Single ;
    protected
      /// <inheritdoc"/>
  ...
  T_PvlCustomComboBox = class( TGIS_PvlControlFmx, IGIS_PvlCustomComboBox )
  ...
  T_PvlColorRampComboBox = class ( TGIS_PvlControlFmx, IGIS_PvlColorRampComboBox )
    protected
      /// <inheritdoc"/>
      procedure doCreate          ( const _context    : TGIS_PvlContext
                                  );
  ...
  T_PvlComboBox = class( TGIS_PvlControlFmx, IGIS_PvlComboBox )
    private
      bSorted                     : Boolean ;
      FFont                       : TFont ;
    protected
    ...
    private
      procedure doOnChange        (       _sender     : TObject
                                  ...
                                  virtual;
      procedure updateFont        ( const _full       : Boolean
                                  ) ;
    protected
  ...
  T_PvlComboEdit = class ( TGIS_PvlControlFmx, IGIS_PvlComboEdit )
    private
      bSorted                     : Boolean            ;
    protected
      /// <inheritdoc"/>
  ...
  T_PvlSearchBox = class ( TGIS_PvlControlFmx, IGIS_PvlSearchBox )
    private
      FOnKeyPress                 : TGIS_PvlKeyPressEvent    ;
      FOnChange                   : TGIS_PvlEvent;
      oList                       : TListBox ;
      lstItems                    : TStringList ;
      iDropDownCount              : Integer ;
      sSearch                     : String ;
      bDropped                    : Boolean ;
    private
      ...
      procedure doEnter           (       _sender   : TObject
                                  ) ;
      procedure doEditKeyDown     (        _sender    : TObject;
                                    var   _key        : Word;
                                    var   _keyChar    : Char;
                                          _shift      : TShiftState
                                  ) ;
      procedure doEditKeyUp       (        _sender    : TObject;
                                    var   _key        : Word;
                                    var   _keyChar    : Char;
                                          _shift      : TShiftState
                                  ) ;
      procedure doEditClick       (       _sender   : TObject
                                  ) ;
      ...
      procedure doListBoxMouseUp  (       _sender   : TObject   ;
                                          _button   : TMouseButton;
                                          _shift    : TShiftState;
                                          _x        : Single    ;
                                          _y        : Single
  ...
  T_PvlRadioButton = class ( TGIS_PvlControlFmx, IGIS_PvlRadioButton )
    private
      FOnChange                   : TGIS_PvlEvent ;
    public
      /// <inheritdoc"/>
  ...
  T_PvlCheckBox = class ( TGIS_PvlControlFmx, IGIS_PvlCheckBox )
    private
      FOnChange                   : TGIS_PvlEvent ;
    public
      /// <inheritdoc"/>
  ...
  T_PvlPanel = class ( TGIS_PvlControlFmx, IGIS_PvlPanel )
    private
      oScrollBox                  : TScrollBox ;
      bBorder                     : Boolean ;
    protected
      /// <inheritdoc"/>
      procedure doCreate          ( const _context    : TGIS_PvlContext
    ...
    private
      procedure DoApplyStyle      (       _sender     : TObject
                                  );
  end;

  T_PvlCanvas = class( TGIS_PvlControlFmx, IGIS_PvlCanvas )
    private
      FRenderEvent                : TGIS_PvlRendererEvent ;
    protected
      /// <inheritdoc"/>
      procedure doCreate          ( const _context    : TGIS_PvlContext
                                  );
    ...
    private
      procedure doOnPaintExtra    (       _sender   : TObject ;
                                          _renderer : TGIS_RendererAbstract ;
                                          _mode     : TGIS_DrawMode
                                  );
  end;
  T_PvlPreviewPanel = class( TGIS_PvlControlFmx, IGIS_PvlPreviewPanel  )
     protected
      /// <inheritdoc"/>
      procedure doCreate          ( const _context    : TGIS_PvlContext
                                  );
  ...
  T_PvlGroupBox = class ( TGIS_PvlControlFmx, IGIS_PvlGroupBox )
    public
      /// <inheritdoc/>
      procedure doCreate          ( const _context    : TGIS_PvlContext
                                  );
  ...
  T_PvlTrackBar = class( TGIS_PvlControlFmx, IGIS_PvlTrackBar )
    protected
      FOnChange                   : TGIS_PvlEvent;
    protected
      /// <inheritdoc"/>
  ...
  T_PvlTree = class ( TGIS_PvlControlFmx, IGIS_PvlTree )
    protected
  ...
  T_PvlListBox = class( TGIS_PvlControlFmx, IGIS_PvlListBox )
    private
  ...
  T_PvlSVGList = class( TGIS_PvlControlFmx, IGIS_PvlSVGList )
    private
      lstItm      : TGIS_ListOfStrings ;
      FOnChange   : TGIS_PvlEvent ;
     protected
...
var
  i   : Integer ;
  cmp : TGIS_PvlComponentFmx ;
  itm : TGIS_PvlControlFmx ;
begin
  if dScale <> _canvas.Scale then begin
    dScale := _canvas.Scale ;

    for i := 0 to oForm.ComponentCount -1 do begin
      if oForm.Components[i] is TGIS_PvlComponentFmx then begin
        cmp := TGIS_PvlComponentFmx( oForm.Components[i] ) ;

        for itm in cmp.lstControls do
          if not itm.oContext.Refresh then
            // not a a pvl form - direct update
            itm.oContext.UpdatePPI( iPPi, dPPIFix, 1);
          itm.DoRedraw ;
      end;
    end;
  end;
...
{$REGION 'TGIS_PvlComponentFmx'}

constructor TGIS_PvlComponentFmx.Create(
  _owner : TComponent
) ;
begin
  inherited ;
  lstControls := TObjectList<TGIS_PvlControlFmx>.Create ;
  lstControls.OwnsObjects := False ;
end;

destructor TGIS_PvlComponentFmx.Destroy ;
begin
...
procedure TGIS_PvlComponentFmx.Add(
  const _control : TGIS_PvlControlFmx
) ;
begin
  lstControls.Add( _control ) ;
end;

procedure TGIS_PvlComponentFmx.Remove(
  const _control : TGIS_PvlControlFmx
) ;
begin
  lstControls.Remove( _control ) ;
end;

{$ENDREGION 'TGIS_PvlComponentFmx'}

{$REGION 'TGIS_PvlObjectFmx'}
constructor TGIS_PvlObjectFmx.Create(
  const _context : TGIS_PvlContext;
  const _parent  : IGIS_PvlBase
);
begin
...
procedure TGIS_PvlObjectFmx.doCreate(
  const _context: TGIS_PvlContext
) ;
begin
...
procedure TGIS_PvlObjectFmx.doDestroy;
begin
  TGIS_PvlObject( oParent ).Platform := nil ;

  inherited;
end;
{$ENDREGION 'TGIS_PvlObjectFmx'}

{$REGION 'TGIS_PvlControlFmx'}
constructor TGIS_PvlControlFmx.Create(
  const _context : TGIS_PvlContext;
  const _parent  : IGIS_PvlBase
);
begin
  ...
  TGIS_PvlContextFmx( _context.Platform ).oOwner.Add( self );
end;

procedure TGIS_PvlControlFmx.doDestroy;
begin
  inherited;
end;

procedure TGIS_PvlControlFmx.DoRedraw;
begin
  // only for safe inheritance
end;

procedure TGIS_PvlControlFmx.ProcessMessages;
begin
  Application.ProcessMessages ;
end;

procedure TGIS_PvlControlFmx.add(
  const _control: TObject
);
begin
...
procedure TGIS_PvlControlFmx.doOnClick(
        _sender     : TObject
);
begin
...
procedure TGIS_PvlControlFmx.doOnDblClick(
        _sender     : TObject
);
begin
...
procedure TGIS_PvlControlFmx.doOnMouseDown(
        _sender     : TObject       ;
        _button     : TMouseButton  ;
        _shift      : TShiftState   ;
        _x          : Single        ;
...
begin
  if Assigned( FOnMouseDown ) then
    FOnMouseDown( _sender, cMouseButton(_button), cShiftState(_shift), _x, _y ) ;
end;

procedure TGIS_PvlControlFmx.doOnMouseMove(
        _sender     : TObject       ;
        _shift      : TShiftState   ;
        _x          : Single        ;
        _y          : Single
...
begin
  if Assigned( FOnMouseMove ) then
    FOnMouseMove( _sender, cShiftState(_shift), _x, _y ) ;
end;

procedure TGIS_PvlControlFmx.doOnMouseUp(
        _sender     : TObject       ;
        _button     : TMouseButton  ;
        _shift      : TShiftState   ;
        _x          : Single        ;
...
begin
  if Assigned( FOnMouseUp ) then
    FOnMouseUp( _sender, cMouseButton(_button), cShiftState(_shift), _x, _y ) ;
end;

procedure TGIS_PvlControlFmx.doOnMouseWheel(
        _sender     : TObject       ;
        _shift      : TShiftState   ;
        _delta      : Integer       ;
  var   _handled    : Boolean
...
begin
  if Assigned( FOnMouseWheel ) then
    FOnMouseWheel( _sender, cShiftState(_shift), _delta, _handled ) ;
end;

procedure TGIS_PvlControlFmx.doOnMouseEnter(
        _sender     : TObject
) ;
begin
  if Assigned( FOnMouseEnter ) then
    FOnMouseEnter( _sender ) ;
end;

procedure TGIS_PvlControlFmx.doOnMouseLeave(
        _sender     : TObject
) ;
begin
  if Assigned( FOnMouseLeave ) then
    FOnMouseLeave( _sender ) ;
end;

function TGIS_PvlControlFmx.fget_OnClick
  : TGIS_PvlEvent;
begin
  Result := FOnClick;
end;

procedure TGIS_PvlControlFmx.fset_OnClick(
  const _value: TGIS_PvlEvent
);
begin
  FOnClick := _value ;
  if Assigned( _value ) then
    TControl( oControl ).OnClick := doOnClick
  else
    TControl( oControl ).OnClick := nil ;
end;

function TGIS_PvlControlFmx.fget_OnDblClick
  : TGIS_PvlEvent;
begin
  Result := FOnDblClick;
end;

procedure TGIS_PvlControlFmx.fset_OnDblClick(
  const _value : TGIS_PvlEvent
);
begin
  FOnDblClick := _value ;
  if Assigned( _value ) then
    TControl( oControl ).OnDblClick := doOnDblClick
  else
    TControl( oControl ).OnDblClick := nil ;
end;

function TGIS_PvlControlFmx.fget_OnMouseDown
  : TGIS_PvlMouseEvent;
begin
  Result := FOnMouseDown;
end;

procedure TGIS_PvlControlFmx.fset_OnMouseDown(
  const _value : TGIS_PvlMouseEvent
);
begin
  FOnMouseDown := _value ;
  if Assigned( _value ) then
    TControl( oControl ).OnMouseDown := doOnMouseDown
  else
    TControl( oControl ).OnMouseDown := nil ;
end;

function TGIS_PvlControlFmx.fget_OnMouseMove
  : TGIS_PvlMouseMoveEvent;
begin
  Result := FOnMouseMove;
end;

procedure TGIS_PvlControlFmx.fset_OnMouseMove(
  const _value : TGIS_PvlMouseMoveEvent
);
begin
  FOnMouseMove := _value ;
  if Assigned( _value ) then
    TControl( oControl ).OnMouseMove := doOnMouseMove
  else
    TControl( oControl ).OnMouseMove := nil ;
end;

function TGIS_PvlControlFmx.fget_OnMouseUp
  : TGIS_PvlMouseEvent;
begin
  Result := FOnMouseUp;
end;

procedure TGIS_PvlControlFmx.fset_OnMouseUp(
  const _value : TGIS_PvlMouseEvent
);
begin
  FOnMouseUp := _value ;
  if Assigned( _value ) then
    TControl( oControl ).OnMouseUp := doOnMouseUp
  else
    TControl( oControl ).OnMouseUp := nil ;
end;

function TGIS_PvlControlFmx.fget_OnMouseWheel
  : TGIS_PvlMouseWheelEvent;
begin
  Result := FOnMouseWheel;
end;

procedure TGIS_PvlControlFmx.fset_OnMouseWheel(
  const _value : TGIS_PvlMouseWheelEvent
);
begin
  FOnMouseWheel := _value ;
  if Assigned( _value ) then
    TControl( oControl ).OnMouseWheel := doOnMouseWheel
  else
    TControl( oControl ).OnMouseWheel := nil ;
end;

function TGIS_PvlControlFmx.fget_OnMouseEnter
  : TGIS_PvlEvent;
begin
  Result := FOnMouseEnter;
end;

procedure TGIS_PvlControlFmx.fset_OnMouseEnter(
  const _value : TGIS_PvlEvent
);
begin
  FOnMouseEnter := _value ;
  if Assigned( _value ) then
    TControl( oControl ).OnMouseEnter := doOnMouseEnter
  else
    TControl( oControl ).OnMouseEnter := nil ;
end;

function TGIS_PvlControlFmx.fget_OnMouseLeave
  : TGIS_PvlEvent;
begin
  Result := FOnMouseLeave;
end;

procedure TGIS_PvlControlFmx.fset_OnMouseLeave(
  const _value : TGIS_PvlEvent
);
begin
  FOnMouseLeave := _value ;
  if Assigned( _value ) then
    TControl( oControl ).OnMouseLeave := doOnMouseLeave
  else
    TControl( oControl ).OnMouseLeave := nil ;
end;

procedure TGIS_PvlControlFmx.fset_Context(
  const _value: TGIS_PvlContext
) ;
begin
  TGIS_PvlContextFmx( _value.Platform ).oOwner.Add( self );
  TGIS_PvlContextFmx( oContext.Platform ).oOwner.Remove( self );
  oContext := _value ;
  TControl( oControl ).Parent := TFmxObject( _value.NativeParent );
end;

function TGIS_PvlControlFmx.fget_NativeControl
  : TObject;
begin
  Result := oControl;
end;

function TGIS_PvlControlFmx.fget_IsStyled
  : Boolean;
begin
  Result := True;
end;

function  TGIS_PvlControlFmx.fget_Anchors
  : TGIS_PvlAnchors;
begin
  Result := [];
...
procedure TGIS_PvlControlFmx.fset_Anchors(
...
function  TGIS_PvlControlFmx.fget_Align
  : TGIS_PvlAlign;
begin
...
procedure TGIS_PvlControlFmx.fset_Align(
...
function TGIS_PvlControlFmx.fget_Enabled
  : Boolean;
begin
  Result := TControl( oControl ).Enabled;
end;

procedure TGIS_PvlControlFmx.fset_Enabled(
  const _value : Boolean
);
begin
...
function TGIS_PvlControlFmx.fget_Width
  : Integer;
begin
  Result := Round( TControl( oControl ).Width / oContext.PPIFix );
end;

procedure TGIS_PvlControlFmx.fset_Width(
  const _value : Integer
);
begin
...
function TGIS_PvlControlFmx.fget_Height
  : Integer;
begin
  Result := Round( TControl( oControl ).Height / oContext.PPIFix );
end;

procedure TGIS_PvlControlFmx.fset_Height(
  const _value : Integer
);
begin
...
function TGIS_PvlControlFmx.fget_Left
  : Integer;
begin
  Result := Round( TControl( oControl ).Position.X / oContext.PPIFix );
end;

procedure TGIS_PvlControlFmx.fset_Left(
  const _value : Integer
);
begin
...
function TGIS_PvlControlFmx.fget_Top
  : Integer;
begin
  Result := Round( TControl( oControl ).Position.Y / oContext.PPIFix );
end;

procedure TGIS_PvlControlFmx.fset_Top(
  const _value : Integer
);
begin
...
function TGIS_PvlControlFmx.fget_TabOrder
  : Integer;
begin
  Result := 0;
end;

procedure TGIS_PvlControlFmx.fset_TabOrder(
  const _value : Integer
);
begin
...
function TGIS_PvlControlFmx.fget_Visible
  : Boolean;
begin
  Result := TControl( oControl ).Visible;
end;

procedure TGIS_PvlControlFmx.fset_Visible(
  const _value : Boolean
);
begin
...
function TGIS_PvlControlFmx.fget_Hint
  : String;
begin
...
procedure TGIS_PvlControlFmx.fset_Hint(
  const _value : String
);
begin
  {$IFNDEF LEVEL_RX101_FMX}
  ...
  {$ELSE}
    ...
    TControl( oControl ).ShowHint := not String.IsNullOrEmpty( _value ) ;
  {$ENDIF}
end;

procedure TGIS_PvlControlFmx.SetFocus;
begin
//  No set focus for control
//  TControl( oControl ).SetFocus;
end;

{$ENDREGION 'TGIS_PvlControlFmx'}
...
begin
  TLabel( oControl ).StyledSettings := TLabel( oControl ).StyledSettings - [TStyledSetting.Size] ;
...
begin
  TLabel( oControl ).StyledSettings := TLabel( oControl ).StyledSettings - [TStyledSetting.Style] ;
...
begin
  TLabel( oControl ).StyledSettings := TLabel( oControl ).StyledSettings - [TStyledSetting.Family] ;
  TLabel( oControl ).Font.Family := _value;
end;

function T_PvlLabel.fget_FontColor
  : TGIS_Color;
begin
  Result := GISColor( TLabel( oControl ).FontColor );
end;

procedure T_PvlLabel.fset_FontColor(
  const _value : TGIS_Color
);
begin
  TLabel( oControl ).StyledSettings := TLabel( oControl ).StyledSettings - [TStyledSetting.FontColor] ;
  TLabel( oControl ).FontColor := FMXColor( _value );
end;
...
begin
  ...
  TControl( oControl ).Width := RoundS( TGIS_PvlIconButton( oParent ).IconSize * 1.5 * _context.PPIFix ) ;
  TControl( oControl ).Height := RoundS( TGIS_PvlIconButton( oParent ).IconSize * 1.5 * _context.PPIFix ) ;
...
var
  ...
  begin
    try
      ...
      btn.Visible := False;
      btn.Parent := TFmxObject( oContext.Parent.NativeControl ) ;
...
begin
  ...
  try
    ...
    tmp.DrawGlyph( smb, RoundS( oContext.PPI * TGIS_PvlIconButton( oParent ).IconSize / 16 * oContext.CanvasScale ), clr, TGIS_PvlIconButton( oParent ).Enabled  ) ;
...
begin
  ...
  TControl( oControl ).Parent := TFmxObject( _context.NativeParent );
  TButton( oControl ).Default := False ;
end;
...
function T_PvlEdit.fget_FontSize
  : Integer;
begin
  Result := RoundS( TEdit( oControl ).Font.Size );
end;

procedure T_PvlEdit.fset_FontSize(
  const _value : Integer
);
begin
  TEdit( oControl ).StyledSettings := [TStyledSetting.Size] ;
  TEdit( oControl ).Font.Size := _value;
end;

function T_PvlEdit.fget_FontStyle
  : TGIS_FontStyles;
var
  iStyle : TGIS_FontStyles;
begin
  iStyle := GisGetEmptyFontStyle;
  if TFontStyle.fsBold in TEdit( oControl ).Font.Style then
    iStyle := GisAddFontStyle( iStyle, TGIS_FontStyle.Bold );
  if TFontStyle.fsItalic in TEdit( oControl ).Font.Style then
    iStyle := GisAddFontStyle( iStyle, TGIS_FontStyle.Italic );
  if TFontStyle.fsUnderline in TEdit( oControl ).Font.Style then
    iStyle := GisAddFontStyle( iStyle, TGIS_FontStyle.Underline );
  if TFontStyle.fsStrikeOut in TEdit( oControl ).Font.Style then
    iStyle := GisAddFontStyle( iStyle, TGIS_FontStyle.StrikeOut );
  Result := iStyle;
end;

procedure T_PvlEdit.fset_FontStyle(
  const _value : TGIS_FontStyles
);
begin
  TEdit( oControl ).StyledSettings := [TStyledSetting.Style] ;
  if TGIS_FontStyle.Bold in _value then
    TEdit( oControl ).Font.Style := TEdit( oControl ).Font.Style + [ TFontStyle.fsBold ];
  if TGIS_FontStyle.Italic in _value then
    TEdit( oControl ).Font.Style := TEdit( oControl ).Font.Style + [ TFontStyle.fsItalic ];
  if TGIS_FontStyle.Underline in _value then
    TEdit( oControl ).Font.Style := TEdit( oControl ).Font.Style + [ TFontStyle.fsUnderline ];
  if TGIS_FontStyle.StrikeOut in _value then
    TEdit( oControl ).Font.Style := TEdit( oControl ).Font.Style + [ TFontStyle.fsStrikeOut ];
end;

function T_PvlEdit.fget_FontFamily
  : string;
begin
  Result := TEdit( oControl ).Font.Family;
end;

procedure T_PvlEdit.fset_FontFamily(
  const _value : string
);
begin
  TEdit( oControl ).StyledSettings := [TStyledSetting.Family] ;
  TEdit( oControl ).Font.Family := _value;
end;

function T_PvlEdit.fget_Editable
  : Boolean;
begin
  Result := not TEdit( oControl ).ReadOnly;
end;

procedure T_PvlEdit.fset_Editable(
  const _value : Boolean
);
begin
  TEdit( oControl ).ReadOnly := not _value;
end;
...
begin
  TEdit( oControl ).StyledSettings := TEdit( oControl ).StyledSettings + [TStyledSetting.Style];
  TEdit( oControl ).StyledSettings := TEdit( oControl ).StyledSettings - [TStyledSetting.FontColor];
  TEdit( oControl ).FontColor := TAlphaColor($ffc61f1f);
end;
...
procedure T_PvlEdit.SetAsHyperlink;
begin
  TEdit( oControl ).StyledSettings := TEdit( oControl ).StyledSettings - [TStyledSetting.FontColor];
  TEdit( oControl ).FontColor := TAlphaColor($ff0000ee) ;
  TEdit( oControl ).StyledSettings := TEdit( oControl ).StyledSettings - [TStyledSetting.Style];
  TEdit( oControl ).Font.Style := TEdit( oControl ).Font.Style + [ TFontStyle.fsUnderline ];
  TEdit( oControl ).StyleLookup := 'transparentedit' ;
end;

procedure T_PvlEdit.SetBackgroundAlarm;
begin
  // Think about background color change
  TEdit( oControl ).StyledSettings := TEdit( oControl ).StyledSettings - [TStyledSetting.FontColor];
  TEdit( oControl ).FontColor := TAlphaColor($fffae0e0) ;
end;

procedure T_PvlEdit.SetBackgroundDefault;
begin
  // Think about background color change
  TEdit( oControl ).StyledSettings := TEdit( oControl ).StyledSettings + [TStyledSetting.FontColor];
end;
...
function T_PvlMemo.fget_FontSize
  : Integer;
begin
  Result := RoundS( TMemo( oControl ).Font.Size ) ;
end;

procedure T_PvlMemo.fset_FontSize(
  const _value : Integer
);
begin
  TMemo( oControl ).StyledSettings := [TStyledSetting.Size] ;
  TMemo( oControl ).Font.Size := _value;
end;

function T_PvlMemo.fget_FontStyle
  : TGIS_FontStyles;
var
  iStyle : TGIS_FontStyles;
begin
  iStyle := GisGetEmptyFontStyle;
  if TFontStyle.fsBold in TMemo( oControl ).Font.Style then
    iStyle := GisAddFontStyle( iStyle, TGIS_FontStyle.Bold );
  if TFontStyle.fsItalic in TMemo( oControl ).Font.Style then
    iStyle := GisAddFontStyle( iStyle, TGIS_FontStyle.Italic );
  if TFontStyle.fsUnderline in TMemo( oControl ).Font.Style then
    iStyle := GisAddFontStyle( iStyle, TGIS_FontStyle.Underline );
  if TFontStyle.fsStrikeOut in TMemo( oControl ).Font.Style then
    iStyle := GisAddFontStyle( iStyle, TGIS_FontStyle.StrikeOut );
  Result := iStyle;
end;

procedure T_PvlMemo.fset_FontStyle(
  const _value : TGIS_FontStyles
);
begin
  TMemo( oControl ).StyledSettings := [TStyledSetting.Style] ;
  if TGIS_FontStyle.Bold in _value then
    TMemo( oControl ).Font.Style := TMemo( oControl ).Font.Style + [ TFontStyle.fsBold ];
  if TGIS_FontStyle.Italic in _value then
    TMemo( oControl ).Font.Style := TMemo( oControl ).Font.Style + [ TFontStyle.fsItalic ];
  if TGIS_FontStyle.Underline in _value then
    TMemo( oControl ).Font.Style := TMemo( oControl ).Font.Style + [ TFontStyle.fsUnderline ];
  if TGIS_FontStyle.StrikeOut in _value then
    TMemo( oControl ).Font.Style := TMemo( oControl ).Font.Style + [ TFontStyle.fsStrikeOut ];
end;

function T_PvlMemo.fget_FontFamily
  : string;
begin
  Result := TMemo( oControl ).Font.Family;
end;

procedure T_PvlMemo.fset_FontFamily(
  const _value : string
);
begin
  TMemo( oControl ).StyledSettings := [TStyledSetting.Family] ;
  TMemo( oControl ).Font.Family := _value;
end;

function T_PvlMemo.fget_Editable
  : Boolean;
begin
  Result := not TMemo( oControl ).ReadOnly;
end;

procedure T_PvlMemo.fset_Editable(
  const _value : Boolean
);
begin
  TMemo( oControl ).ReadOnly := not _value;
end;
...
begin
  ...
  TComboBox( oControl ).DropDownKind := TDropDownKind.Custom ;
  TComboBox( oControl ).OnChange := doOnChange;
end;

procedure T_PvlComboBox.doDestroy;
begin
  FreeObject( FFont ) ;
  inherited ;
end;
...
procedure T_PvlComboBox.updateFont(
  const _full : Boolean
) ;
var
  i : Integer ;
...
begin
  ...
  if _full then begin
    for i := 0 to TComboBox( oControl ).Count - 1 do begin
      Item := TComboBox( oControl ).ListItems[i];
      Item.Font.Family := FFont.Family;
      Item.Font.Size := FFont.Size; 
      Item.Font.Style := FFont.Style;
      Item.StyledSettings := Item.StyledSettings - [TStyledSetting.Family,TStyledSetting.Size,TStyledSetting.FontColor];
    end;
  end else begin
      Item := TComboBox( oControl ).ListItems[ TComboBox( oControl ).Count-1 ];
      Item.Font.Family := FFont.Family; 
      Item.Font.Size := FFont.Size;
      Item.Font.Style := FFont.Style;
      Item.StyledSettings := Item.StyledSettings - [TStyledSetting.Family,TStyledSetting.Size,TStyledSetting.FontColor];
...
function T_PvlComboBox.fget_FontSize
  : Integer;
begin           
  if not assigned( FFont ) then begin
    FFont := TFont.Create ;
    FFont.Family := TComboBox( oControl ).ListItems[0].Font.Family ;
    FFont.Size := TComboBox( oControl ).ListItems[0].Font.Size ;
    FFont.Style := TComboBox( oControl ).ListItems[0].Font.Style ;
  end;     
  
  Result := RoundS( FFont.Size );
end;

procedure T_PvlComboBox.fset_FontSize(
  const _value : Integer
);
begin             
  if not assigned( FFont ) then begin
...
function T_PvlComboBox.fget_FontStyle
  : TGIS_FontStyles;
var
  iStyle : TGIS_FontStyles;
begin             
...
procedure T_PvlComboBox.fset_FontStyle(
  const _value : TGIS_FontStyles
);
begin        
  if not assigned( FFont ) then begin
  ...
  if TGIS_FontStyle.Italic in _value then
    FFont.Style := FFont.Style + [ TFontStyle.fsItalic ];
  if TGIS_FontStyle.Underline in _value then
    FFont.Style := FFont.Style + [ TFontStyle.fsUnderline ];
  if TGIS_FontStyle.StrikeOut in _value then
    FFont.Style := FFont.Style + [ TFontStyle.fsStrikeOut ];
    
  updateFont( True );
end;

function T_PvlComboBox.fget_FontFamily
  : string;
begin           
  if not assigned( FFont ) then begin
    FFont := TFont.Create ;
...
procedure T_PvlComboBox.fset_FontFamily(
  const _value : string
);
begin                        
  if not assigned( FFont ) then begin
...
begin
  oControl := TCustomComboEdit.Create( TFmxObject( _context.NativeParent ) );
  TCustomComboEdit( oControl ).DropDownKind := TDropDownKind.Native ;
  TCustomComboEdit( oControl ).OnChange := doOnChange ;
  TCustomComboEdit( oControl ).OnKeyDown := doOnKeyPress ;
  TCustomComboEdit( oControl ).DropDownCount := 5 ;
  TControl( oControl ).Parent := TFmxObject( _context.NativeParent );
end;
...
procedure T_PvlComboEdit.doOnKeyPress(
      _sender  : TObject  ;
  var _key     : Word     ;
  var _keychar : WideChar ;
      _shift   : TShiftState
...
function T_PvlComboEdit.fget_ItemsCount
  : Integer;
begin
  Result := TCustomComboEdit( oControl ).Items.Count;
end;
...
begin
  Result := TCustomComboEdit( oControl ).Items[ _idx ];
end;

function  T_PvlComboEdit.fget_ItemIndex
  : Integer;
begin
  Result := TCustomComboEdit( oControl ).ItemIndex;
end;
...
begin
  TCustomComboEdit( oControl ).ItemIndex := _value;
  doOnChange( Parent );
end;
...
function  T_PvlComboEdit.fget_Text
  : String;
begin
  Result := TCustomComboEdit( oControl ).Text;
end;
...
begin
  if TCustomComboEdit( oControl ).Items.IndexOf( _value ) >= 0 then
    TCustomComboEdit( oControl ).ItemIndex := TCustomComboEdit( oControl ).Items.IndexOf( _value )
  else
    TCustomComboEdit( oControl ).Text := _value ;
end;

function T_PvlComboEdit.fget_FontSize
  : Integer;
begin
  Result := RoundS( TCustomComboEdit( oControl ).Font.Size );
end;

procedure T_PvlComboEdit.fset_FontSize(
  const _value : Integer
);
begin
  TCustomComboEdit( oControl ).Font.Size := _value;
end;

function T_PvlComboEdit.fget_FontStyle
  : TGIS_FontStyles;
var
  iStyle : TGIS_FontStyles;
begin
  iStyle := GisGetEmptyFontStyle;
  if TFontStyle.fsBold in TCustomComboEdit( oControl ).Font.Style then
    iStyle := GisAddFontStyle( iStyle, TGIS_FontStyle.Bold );
  if TFontStyle.fsItalic in TCustomComboEdit( oControl ).Font.Style then
    iStyle := GisAddFontStyle( iStyle, TGIS_FontStyle.Italic );
  if TFontStyle.fsUnderline in TCustomComboEdit( oControl ).Font.Style then
    iStyle := GisAddFontStyle( iStyle, TGIS_FontStyle.Underline );
  if TFontStyle.fsStrikeOut in TCustomComboEdit( oControl ).Font.Style then
    iStyle := GisAddFontStyle( iStyle, TGIS_FontStyle.StrikeOut );
  Result := iStyle;
end;

procedure T_PvlComboEdit.fset_FontStyle(
  const _value : TGIS_FontStyles
);
begin
  if TGIS_FontStyle.Bold in _value then
    TCustomComboEdit( oControl ).Font.Style := TCustomComboEdit( oControl ).Font.Style + [ TFontStyle.fsBold ];
  if TGIS_FontStyle.Italic in _value then
    TCustomComboEdit( oControl ).Font.Style := TCustomComboEdit( oControl ).Font.Style + [ TFontStyle.fsItalic ];
  if TGIS_FontStyle.Underline in _value then
    TCustomComboEdit( oControl ).Font.Style := TCustomComboEdit( oControl ).Font.Style + [ TFontStyle.fsUnderline ];
  if TGIS_FontStyle.StrikeOut in _value then
    TCustomComboEdit( oControl ).Font.Style := TCustomComboEdit( oControl ).Font.Style + [ TFontStyle.fsStrikeOut ];
end;

function T_PvlComboEdit.fget_FontFamily
  : string;
begin
  Result := TCustomComboEdit( oControl ).Font.Family;
end;

procedure T_PvlComboEdit.fset_FontFamily(
  const _value : string
);
begin
  TCustomComboEdit( oControl ).Font.Family := _value;
end;

function T_PvlComboEdit.fget_OnKeyPress
  : TGIS_PvlKeyPressEvent;
begin
  Result := FOnKeyPress;
end;

procedure T_PvlComboEdit.fset_OnKeyPress(
  const _value : TGIS_PvlKeyPressEvent
);
begin
  FOnKeyPress := _value;
...
begin
  bSorted := _value ;
  if bSorted then begin
    TCustomComboEdit( oControl ).Sort( ComboBoxCompare ) ;
  end;
end;
...
function T_PvlComboEdit.fget_DropDownCount
  : Integer;
begin
  Result := TCustomComboEdit( oControl ).DropDownCount;
end;
...
begin
  TCustomComboEdit( oControl ).DropDownCount := _value;
end;
...
procedure T_PvlComboEdit.SetFontAlarm;
begin
  TCustomComboEdit( oControl ).StyledSettings := TCustomComboEdit( oControl ).StyledSettings - [TStyledSetting.FontColor];
  TCustomComboEdit( oControl ).FontColor := TAlphaColor($ffc61f1f);
end;

procedure T_PvlComboEdit.SetFontDefault;
begin
  TCustomComboEdit( oControl ).StyledSettings := TCustomComboEdit( oControl ).StyledSettings + [TStyledSetting.FontColor];
end;

procedure T_PvlComboEdit.SetBackgroundAlarm;
begin
  // Think about background color change
  TCustomComboEdit( oControl ).StyledSettings := TCustomComboEdit( oControl ).StyledSettings - [TStyledSetting.FontColor];
  TCustomComboEdit( oControl ).FontColor := TAlphaColor($fffae0e0) ;
end;

procedure T_PvlComboEdit.SetBackgroundDefault;
begin
  // Think about background color change
  TCustomComboEdit( oControl ).StyledSettings := TCustomComboEdit( oControl ).StyledSettings + [TStyledSetting.FontColor];
end;
...
begin
  TCustomComboEdit( oControl ).Items.BeginUpdate;
end;

procedure T_PvlComboEdit.EndUpdate;
begin
  TCustomComboEdit( oControl ).Items.EndUpdate;
end;

procedure T_PvlComboEdit.ItemsClear;
begin
  TCustomComboEdit( oControl ).Items.Clear;
end;
...
begin                                    
  TCustomComboEdit( oControl ).Items.Add( _item ) ;
end;
...
begin
  Result := TCustomComboEdit( oControl ).Items.IndexOf( _item );
end;

procedure T_PvlComboEdit.SetFocus;
begin
  TCustomComboEdit( oControl ).SetFocus;
end;

{$ENDREGION 'T_PvlComboEdit'}

{$REGION 'T_PvlSearchBox'}

procedure T_PvlSearchBox.doCreate(
  const _context : TGIS_PvlContext
);
begin
  oControl := TEdit.Create( TFmxObject( _context.NativeParent ) );
  TControl( oControl ).Parent := TFmxObject( _context.NativeParent );
  TEdit( oControl ).OnEnter := doEnter ;
  TEdit( oControl ).OnKeyDown := doEditKeyDown ;
  TEdit( oControl ).OnKeyUp := doEditKeyUp ;
  TEdit( oControl ).OnClick := doEditClick ;
  TEdit( oControl ).OnChange := doOnChange ;

  oList := TListBox.Create( TFmxObject( _context.NativeParent ) ) ;
  oList.Parent := TFmxObject( _context.NativeParent ) ;
  oList.Visible := False ;
  oList.OnKeyup := doListboxKeyDown;
  oList.OnMouseUp := doListBoxMouseUp;

  lstItems := TStringList.Create ;
  iDropDownCount := 5 ;
end;

procedure T_PvlSearchBox.doDestroy;
begin
  inherited ;
  FreeObject( lstItems ) ;
end;

procedure T_PvlSearchBox.findStem;
var
  i : Integer ;
  k : Integer ;
  bfound : Boolean ;
...
begin
  ...
  k := TEdit( oControl ).SelStart ;

  if k < Length( TEdit( oControl ).Text ) then begin
    c := TEdit( oControl ).Text[k+1] ;
  ...
  while k >= StringFirst do begin

    c := TEdit( oControl ).Text[k] ;
  ...
  sSearch := Copy( TEdit( oControl ).Text, k+1, TEdit( oControl ).SelStart - k ) ;

  bfound := false ;
  for i:=0 to lstItems.Count-1 do begin
    k := Pos( UpperCase( sSearch ), UpperCase( lstItems[i] ) ) ;
...
procedure T_PvlSearchBox.dropDown;
var
  i : Integer ;
  k : Integer ;
begin
  ...
  for i:=0 to lstItems.Count-1 do begin
    k := Pos( UpperCase( sSearch ), UpperCase( lstItems[i] ) ) ;
    if (sSearch = '') or ( k >= StringFirst ) then begin
      oList.Items.Add( lstItems[i] ) ;
    end ;
  end ;

  oList.Position.X := TEdit( oControl ).Position.X ;
  oList.Position.Y := TEdit( oControl ).Position.Y + TEdit( oControl ).Height ;
  oList.Width := TruncS( fget_Width * oContext.PPIFix ) ;
  if oList.Items.Count < iDropDownCount then
    oList.Height := oList.ListItems[0].Height * oList.Items.Count
  else
    oList.Height := oList.ListItems[0].Height * iDropDownCount ;

  oList.Visible := oList.Items.Count > 0 ;

  if oList.Visible then begin
    oList.BringToFront ;
  end;
...
procedure T_PvlSearchBox.dropUp;
begin
  ...
  oList.Visible := False ;
  TEdit( oControl ).SetFocus;
  TEdit( oControl ).SelStart := Length( TEdit( oControl ).Text ) ;

  bDropped := False ;
end;

procedure T_PvlSearchBox.doOnChange(
       _sender : TObject
);
begin
  if Assigned( FOnChange ) then
...
procedure T_PvlSearchBox.doEnter(
        _sender   : TObject
);
begin
  dropUp ;
...
procedure T_PvlSearchBox.doEditClick(
        _sender: TObject
);
begin
//  if TEdit( oControl ).Text <> '' then
//    exit ;

  sSearch := '';
  dropDown;
  if oList.Visible then
    oList.ItemIndex := 0;
end;

procedure T_PvlSearchBox.doListBoxKeyDown(
        _sender    : TObject;
  var   _key        : Word;
  var   _keyChar    : Char;
        _shift      : TShiftState
...
begin
   case _key of
    ...
    vkReturn:
      begin
        TEdit( oControl ).SelLength := - Length( sSearch ) ;
//        TEdit( oControl ).SelText := (oList.Items[oList.ItemIndex]);
        stmp := Copy( TEdit( oControl ).Text, 0, TEdit( oControl ).SelStart ) ;
        stmp2 := Copy( TEdit( oControl ).Text, TEdit( oControl ).SelStart + TEdit( oControl ).SelLength + 1, Length( TEdit( oControl ).Text ) ) ;
        TEdit( oControl ).Text := stmp + (oList.Items[oList.ItemIndex]) + stmp2 ;
        bDropped := True ;
        dropUp;
      end;
  end;
...
procedure T_PvlSearchBox.doEditKeyDown(
        _sender    : TObject;
  var   _key        : Word;
  var   _keyChar    : Char;
        _shift      : TShiftState
...
procedure T_PvlSearchBox.doEditKeyUp(
        _sender    : TObject;
  var   _key        : Word;
  var   _keyChar    : Char;
        _shift      : TShiftState
...
begin
  ...
  if lstItems.IndexOf( sSearch ) >= 0 then
    exit ;
...
procedure T_PvlSearchBox.doListBoxMouseUp(
        _sender   : TObject      ;
        _button   : TMouseButton ;
        _shift    : TShiftState  ;
        _x        : Single       ;
...
function  T_PvlSearchBox.fget_Text
  : String;
begin
  Result := TEdit( oControl ).Text;
end;

procedure T_PvlSearchBox.fset_Text(
  const _value : String
);
begin
  TEdit( oControl ).Text := _value ;
...
function T_PvlSearchBox.fget_ItemsCount
  : Integer;
begin
  Result := oList.Items.Count;
end;

function T_PvlSearchBox.fget_Item(
  const _idx   : Integer
) : String;
begin
  Result := oList.Items[ _idx ];
end;

function  T_PvlSearchBox.fget_ItemIndex
  : Integer;
begin
  Result := oList.ItemIndex;
end;

procedure T_PvlSearchBox.fset_ItemIndex(
  const _value : Integer
);
begin
  oList.ItemIndex := _value;
  doOnChange( Parent );
end;

function T_PvlSearchBox.fget_FontSize
  : Integer;
begin
  Result := RoundS( TEdit( oControl ).Font.Size );
end;

procedure T_PvlSearchBox.fset_FontSize(
  const _value : Integer
);
begin
  TEdit( oControl ).Font.Size := _value ;
//?  oList.Font.Size := _Value ;
end;

function T_PvlSearchBox.fget_FontStyle
  : TGIS_FontStyles;
var
  iStyle : TGIS_FontStyles;
begin
...
procedure T_PvlSearchBox.fset_FontStyle(
  const _value : TGIS_FontStyles
);
begin
  if TGIS_FontStyle.Bold in _value then
...
//  if TGIS_FontStyle.Bold in _value then
//    oList.Font.Style := oList.Font.Style + [ TFontStyle.fsBold ];
//  if TGIS_FontStyle.Italic in _value then
//    oList.Font.Style := oList.Font.Style + [ TFontStyle.fsItalic ];
//  if TGIS_FontStyle.Underline in _value then
//    oList.Font.Style := oList.Font.Style + [ TFontStyle.fsUnderline ];
//  if TGIS_FontStyle.StrikeOut in _value then
//    oList.Font.Style := oList.Font.Style + [ TFontStyle.fsStrikeOut ];
end;

function T_PvlSearchBox.fget_FontFamily
  : string;
begin
  Result := TEdit( oControl ).Font.Family;
end;

procedure T_PvlSearchBox.fset_FontFamily(
  const _value : string
);
begin
  TEdit( oControl ).Font.Family := _value ;
//  oList.Font.Name := _value ;
end;

function T_PvlSearchBox.fget_Sorted
  : Boolean;
begin
  Result := oList.Sorted;
end;

procedure T_PvlSearchBox.fset_Sorted(
  const _value : Boolean
);
begin
  oList.Sorted := _value;
...
function T_PvlSearchBox.fget_DropDownCount
  : Integer;
begin
  Result := iDropDownCount;
end;

procedure T_PvlSearchBox.fset_DropDownCount(
  const _value : Integer
);
begin
  iDropDownCount := _value;
end;

procedure T_PvlSearchBox.fset_Width(
  const _value: Integer
) ;
begin
  inherited ;
...
procedure T_PvlSearchBox.fset_Height(
  const _value: Integer
) ;
begin
  inherited ;
...
function T_PvlSearchBox.fget_OnChange
  : TGIS_PvlEvent;
begin
  Result := FOnChange;
end;

procedure T_PvlSearchBox.fset_OnChange(
  const _value : TGIS_PvlEvent
);
begin
  FOnChange := _value;
...
procedure T_PvlSearchBox.ItemsClear;
begin
  oList.Items.Clear;
  lstItems.Clear ;
end;

procedure T_PvlSearchBox.ItemsAdd(
  const _item  : String
);
begin
  oList.Items.Add( _item ) ;
  lstItems.Add( _item ) ;
end;

function T_PvlSearchBox.IndexOf(
  const _item: string
): Integer;
begin
  Result := oList.Items.IndexOf( _item );
end;

function T_PvlSearchBox.fget_OnKeyPress
  : TGIS_PvlKeyPressEvent;
begin
  Result := FOnKeyPress;
end;

procedure T_PvlSearchBox.fset_OnKeyPress(
  const _value : TGIS_PvlKeyPressEvent
);
begin
  FOnKeyPress := _value;
...
procedure T_PvlSearchBox.SetFontAlarm;
begin
  TCustomComboEdit( oControl ).StyledSettings := TCustomComboEdit( oControl ).StyledSettings - [TStyledSetting.FontColor];
  TCustomComboEdit( oControl ).FontColor := TAlphaColor($ffc61f1f);
end;

procedure T_PvlSearchBox.SetFontDefault;
begin
  TCustomComboEdit( oControl ).StyledSettings := TCustomComboEdit( oControl ).StyledSettings + [TStyledSetting.FontColor];
end;

procedure T_PvlSearchBox.SetBackgroundAlarm;
begin
  // Think about background color change
  TCustomComboEdit( oControl ).StyledSettings := TCustomComboEdit( oControl ).StyledSettings - [TStyledSetting.FontColor];
  TCustomComboEdit( oControl ).FontColor := TAlphaColor($fffae0e0) ;
...
procedure T_PvlSearchBox.SetBackgroundDefault;
begin
  // Think about background color change
  TCustomComboEdit( oControl ).StyledSettings := TCustomComboEdit( oControl ).StyledSettings + [TStyledSetting.FontColor];
end;

procedure T_PvlSearchBox.SetFocus;
begin
  TEdit( oControl ).SetFocus;
end;


{$ENDREGION 'T_PvlSearchBox'}
...
begin
  ...
  TControl( oControl ).Parent := TFmxObject( _context.NativeParent );
  TCheckBox( oControl ).OnChange := doOnChange ;
end;

procedure T_PvlCheckBox.doOnChange(
  _sender: TObject
) ;
begin
  if assigned( FOnChange ) then
...
function T_PvlCheckBox.fget_OnChange
  : TGIS_PvlEvent ;
begin
  Result := FOnChange ;
end;

procedure T_PvlCheckBox.fset_OnChange(
  const _value: TGIS_PvlEvent
) ;
begin
  FOnChange := _value ;
...
begin
  ...
  TControl( oControl ).Parent := TFmxObject( _context.NativeParent );
  TRadioButton( oControl ).OnClick := doOnClick;
  TRadioButton( oControl ).OnChange := doOnChange;
end;
...
procedure T_PvlRadioButton.doOnChange(
  _sender: TObject
) ;
begin
  try
    TCheckBox( oControl ).OnChange := nil;
    TGIS_PvlRadioButton( Self.oParent ).UncheckGroup(
      TGIS_PvlRadioButton( Self.oParent )
    );
...
function T_PvlRadioButton.fget_OnChange
  : TGIS_PvlEvent ;
begin
  Result := FOnChange ;
end;

procedure T_PvlRadioButton.fset_OnChange(
  const _value: TGIS_PvlEvent
) ;
begin
  FOnChange := _value ;
...
begin
  ...
  TRectangle( oControl ).Stroke.Kind := TBrushKind.None ;
  TRectangle( oControl ).Padding.Left := 0 ;
  TRectangle( oControl ).Padding.Right := 0 ;
  TRectangle( oControl ).Padding.Top := 0 ;
  TRectangle( oControl ).Padding.Bottom := 0 ;

  oScrollBox := TScrollBox.Create( TRectangle( oControl ) ) ;
  oScrollBox.Parent := TRectangle( oControl ) ;
  oScrollBox.ShowScrollBars := False ;

  oScrollBox.Align :=TAlignLayout.Client ;


  oScrollBox.OnApplyStyleLookup := DoApplyStyle ;
...
function T_PvlPanel.fget_NativeControl : TObject;
begin
  Result := oScrollBox ;
end;
...
function T_PvlPanel.fget_Scrollable
  : Boolean;
begin
  Result := oScrollBox.ShowScrollBars ;
end;
...
begin
  oScrollBox.ShowScrollBars := _value ;

  if _value then
  begin
    TRectangle( oControl ).Padding.Left := 1 ;
    TRectangle( oControl ).Padding.Right := 1 ;
    TRectangle( oControl ).Padding.Top := 1 ;
    TRectangle( oControl ).Padding.Bottom := 1 ;
  end
  else
  begin
    TRectangle( oControl ).Padding.Left := 0 ;
...
var
  cntrl : TGIS_PvlBase ;
begin
  oScrollBox.Content.DeleteChildren ;
end;

procedure T_PvlPanel.DoApplyStyle(
  _sender : TObject
);
var
  stl  : TFmxObject ;
begin
  stl := TStyledControl.LookupStyleObject(
            TScrollBox( oControl ), TScrollBox( oControl ), TScrollBox( oControl ).Scene, '', 'panelstyle', '', False
          );
  if not ( Assigned( stl ) and ( stl is TRectangle ) ) then
    exit ;

  TRectangle( oControl ).Stroke := TRectangle(stl).Stroke;
  TRectangle( oControl ).Fill := TRectangle(stl).Fill;

  if not fget_Border then
    TRectangle( oControl ).Stroke.Kind := TBrushKind.None ;
end;
...
procedure T_PvlCanvas.doCreate(
  const _context: TGIS_PvlContext
) ;
begin
  oControl := TGIS_ViewerWnd.Create( TFmxObject( _context.NativeParent ) );
  TGIS_ViewerWnd( oControl ).Parent := TFmxObject( _context.NativeParent );
  TGIS_ViewerWnd( oControl ).Enabled := False ;

  TGIS_ViewerWnd( oControl ).AfterPaintRendererEvent := doOnPaintExtra ;
end;

function T_PvlCanvas.fget_OnRender
  : TGIS_PvlRendererEvent ;
begin
  Result := FRenderEvent ;
end;

procedure T_PvlCanvas.fset_OnRender(
...
procedure T_PvlCanvas.doOnPaintExtra(
  _sender   : TObject;
  _renderer : TGIS_RendererAbstract;
  _mode     : TGIS_DrawMode
) ;
begin
  if assigned( FRenderEvent ) then
    FRenderEvent( _sender, _renderer, _mode ) ;
end;

{$ENDREGION 'T_PvlCanvas'}
...
function T_PvlTree.fget_SelectedIndex
  : Integer;
begin
  if not Assigned( TTreeView( oControl ).Selected ) then
    Result := -1
  else
    Result := TTreeView( oControl ).Selected.Index  //? To double check !
end;
...
var
  node : T_TreeViewItemEx ;
begin
  node := T_TreeViewItemEx( _node.Parent.NativeControl ) ;
  if assigned( node ) then
    node.RemoveObject( T_TreeViewItemEx( _node.NativeControl ) ) 
  else
    TTreeView( _node.TreeControl.NativeControl ).RemoveObject( node ) ;
  T_TreeViewItemEx( _node.NativeControl  ).Free;
end;
...
function T_PvlListBox.fget_OnChange
  : TGIS_PvlEvent ;
begin
  Result := TListBox( oControl ).OnChange ;
end;

procedure T_PvlListBox.fset_OnChange(
  const _value: TGIS_PvlEvent
) ;
begin
  TListBox( oControl ).OnChange := _value ;
end;
...
begin
  ...
  oControl := TScrollBox.Create( TFmxObject( _context.NativeParent ) );
  oScrollBox := TScrollBox( oControl );
  oScrollBox.Parent := TFmxObject( _context.NativeParent ) ;
  oScrollBox.StyleLookup := 'framedscrollboxstyle';
  oScrollBox.OnResize := doResize ;

  oLib := TGIS_SymbolLibrarySVG.Handle ;
  oLib.OpenForBrowsing ;

  oScrollBox.Width := fget_Width ;
  oScrollBox.Height := fget_Height ;

  TLayout( oControl ).Width := fget_Width ;
  TLayout( oControl ).Height := fget_Height ;
  TLayout( oControl ).OnClick := doOnClick ;
  applyStyle ;
end;
...
function T_PvlSVGList.fget_OnChange
  : TGIS_PvlEvent ;
begin
  Result := FOnChange ;
end;

procedure T_PvlSVGList.fset_OnChange(
  const _value: TGIS_PvlEvent
) ;
begin
  FOnChange := _value ;
...
begin
  iCount := 0 ;
  if Assigned( oScrollBox.Content.Children ) then begin
    for i:=oScrollBox.Content.Children.Count -1 downto 0 do
      oScrollBox.Content.RemoveObject( oScrollBox.Content.Children.Items[i] );
  end;
  iCol := 0 ;
  iRow := 0 ;
  iColMax := 0 ;
...
begin
  ...
  iColMax := TruncS( oScrollBox.ClientWidth / svgItem.Width );

  svgItem.Position.X := iCol * svgItem.Width ;
  svgItem.Position.Y := iRow * svgItem.Height ;

  itmList.Add( svgItem ) ;
  oScrollBox.Content.AddObject( svgItem ) ;

  inc( iCount ) ;
  inc( iCol ) ;
  if iCol >= iColMax then begin
    inc( iRow ) ;
    iCol := 0 ;
  end ;
end;
...
procedure T_PvlSVGList.doResize(
  _sender : TObject
);
var
  svgItem  : T_SVGListItem ;
begin
  ...
  for svgItem in itmList do begin
    iColMax := TruncS( oScrollBox.ClientWidth / svgItem.Width );
    svgItem.Position.X := iCol * svgItem.Width ;
    svgItem.Position.Y := iRow * svgItem.Height ;
...
{$REGION 'TGIS_PvlContextFmx'}

constructor TGIS_PvlContextFmx.Create(
...
begin
  ...
  oOwner := TGIS_PvlComponentFmx.Create(TComponent(oParent));
  oOwner.oMaster := oMaster; // trick to destroyself TGIS_Pvl*
  oOwner.oOwner  := self;    // trick to destroyself T_Pvl*

  oMaster.UpdatePPI( _ppi, _ppifix, _canvasscale ) ;
  oMaster.UpdateRightToLeft( _righttoleft ) ;
...
begin
  ...
  if not Assigned( _parent ) then begin
    ...
    if Assigned( _refcontext ) then
      ...
      if not Assigned( frm ) then  //? to be evaluated on Mac Retina
        Create( prnt,
          ppi,
           1,
          1,
...
class function TGIS_PvlContextFmx.CreateOpenDialog(
  const _context: TGIS_PvlContext;
  const _self   : TGIS_PvlOpenDialog
) : TGIS_PvlOpenDialog;
begin
  Result := TGIS_OpenDialog.Create( _context, _self );
end;

class function TGIS_PvlContextFmx.CreateSaveDialog(
  const _context: TGIS_PvlContext;
  const _self   : TGIS_PvlSaveDialog
) : TGIS_PvlSaveDialog;
begin
  Result := TGIS_SaveDialog.Create( _context, _self );
end;

class function TGIS_PvlContextFmx.CreateSelectFolderDialog(
  const _context: TGIS_PvlContext;
  const _self   : TGIS_PvlSelectFolderDialog
) : TGIS_PvlSelectFolderDialog;
begin
  Result := TGIS_SelectFolderDialog.Create( _context, _self );
end;

class function TGIS_PvlContextFmx.CreateOptionDialog(
  const _context: TGIS_PvlContext;
  const _self   : TGIS_PvlOptionDialog
) : TGIS_PvlOptionDialog;
begin
  Result := TGIS_OptionDialog.Create( _context, _self );
end;

class function TGIS_PvlContextFmx.CreateInfoDialog(
  const _context: TGIS_PvlContext;
  const _self   : TGIS_PvlInfoDialog
) : TGIS_PvlInfoDialog ;
begin
  Result := TGIS_InfoDialog.Create( _context, _self ) ;
end;

class function TGIS_PvlContextFmx.CreateWarningDialog(
  const _context: TGIS_PvlContext;
  const _self   : TGIS_PvlWarningDialog
) : TGIS_PvlWarningDialog ;
begin
  Result := TGIS_WarningDialog.Create( _context, _self ) ;
end;

class function TGIS_PvlContextFmx.CreateErrorDialog(
  const _context: TGIS_PvlContext;
  const _self   : TGIS_PvlErrorDialog
) : TGIS_PvlErrorDialog ;
begin
  Result := TGIS_ErrorDialog.Create( _context, _self ) ;
end;

class function TGIS_PvlContextFmx.CreateCSDialog(
  const _context: TGIS_PvlContext;
  const _self   : TGIS_PvlControlCSSystem
) : TGIS_PvlControlCSSystem ;
begin
  Result := FMX.GisSystemForms.TGIS_ControlCSSystem.Create( _context, _self ) ;
end;

class function TGIS_PvlContextFmx.CreateLineSymbologyDialog(
  const _context: TGIS_PvlContext;
  const _self   : TGIS_PvlLineSymbolEditor
) : TGIS_PvlLineSymbolEditor ;
begin
  Result := FMX.GisSystemForms.TGIS_LineSymbolEditor.Create( _context, _self ) ;
end;

class function TGIS_PvlContextFmx.CreatePrintPreviewSimpleDialog(
  const _context: TGIS_PvlContext;
  const _self   : TGIS_PvlControlPrintPreviewSimple
) : TGIS_PvlControlPrintPreviewSimple ;
begin
  Result := FMX.GisSystemForms.TGIS_ControlPrintPreviewSimple.Create( _context, _self ) ;
end;

class function TGIS_PvlContextFmx.Support(
  const _parent  : TObject
) : Boolean ;
var
  o : TObject;
...
function TGIS_PvlContextFmx.getAllFonts
  : TStringList ;
begin
...
function TGIS_PvlContextFmx.CreateObject(
...
procedure TGIS_PvlContextFmx.FreeContext ;
begin
  // force freeing of context
  oOwner.Free ;
end;

function TGIS_PvlContextFmx.ClientWidth
  : Integer;
begin
  Result := 0 ;
  ...
  if oParent is TControl then
    Result := RoundS( TControl( oParent ).Width )
  else
    Assert( False ) ;
end;

function TGIS_PvlContextFmx.fget_HMargin
  : Integer;
begin
  Result := RoundS( iHMargin );
end;

procedure TGIS_PvlContextFmx.fset_HMargin(
  const _value: Integer
) ;
begin
...
function TGIS_PvlContextFmx.fget_VMargin
  : Integer;
begin
  Result := RoundS( iVMargin );
end;

procedure TGIS_PvlContextFmx.fset_VMargin(
  const _value: Integer
) ;
begin
...
function TGIS_PvlContextFmx.fget_HSpace
  : Integer ;
begin
  Result := 4 {$IFDEF ANDROID}* 2{$ENDIF} ;
end;

function TGIS_PvlContextFmx.fget_VSpace
  : Integer ;
begin
  Result := 4 {$IFDEF ANDROID}* 2{$ENDIF} ;
end;

function TGIS_PvlContextFmx.fget_LSpace
  : Integer ;
begin
  Result := 2 ;
end;

function TGIS_PvlContextFmx.fget_CanvasScale
  : Single;
begin
  Result := oMaster.CanvasScale ; //?dCanvasScale;
end;

function TGIS_PvlContextFmx.fget_PPIFix
  : Single;
begin
  Result := oMaster.PPIFix ; //?dPPIFix;
end;

function TGIS_PvlContextFmx.fget_PPI
  : Integer;
begin
  Result := oMaster.PPI ; //?iPPI;
end;

{$ENDREGION 'TGIS_PvlContextFmx'}
...
begin
  ...
  RegisterPVLPlatformControl( 'SearchBox'           , T_PvlSearchBox           );
  ...
  RegisterPVLPlatformControl( 'Canvas'              , T_PvlCanvas              );
end;
...
initialization
  TGIS_PvlContext.&Register( TGIS_PvlContextFmx ) ;
