...
unit Lider.CG.GIS.FMX.GeoLegendUtilsFactory ;
{$HPPEMIT '#pragma link "Lider.CG.GIS.FMX.GeoLegendUtilsFactory"'}
...
type
  ...
  /// </summary>
  TGIS_LegendRendererFMX = class( TGIS_LegendRendererAbstract )
...
//==============================================================================
// TGIS_LegendRendererFMX
//==============================================================================

  procedure TGIS_LegendRendererFMX.prepareFmxObject ;
  begin
    try
  ...
  procedure TGIS_LegendRendererFMX.drawSymbol(
  ...
  constructor TGIS_LegendRendererFMX.Create(
  ...
  destructor TGIS_LegendRendererFMX.Destroy ;
  begin
    {$IFDEF LEVEL_RX10_FMX}
  ...
  function TGIS_LegendRendererFMX.GetBackgroundColor
    : TAlphaColor ;
  begin
    Result := FColor ;
  end ;

  procedure TGIS_LegendRendererFMX.SetBackgroundColor(
  ...
  function TGIS_LegendRendererFMX.GetFont
    : TFont ;
  begin
    Result := FFont ;
  end ;

  procedure TGIS_LegendRendererFMX.SetFont(
    const _value : TFont
  ) ;
  begin
    FFont.Assign( _value ) ;
  ...
  function TGIS_LegendRendererFMX.GetFontColor
    : TAlphaColor ;
  begin
    Result := FFontColor ;
  end ;

  procedure TGIS_LegendRendererFMX.SetFontColor(
    const _value : TAlphaColor
  ) ;
  begin
    FFontColor := _value ;
  ...
  function TGIS_LegendRendererFMX.GetActualColor(
  ...
  function TGIS_LegendRendererFMX.GetActualFontFamily
    : TFontName ;
  begin
    Result := FFont.Family ;
    {$IFDEF LEVEL_RX10_FMX}
  ...
  function TGIS_LegendRendererFMX.GetActualFontSize
    : Single ;
  begin
    Result := FFont.Size ;
    {$IFDEF LEVEL_RX10_FMX}
  ...
  function TGIS_LegendRendererFMX.GetActualFontStyle
    : TFontStyles ;
  begin
    Result := FFont.Style ;
    {$IFDEF LEVEL_RX10_FMX}
  ...
  function TGIS_LegendRendererFMX.GetActualFontColor(
    const _selected : Boolean
  ) : TAlphaColor ;
  begin
    if _selected then
  ...
  function TGIS_LegendRendererFMX.GetActualCheckBoxSize
    : Integer ;
  var
    check : TCheckBox ;
  begin
  ...
  procedure TGIS_LegendRendererFMX.SetPPI(
  ...
  procedure TGIS_LegendRendererFMX.SetCanvasScale(
    const _value : Single
  ) ;
  begin
    sCanvasScale := _value ;
...
{$IFDEF LEVEL_RX10_FMX}
  procedure TGIS_LegendRendererFMX.ChangeStyle ;
  var
    stl  : TFmxObject ;
    stl2 : TFmxObject ;
  begin
...
{$IFDEF LEVEL_RX10_FMX}
  procedure TGIS_LegendRendererFMX.ApplyStyledSettings(
    _settings : TGIS_ControlLegendStyledSettings
  ) ;
  begin
...
{$ENDIF}
  ...
  procedure TGIS_LegendRendererFMX.DrawBackground(
  ...
  procedure TGIS_LegendRendererFMX.CreateContext(
    const _canvas : TCanvas ;
    const _rtl    : Boolean
  ) ;
  var
  ...
  procedure TGIS_LegendRendererFMX.FreeContext ;
  begin
    oCanvas := nil ;
  end ;

  function TGIS_LegendRendererFMX.GetBrushColor
    : TGIS_Color ;
  begin
    Result := TGIS_Color.None ;
  end ;

  procedure TGIS_LegendRendererFMX.SetBrushColor(
    const _selected : Boolean
  ) ;
  begin
  ...
  procedure TGIS_LegendRendererFMX.DrawCheckBox(
  ...
  procedure TGIS_LegendRendererFMX.DrawExpandCollapseMarker(
    const _expanded : Boolean ;
    const _rect     : TRect
  ) ;
  var
  ...
  procedure TGIS_LegendRendererFMX.DrawRectangle(
    const _rect : TRect
  ) ;
  begin
  ...
  function TGIS_LegendRendererFMX.GetTextExtent(
    const _selected : Boolean ;
    const _text     : String
  ) : TPoint ;
  var
  ...
  procedure TGIS_LegendRendererFMX.DrawText(
    const _selected : Boolean ;
    const _text     : String  ;
    const _rect     : TRect
  ) ;
  ...
  procedure TGIS_LegendRendererFMX.DrawImage(
  ...
  procedure TGIS_LegendRendererFMX.CreateTemporaryContext(
    const _width  : Integer ;
    const _height : Integer ;
    const _ppi    : Integer
  ) ;
  ...
  procedure TGIS_LegendRendererFMX.RenderTemporaryContext(
    const _left : Integer ;
    const _top  : Integer
  ) ;
  begin
