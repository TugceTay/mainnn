...
unit FMX.GisControlCsSystem ;
{$HPPEMIT '#pragma link "FMX.GisControlCsSystem"'}
...
{$IFDEF GIS_MOBILE}
  {$ERROR 'On Mobile platforms use FMX.Mobile.GisControlCsSystem' }
{$ENDIF}
...
type
  ...
  TGIS_ControlCSSystem = class(TGIS_ModalForm)
    ...
    cmbGEOGCS: FMX.GisControlCsHelper.TComboEdit;
    cmbPROJCS: FMX.GisControlCsHelper.TComboEdit;
...
//==============================================================================
  ...
  begin
    doExecute( _cs, 0, GisNoWorld(), _onhelp, _proc, True );
  end;
  ...
  begin
    hlp := nil ;
    doExecute( _cs, 0, GisNoWorld(), hlp, _proc, True );
  end;
  ...
  begin
    doExecute( _cs, _area_epsg, _area_extent, _onhelp, _proc, True );
  end;
