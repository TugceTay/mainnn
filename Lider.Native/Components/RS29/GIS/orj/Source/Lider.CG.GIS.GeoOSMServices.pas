...
{$IFDEF DCC}
  unit GisOSMServices;
  {$HPPEMIT '#pragma link "GisOSMServices"'}
{$ENDIF}
{$IFDEF CLR}
  ...
  begin
    ...
    try
      if httpFetch( _url, strm ) then begin
        ...
        lres.Params.Marker.SizeAsText := 'SIZE:16 pt' ;
        lres.Params.Marker.Style := TGIS_MarkerStyle.Cross ;
        lres.Params.Marker.Color := TGIS_Color.Red ;
