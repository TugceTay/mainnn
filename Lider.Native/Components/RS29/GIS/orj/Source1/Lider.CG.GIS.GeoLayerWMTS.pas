...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoLayerWMTS ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoLayerWMTS"'}
{$ENDIF}
{$IFDEF CLR}
...
//==============================================================================
  ...
  class procedure GisLayerWMTS.SelfRegisterLayer() ;
  begin
...
{$IFNDEF OXYGENE}
initialization
    GisLayerWMTS.SelfRegisterLayer() ;
{$ENDIF}
