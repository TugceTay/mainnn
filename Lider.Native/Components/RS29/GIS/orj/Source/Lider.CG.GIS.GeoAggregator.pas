...
{$IFDEF DCC}
  unit GisAggregator;
  {$HPPEMIT '#pragma link "GisAggregator"'}
{$ENDIF}
{$IFDEF CLR}
...
type
  ...
  Unit_GisAggregator = class
    public
      class procedure SelfRegisterLayer() ;
  end ;

  /// <summary>
  ///   Represents a collection of dynamic aggregator names.
  ///   This class provides a list of names to be used with
  ///   TGIS_DynamicAggregatorFactory.CreateInstance method.
  /// </summary>
  TGIS_AggregatorNames = {$IFDEF OXYGENE} public {$ENDIF}
  ...
  private
    class function fget_BinningHexagonFlat            : String; static;
    class function fget_BinningHexagonPointy          : String; static;
    class function fget_BinningSquare                 : String; static;
    class function fget_ClusteringHexagonalGridFlat   : String; static;
    class function fget_ClusteringHexagonalGridPointy : String; static;
    class function fget_ClusteringMovingAverage       : String; static;
    class function fget_ClusteringSquareGrid          : String; static;
    class function fget_ShapeReduction                : String; static;
  public
    /// <summary>
    ///   Hexagonal binning method with flat-top hexagons.
    ///   Groups data points into hexagonal bins with flat sides at the top and bottom.
    /// </summary>
    class property BinningHexagonFlat: String read fget_BinningHexagonFlat ;

    /// <summary>
    ///   Hexagonal binning method with pointy-top hexagons.
    ///   Groups data points into hexagonal bins with a vertex pointing upward.
    /// </summary>
    class property BinningHexagonPointy: String read fget_BinningHexagonPointy ;

    /// <summary>
    ///   Square binning method
    ///   Aggregates data points into a uniform grid of square bins.
    /// </summary>
    class property BinningSquare: String read fget_BinningSquare ;

    /// <summary>
    ///   Clustering using a flat-top hexagonal grid.
    ///   Applies clustering within a structured grid of hexagons oriented with flat sides at the top and bottom.
    /// </summary>
    class property ClusteringHexagonalGridFlat: String read fget_ClusteringHexagonalGridFlat ;

    /// <summary>
    ///   Clustering using a pointy-top hexagonal grid.
    ///   Applies clustering within a structured grid of hexagons oriented with a vertex pointing upward.
    /// </summary>
    class property ClusteringHexagonalGridPointy: String read fget_ClusteringHexagonalGridPointy ;

    /// <summary>
    ///   Moving average clustering method.
    ///   Uses a moving average approach to group nearby data points dynamically.
    /// </summary>
    class property ClusteringMovingAverage: String read fget_ClusteringMovingAverage ;

    /// <summary>
    ///   Clustering using a square grid.
    ///   Clusters data points within a structured grid of square cells.
    /// </summary>
    class property ClusteringSquareGrid: String read fget_ClusteringSquareGrid ;

    /// <summary>
    ///   Dynamic point reduction method
    ///   Dynamically reduces the number of displayed points on the map while preserving the overall spatial distribution and visual clarity.
    /// </summary>
    class property ShapeReduction: String read fget_ShapeReduction ;
  end;
...
{$REGION 'Unit_GisAggregator'}
class procedure Unit_GisAggregator.SelfRegisterLayer() ;
var
  ...
  try
    ...
    try
      TGIS_DynamicAggregatorFactory.Register(
        TGIS_AggregatorNames.GIS_AGGREGATION_BIN_HEX_FLAT,
        TGIS_AggregatorBinningHexagonFlat
      ) ;
      TGIS_DynamicAggregatorFactory.Register(
        TGIS_AggregatorNames.GIS_AGGREGATION_BIN_HEX_POINTY,
        TGIS_AggregatorBinningHexagonPointy
      ) ;
      TGIS_DynamicAggregatorFactory.Register(
        TGIS_AggregatorNames.GIS_AGGREGATION_BIN_SQUARE,
        TGIS_AggregatorBinningSquare
      ) ;
      TGIS_DynamicAggregatorFactory.Register(
        TGIS_AggregatorNames.GIS_AGGREGATION_CLUSTERING_HEX_FLAT,
        TGIS_AggregatorClusteringHexagonalGridFlat
      ) ;
      TGIS_DynamicAggregatorFactory.Register(
        TGIS_AggregatorNames.GIS_AGGREGATION_CLUSTERING_HEX_POINTY,
        TGIS_AggregatorClusteringHexagonalGridPointy
      ) ;
      TGIS_DynamicAggregatorFactory.Register(
        TGIS_AggregatorNames.GIS_AGGREGATION_CLUSTERING_MOVING_AVG,
        TGIS_AggregatorClusteringMovingAverage
      ) ;
      TGIS_DynamicAggregatorFactory.Register(
        TGIS_AggregatorNames.GIS_AGGREGATION_CLUSTERING_SQUARE,
        TGIS_AggregatorClusteringSquareGrid
      ) ;
      TGIS_DynamicAggregatorFactory.Register(
        TGIS_AggregatorNames.GIS_AGGREGATION_SHAPE_REDUCTION,
        TGIS_AggregatorShapeReduction
      ) ;
    finally
      thc.UnlockThread ;
...
{$REGION 'TGIS_AggregatorNames'}
class function TGIS_AggregatorNames.fget_BinningHexagonFlat: String;
begin
  Result := GIS_AGGREGATION_BIN_HEX_FLAT ;
end;

class function TGIS_AggregatorNames.fget_BinningHexagonPointy: String;
begin
  Result := GIS_AGGREGATION_BIN_HEX_POINTY ;
end;

class function TGIS_AggregatorNames.fget_BinningSquare: String;
begin
  Result := GIS_AGGREGATION_BIN_SQUARE ;
end;

class function TGIS_AggregatorNames.fget_ClusteringHexagonalGridFlat: String;
begin
  Result := GIS_AGGREGATION_CLUSTERING_HEX_FLAT ;
end;

class function TGIS_AggregatorNames.fget_ClusteringHexagonalGridPointy: String;
begin
  Result :=  GIS_AGGREGATION_CLUSTERING_HEX_POINTY ;
end;

class function TGIS_AggregatorNames.fget_ClusteringMovingAverage: String;
begin
  Result := GIS_AGGREGATION_CLUSTERING_MOVING_AVG ;
end;

class function TGIS_AggregatorNames.fget_ClusteringSquareGrid: String;
begin
  Result := GIS_AGGREGATION_CLUSTERING_SQUARE ;
end;

class function TGIS_AggregatorNames.fget_ShapeReduction: String;
begin
  Result := GIS_AGGREGATION_SHAPE_REDUCTION ;
end;
{$ENDREGION}
...
{$IFNDEF OXYGENE}
initialization
  Unit_GisAggregator.SelfRegisterLayer() ;
