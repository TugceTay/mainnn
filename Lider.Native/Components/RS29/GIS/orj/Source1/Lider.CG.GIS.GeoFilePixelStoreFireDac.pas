...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoFilePixelStoreFireDac ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoFilePixelStoreFireDac"'}
{$ENDIF}
{$IFDEF CLR}
...
{$IFDEF GIS_NODB}
  {$Message Warn 'Unit Lider.CG.GIS.GeoFilePixelStoreFireDac not supported - no DB support' }
  interface
  implementation
{$ELSE}
