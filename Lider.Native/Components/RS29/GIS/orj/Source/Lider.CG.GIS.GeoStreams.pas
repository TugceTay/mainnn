...
{$IFDEF DCC}
  unit GisStreams ;
  {$HPPEMIT '#pragma link "GisStreams"'}
{$ENDIF}
{$IFDEF CLR}
...
type
  ...
  TGIS_Stream = {$IFDEF OXYGENE} public abstract {$ENDIF} class( TGIS_BaseStream )
    ...
    public // basic routines
      /// <summary>
      ///   Check if Unicode BOM exsts and alters Code Page accoringly.
      /// </summary>
      /// <remarks>
      ///   Must be called before first read. Internally String reading fuctions
      ///   call this method.
      /// </remarks>
      procedure ApplyBom ;
...
procedure TGIS_Stream.ApplyBom ;
var
  buf : TBytes ;
  bom : Boolean ;
begin
