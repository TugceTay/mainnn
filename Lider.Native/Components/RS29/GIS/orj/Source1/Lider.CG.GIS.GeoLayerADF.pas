...
{$IFDEF DCC}
  unit Lider.CG.GIS.GeoLayerADF ;
  {$HPPEMIT '#pragma link "Lider.CG.GIS.GeoLayerADF"'}
{$ENDIF}
{$IFDEF CLR}
...
//==============================================================================
  ...
  class procedure GisLayerADF.SelfRegisterLayer() ;
  begin
